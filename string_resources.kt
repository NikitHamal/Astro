...
enum class StringKey(val en: String, val ne: String) {
    ...
    PLANET_URANUS("Uranus", "अरुण"),
    PLANET_NEPTUNE("Neptune", "वरुण"),
    PLANET_PLUTO("Pluto", "यम"),
    ...
    MATCH_BELOW_AVERAGE("Below Average", "औसतभन्दा कम"),
    ...
    MATCH_SWAP_PROFILES("Swap Profiles", "प्रोफाइलहरू बदल्नुहोस्"),
    ...
    // PANCHANGA
    // ============================================
    PANCHANGA_SUBTITLE_NEPALI("Vedic Almanac", "पञ्चाङ्ग"),
    PANCHANGA_TITHI("Tithi", "तिथि"),
    PANCHANGA_TITHI_SANSKRIT_NEPALI("Tithi", "तिथि"),
    PANCHANGA_TITHI_SUBTITLE("Lunar Day", "चन्द्र दिवस"),
    PANCHANGA_VARA("Vara (Day)", "वार"),
    PANCHANGA_VARA_SANSKRIT_NEPALI("Vara", "वार"),
    PANCHANGA_VARA_SUBTITLE("Weekday", "हप्ताको दिन"),
    PANCHANGA_NAKSHATRA_LABEL("Nakshatra", "नक्षत्र"),
    PANCHANGA_NAKSHATRA_SANSKRIT_NEPALI("Nakshatra", "नक्षत्र"),
    PANCHANGA_YOGA("Yoga", "योग"),
    PANCHANGA_YOGA_SANSKRIT_NEPALI("Yoga", "योग"),
    PANCHANGA_YOGA_SUBTITLE("Luni-Solar Combination", "सूर्य-चन्द्र संयोजन"),
    PANCHANGA_KARANA("Karana", "करण"),
    PANCHANGA_KARANA_SANSKRIT_NEPALI("Karana", "करण"),
    PANCHANGA_KARANA_SUBTITLE("Half Lunar Day", "अर्ध चन्द्र दिवस"),
    ...
    MUHURTA_RAHUKALA_DESC("Avoid important work", "महत्त्वपूर्ण कार्यबाट बच्नुहोस्"),
    MUHURTA_YAMAGHANTA("Yamaghanta", "यमघन्ता"),
    MUHURTA_YAMAGHANTA_DESC("Avoid travel", "यात्राबाट बच्नुहोस्"),
    MUHURTA_GULIKA_KALA("Gulika Kala", "गुलिक काल"),
    MUHURTA_GULIKA_KALA_DESC("Avoid new beginnings", "नयाँ सुरुवातबाट बच्नुहोस्"),
    MUHURTA_ACTIVE("ACTIVE", "सक्रिय"),
    MUHURTA_DAY_CHOGHADIYA("Day Choghadiya", "दिनको चोघडिया"),
    ...
    MUHURTA_DETAIL_CHOGHADIYA("Choghadiya", "चोघडिया"),
    ...
    PLANETARY_STATUS_FRIENDLY("Friendly", "मित्र राशि"),
    ...
    // BS Months
    BS_MONTH_BAISHAKH("Baishakh", "वैशाख"),
    ...
    COMPAT_BELOW_AVERAGE("Below Average", "औसतभन्दा कम"),
    ...
    DASHA_UPCOMING_TRANSITIONS("%1\$d upcoming transition(s) within %2\$d days", "%2\$d दिनभित्र %1\$d आगामी संक्रमण(हरू)"),
    DASHA_TRANSITION("transition", "संक्रमण"),
    DASHA_SANDHI_EXPLANATION("Sandhi periods mark transitions between planetary periods. These are sensitive times requiring careful attention as the energy shifts from one planet to another.", "सन्धि अवधिहरूले ग्रह अवधिहरूबीचको संक्रमण चिन्ह लगाउँछन्। यी संवेदनशील समयहरू हुन् जहाँ एउटा ग्रहबाट अर्को ग्रहमा ऊर्जा परिवर्तन हुन्छ।"),
    ...
    DASHA_SANDHI_NOTE("Dasha Sandhi (junction periods) occur when transitioning between planetary periods and are considered sensitive times requiring careful attention.", "दशा सन्धि (जोड अवधिहरू) ग्रह अवधिहरूबीच संक्रमण हुँदा हुन्छ र यी संवेदनशील समयहरू मानिन्छन्।"),
    ...
    DASHA_YEARS_VALUE("%d yrs", "%d वर्ष"),
    DASHA_SANDHI_TRANSITION_LABEL("%s → %s", "%s → %s"),
    DASHA_CURRENT_PERIOD_DESC_FULL("%s / %s / %s", "%s / %s / %s"),
    DASHA_CURRENT_PERIOD_DESC_ANTAR("%s / %s", "%s / %s"),
    DASHA_PROGRESS_REMAINING("%s%% complete • %s", "%s%% पूरा • %s"),
    DASHA_ANTAR_PERIOD_LABEL("%s – %s", "%s – %s"),
    DASHA_PLANET_MAHADASHA("%s Mahadasha", "%s महादशा"),
    DASHA_INTERPRETATION_MAHA_SUN("The Sun's major period highlights themes of authority, leadership, and self-realization. Expect focus on career, public life, and personal power.", "सूर्यको महादशाले अधिकार, नेतृत्व र आत्म-अनुभूतिको विषयलाई उजागर गर्दछ। करियर, सार्वजनिक जीवन र व्यक्तिगत शक्तिमा ध्यान केन्द्रित हुने अपेक्षा गर्नुहोस्।"),
    DASHA_INTERPRETATION_MAHA_MOON("The Moon's period brings focus to emotions, home, and public life. It's a time of fluctuating experiences and heightened sensitivity.", "चन्द्रमाको अवधिले भावना, घर र सार्वजनिक जीवनमा ध्यान केन्द्रित गर्दछ। यो उतारचढावपूर्ण अनुभव र बढेको संवेदनशीलताको समय हो।"),
    DASHA_INTERPRETATION_MAHA_MARS("Mars' period is energetic and action-oriented. It can bring ambition, conflict, and a drive for achievement. Focus is often on property and competition.", "मंगलको अवधि ऊर्जावान र कार्य-उन्मुख हुन्छ। यसले महत्वाकांक्षा, द्वन्द्व र उपलब्धिको लागि प्रेरणा ल्याउन सक्छ। ध्यान प्रायः सम्पत्ति र प्रतिस्पर्धामा केन्द्रित हुन्छ।"),
    DASHA_INTERPRETATION_MAHA_MERCURY("Mercury's period emphasizes communication, intellect, and commerce. It's a time for learning, business, and networking.", "बुधको अवधिले सञ्चार, बुद्धि र वाणिज्यमा जोड दिन्छ। यो सिक्ने, व्यापार र नेटवर्किङको लागि समय हो।"),
    DASHA_INTERPRETATION_MAHA_JUPITER("Jupiter's period is one of expansion, wisdom, and fortune. It often brings opportunities for growth, learning, and spiritual development.", "बृहस्पतिको अवधि विस्तार, बुद्धि र भाग्यको अवधि हो। यसले प्रायः वृद्धि, शिक्षा र आध्यात्मिक विकासको अवसर ल्याउँछ।"),
    DASHA_INTERPRETATION_MAHA_VENUS("Venus' period focuses on love, luxury, and creativity. It's a time for relationships, artistic pursuits, and enjoying the pleasures of life.", "शुक्रको अवधिले प्रेम, विलासिता र रचनात्मकतामा ध्यान केन्द्रित गर्दछ। यो सम्बन्ध, कलात्मक खोज र जीवनको आनन्द लिने समय हो।"),
    DASHA_INTERPRETATION_MAHA_SATURN("Saturn's period is a time of discipline, responsibility, and karmic lessons. It often brings slow but steady progress and a focus on long-term goals.", "शनिको अवधि अनुशासन, जिम्मेवारी र कर्मको पाठको समय हो। यसले प्रायः ढिलो तर स्थिर प्रगति र दीर्घकालीन लक्ष्यहरूमा ध्यान केन्द्रित गर्दछ।"),
    DASHA_INTERPRETATION_MAHA_RAHU("Rahu's period brings a focus on worldly desires, ambition, and unconventional pursuits. It can be a time of sudden changes and foreign influences.", "राहुको अवधिले सांसारिक इच्छा, महत्वाकांक्षा र अपरंपरागत खोजहरूमा ध्यान केन्द्रित गर्दछ। यो अचानक परिवर्तन र विदेशी प्रभावहरूको समय हुन सक्छ।"),
    DASHA_INTERPRETATION_MAHA_KETU("Ketu's period is one of spiritual introspection, detachment, and sudden insights. It often involves letting go of material attachments and seeking deeper meaning.", "केतुको अवधि आध्यात्मिक आत्मनिरीक्षण, वैराग्य र अचानक अन्तर्दृष्टिको समय हो। यसमा प्रायः भौतिक आसक्तिहरू छोडेर गहिरो अर्थ खोज्नु समावेश हुन्छ।"),
    DASHA_INTERPRETATION_MAHA_GENERIC("This is a significant planetary period. Its effects will be shaped by its placement and aspects in your birth chart.", "यो एक महत्त्वपूर्ण ग्रह अवधि हो। यसको प्रभाव तपाईंको जन्म कुण्डलीमा यसको स्थिति र दृष्टिले निर्धारण गर्नेछ।"),
    DASHA_INTERPRETATION_ANTAR_SUN("The sub-period of the Sun brings a focus on career, authority, and confidence.", "सूर्यको उप-अवधिले करियर, अधिकार र आत्मविश्वासमा ध्यान केन्द्रित गर्दछ।"),
    DASHA_INTERPRETATION_ANTAR_MOON("The Moon's sub-period emphasizes emotions, relationships, and domestic matters.", "चन्द्रमाको उप-अवधिले भावना, सम्बन्ध र घरेलु मामिलाहरूमा जोड दिन्छ।"),
    DASHA_INTERPRETATION_ANTAR_MARS("Mars' sub-period brings energy, action, and potential conflicts. Drive and ambition are heightened.", "मंगलको उप-अवधिले ऊर्जा, कार्य र सम्भावित द्वन्द्वहरू ल्याउँछ। प्रेरणा र महत्वाकांक्षा बढ्छ।"),
    DASHA_INTERPRETATION_ANTAR_MERCURY("Mercury's sub-period highlights communication, learning, and business activities.", "बुधको उप-अवधिले सञ्चार, शिक्षा र व्यापारिक गतिविधिहरूलाई उजागर गर्दछ।"),
    DASHA_INTERPRETATION_ANTAR_JUPITER("Jupiter's sub-period brings opportunities for growth, knowledge, and prosperity.", "बृहस्पतिको उप-अवधिले वृद्धि, ज्ञान र समृद्धिको अवसर ल्याउँछ।"),
    DASHA_INTERPRETATION_ANTAR_VENUS("Venus' sub-period enhances creativity, romance, and social enjoyment.", "शुक्रको उप-अवधिले रचनात्मकता, रोमान्स र सामाजिक आनन्द बढाउँछ।"),
    DASHA_INTERPRETATION_ANTAR_SATURN("Saturn's sub-period may bring responsibilities, delays, and a need for discipline.", "शनिको उप-अवधिले जिम्मेवारी, ढिलाइ र अनुशासनको आवश्यकता ल्याउन सक्छ।"),
    DASHA_INTERPRETATION_ANTAR_RAHU("Rahu's sub-period can bring sudden changes, worldly ambitions, and unexpected events.", "राहुको उप-अवधिले अचानक परिवर्तन, सांसारिक महत्वाकांक्षा र अप्रत्याशित घटनाहरू ल्याउन सक्छ।"),
    ...
    PANCHANGA_NATURE("Nature", "स्वभाव"),
    PANCHANGA_PROGRESS("Progress", "प्रगति"),
    PANCHANGA_SIGNIFICANCE("Significance", "महत्व"),
    PANCHANGA_FAVORABLE_ACTIVITIES("Favorable Activities", "अनुकूल गतिविधिहरू"),
    PANCHANGA_AVOID("Avoid", "बेवास्ता गर्नुहोस्"),
    PANCHANGA_OF_30("of 30", "मध्ये ३०"),
    PANCHANGA_NAKSHATRA_SUBTITLE("Lunar Mansion • नक्षत्र", "चन्द्रमाको नक्षत्र • नक्षत्र"),
    PANCHANGA_CHARACTERISTICS("Characteristics", "विशेषताहरू"),
    PANCHANGA_OF_27("of 27", "मध्ये २७"),
    PANCHANGA_PADA("Pada", "पद"),
    PANCHANGA_OF_4("of 4", "मध्ये ४"),
    PANCHANGA_RULER("Ruler", "शासक"),
    PANCHANGA_SYMBOL("Symbol", "प्रतीक"),
    ...
    PANCHANGA_ABOUT_TITLE("About Panchanga", "पञ्चाङ्ग बारेमा"),
    PANCHANGA_ABOUT_SUBTITLE_NEPALI("Panchanga Introduction", "पञ्चाङ्ग परिचय"),
    PANCHANGA_ABOUT_DESC("Panchanga (Sanskrit: पञ्चाङ्ग, \"five limbs\") is the traditional Hindu calendar and almanac. It tracks five fundamental elements of Vedic time-keeping, essential for determining auspicious moments (muhurta) for important activities.", "पञ्चाङ्ग (संस्कृत: पञ्चाङ्ग, \"पाँच अंग\") परम्परागत हिन्दू पात्रो र पंचांग हो। यसले वैदिक समय-गणनाका पाँच आधारभूत तत्वहरू ट्र्याक गर्दछ, जुन महत्त्वपूर्ण गतिविधिहरूको लागि शुभ मुहूर्त निर्धारण गर्न आवश्यक छ।"),
    PANCHANGA_ABOUT_TITHI_DESC("Based on the angular distance between Sun and Moon. Each tithi spans 12° of lunar elongation. There are 30 tithis in a lunar month.", "सूर्य र चन्द्रमा बीचको कोणीय दूरीमा आधारित। प्रत्येक तिथिले १२° चन्द्रमाको विस्तार फैलिएको छ। एक चन्द्र महिनामा ३० तिथिहरू हुन्छन्।"),
    PANCHANGA_ABOUT_NAKSHATRA_DESC("The Moon's position among 27 stellar constellations, each spanning 13°20'. Determines the Moon's influence on consciousness.", "२७ तारकीय नक्षत्रहरू मध्ये चन्द्रमाको स्थिति, प्रत्येक १३°२०' फैलिएको छ। चेतनामा चन्द्रमाको प्रभाव निर्धारण गर्दछ।"),
    PANCHANGA_ABOUT_YOGA_DESC("Derived from the sum of Sun and Moon longitudes divided into 27 equal parts. Indicates the overall quality of time.", "सूर्य र चन्द्रमाको देशान्तरको योगलाई २७ बराबर भागमा विभाजन गरेर व्युत्पन्न। समयको समग्र गुणस्तर संकेत गर्दछ।"),
    PANCHANGA_ABOUT_KARANA_DESC("Each tithi has two karanas. There are 11 karanas (4 fixed, 7 repeating) cycling through the month.", "प्रत्येक तिथिको दुई करण हुन्छन्। महिनाभरि ११ करणहरू (४ स्थिर, ७ दोहोरिने) चक्रमा हुन्छन्।"),
    PANCHANGA_ABOUT_VARA_DESC("Each day is ruled by a planet, influencing the day's energy and suitable activities.", "प्रत्येक दिन एक ग्रह द्वारा शासित हुन्छ, जसले दिनको ऊर्जा र उपयुक्त गतिविधिहरूलाई प्रभाव पार्छ।"),
    PANCHANGA_ABOUT_INSIGHT("The Panchanga at birth reveals the cosmic influences active at the moment of incarnation, providing insights into one's inherent nature, tendencies, and life patterns.", "जन्मको समयमा पञ्चाङ्गले अवतारको क्षणमा सक्रिय ब्रह्माण्डीय प्रभावहरू प्रकट गर्दछ, जसले व्यक्तिको अन्तर्निहित स्वभाव, प्रवृत्ति र जीवन ढाँचाहरूमा अन्तर्दृष्टि प्रदान गर्दछ।"),
    ...
    MUHURTA_EVENT_BUSINESS_START("Business Start", "व्यापार सुरुवात"),
    MUHURTA_EVENT_TRAVEL("Travel", "यात्रा"),
    MUHURTA_EVENT_VEHICLE_PURCHASE("Vehicle Purchase", "सवारी खरिद"),
    MUHURTA_EVENT_EDUCATION_START("Education Start", "शिक्षा सुरुवात"),
    ...
    PANCHANGA_WAXING("Waxing", "शुक्ल पक्ष"),
    PANCHANGA_WANING("Waning", "कृष्ण पक्ष"),
