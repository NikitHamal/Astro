package com.astro.vajra.ui.navigation
...
import com.astro.vajra.ui.screen.CharaDashaScreen
import com.astro.vajra.ui.screen.ChartAnalysisScreen
import com.astro.vajra.ui.screen.ChartInputScreen
import com.astro.vajra.ui.screen.VimsottariDashaScreen
import com.astro.vajra.ui.screen.matchmaking.MatchmakingScreen
import com.astro.vajra.ui.screen.MuhurtaScreen
import com.astro.vajra.ui.screen.NakshatraScreen
import com.astro.vajra.ui.screen.panchanga.PanchangaScreenRedesigned
import com.astro.vajra.ui.screen.PlanetsScreen
import com.astro.vajra.ui.screen.NadiAmshaScreen
import com.astro.vajra.ui.screen.PrashnaScreen
import com.astro.vajra.ui.screen.PredictionsScreen
import com.astro.vajra.ui.screen.RemediesScreen
import com.astro.vajra.ui.screen.ShadbalaScreen
import com.astro.vajra.ui.screen.ShodashvargaScreen
import com.astro.vajra.ui.screen.SynastryScreen
import com.astro.vajra.ui.screen.transits.TransitsScreenRedesigned
import com.astro.vajra.ui.screen.VarshaphalaScreen
import com.astro.vajra.ui.screen.yogas.YogasScreenRedesigned
import com.astro.vajra.ui.screen.YoginiDashaScreen
import com.astro.vajra.ui.screen.AshtottariDashaScreen
import com.astro.vajra.ui.screen.SudarshanaChakraScreen
import com.astro.vajra.ui.screen.MrityuBhagaScreen
import com.astro.vajra.ui.screen.LalKitabRemediesScreen
import com.astro.vajra.ui.screen.DivisionalChartsScreen
import com.astro.vajra.ui.screen.UpachayaTransitScreen
import com.astro.vajra.ui.screen.KalachakraDashaScreen
import com.astro.vajra.ui.screen.tarabala.TarabalaScreen
import com.astro.vajra.ui.screen.ArudhaPadaScreen
import com.astro.vajra.ui.screen.GrahaYuddhaScreen
import com.astro.vajra.ui.screen.DashaSandhiScreen
import com.astro.vajra.ui.screen.GocharaVedhaScreen
import com.astro.vajra.ui.screen.KemadrumaYogaScreen
import com.astro.vajra.ui.screen.PanchMahapurushaScreen
import com.astro.vajra.ui.screen.NityaYogaScreen
import com.astro.vajra.ui.screen.AvasthaScreen
import com.astro.vajra.ui.screen.MarakaScreen
import com.astro.vajra.ui.screen.BadhakaScreen
import com.astro.vajra.ui.screen.VipareetaRajaYogaScreen
import com.astro.vajra.ui.screen.IshtaKashtaPhalaScreen
import com.astro.vajra.ui.screen.ShoolaDashaScreen
import com.astro.vajra.ui.screen.AshtavargaTransitScreen
import com.astro.vajra.ui.screen.KakshaTransitScreen
import com.astro.vajra.ui.screen.SarvatobhadraChakraScreen
import com.astro.vajra.ui.screen.DrigBalaScreen
import com.astro.vajra.ui.screen.SthanaBalaScreen
...
import com.astro.vajra.ui.screen.KpSystemScreen
...
fun AstroVajraNavigation(
    ...
    LaunchedEffect(uiState) {
        if (uiState is com.astro.vajra.ui.viewmodel.ChartUiState.Success) {
            currentChart = (uiState as com.astro.vajra.ui.viewmodel.ChartUiState.Success).chart
        }
    }
    ...
    NavHost(
            ...
            currentChart?.let { chart ->
                ChartAnalysisScreen(
                    ...
                    onNavigateToDetailedYoga = { yoga ->
                        when {
                            yoga.detailedResult is com.astro.vajra.ephemeris.KemadrumaYogaCalculator.KemadrumaAnalysis -> {
                                navController.navigate(Screen.KemadrumaYoga.createRoute(chartId))
                            }
                            yoga.detailedResult is com.astro.vajra.ephemeris.PanchMahapurushaYogaCalculator.MahapurushaYoga -> {
                                navController.navigate(Screen.PanchMahapurusha.createRoute(chartId))
                            }
                            yoga.detailedResult is com.astro.vajra.ephemeris.VipareetaRajaYogaCalculator.VipareetaYoga -> {
        ...
        composable(Screen.About.route) {
            com.astro.vajra.ui.screen.main.AboutScreen(
                onBack = { navController.popBackStack() }
            )
        }
