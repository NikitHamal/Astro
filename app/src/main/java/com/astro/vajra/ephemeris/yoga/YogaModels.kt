...
enum class YogaStrength(val displayName: String, val value: Int) {
    ...
    fun getLocalizedName(language: Language): String {
        val key = when (this) {
            EXTREMELY_STRONG -> com.astro.vajra.core.common.StringKey.YOGA_STRENGTH_EXTREMELY_STRONG
            VERY_STRONG -> com.astro.vajra.core.common.StringKey.YOGA_STRENGTH_VERY_STRONG
            STRONG -> com.astro.vajra.core.common.StringKey.YOGA_STRENGTH_STRONG
            MODERATE -> com.astro.vajra.core.common.StringKey.YOGA_STRENGTH_MODERATE
            WEAK -> com.astro.vajra.core.common.StringKey.YOGA_STRENGTH_WEAK
            VERY_WEAK -> com.astro.vajra.core.common.StringKey.YOGA_STRENGTH_VERY_WEAK
        }
        return StringResources.get(key, language)
    }
