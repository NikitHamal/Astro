...
class SwissEphemerisEngine internal constructor(
    ...
    private val astroSettings: com.astro.vajra.data.preferences.AstrologySettingsManager
) : AutoCloseable {
    ...
    companion object {
        ...
        fun getInstance(
            ...
            astroSettings: com.astro.vajra.data.preferences.AstrologySettingsManager = 
                com.astro.vajra.data.preferences.AstrologySettingsManager.getInstance(context)
