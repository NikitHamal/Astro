...
import com.astro.vajra.ephemeris.shoola.ShoolaDashaEvaluator.assessHealthSeverity
import com.astro.vajra.ephemeris.shoola.ShoolaDashaEvaluator.assessPeriodNature
...
object ShoolaDashaCalculator {
    ...
    private fun calculateAntardashas(
        ...
        val daysPerAntardasha = (com.astro.vajra.ephemeris.DashaUtils.DAYS_PER_YEAR.toDouble() * SIGN_DASHA_YEARS) / 12.0
