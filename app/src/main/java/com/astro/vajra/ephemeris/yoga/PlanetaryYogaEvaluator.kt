    ...
    private fun evaluateSunYogas(chart: VedicChart, houseLords: Map<Int, Planet>): List<Yoga> {
        ...
        if (YogaHelpers.isExalted(sunPos)) {
            ...
            yogas.add(Yoga(
                ...
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_UTTAMADI
            ))
        }
        ...
        if (YogaHelpers.isDebilitated(sunPos)) {
            ...
            if (venusPos != null && YogaHelpers.isAspecting(venusPos, sunPos)) {
                ...
                yogas.add(Yoga(
                    ...
                    nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_NEECHABHILASHI
                ))
            }
        }
        ...
        if (sunPos.house == 10 && saturnPos != null && YogaHelpers.isAspecting(saturnPos, sunPos)) {
            ...
            yogas.add(Yoga(
                ...
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_TAPASVI
            ))
        }
        ...
        if (sunPos.sign == ZodiacSign.LEO && sunPos.house in listOf(1, 4, 7, 10)) {
            ...
            yogas.add(Yoga(
                ...
                cancellationFactors = emptyList(),
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_SURYA
            ))
        }
        ...
        if ((sunPos.house == 1 || sunPos.house == 10) &&
            ...
            yogas.add(Yoga(
                ...
                cancellationFactors = emptyList(),
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_PRABHAKAR
            ))
        }
    ...
    private fun evaluateMoonYogas(chart: VedicChart, houseLords: Map<Int, Planet>): List<Yoga> {
        ...
        if (inPushkara) {
            ...
            yogas.add(Yoga(
                ...
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_PUSHKARA_NAVAMSA
            ))
        }
        ...
        if ((moonPos.sign == ZodiacSign.CANCER || moonPos.sign == ZodiacSign.TAURUS) &&
            ...
            yogas.add(Yoga(
                ...
                cancellationFactors = emptyList(),
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_SHARADA
            ))
        }
        ...
        if (moonPos.sign == ZodiacSign.CANCER && moonPos.house in listOf(1, 4, 7, 10) &&
            ...
            yogas.add(Yoga(
                ...
                cancellationFactors = emptyList(),
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_CHANDRA_LAKSHMI
            ))
        }
        ...
        if (moonStrength > 0.9) {
            ...
            yogas.add(Yoga(
                ...
                activationPeriod = "Moon Dasha periods",
                cancellationFactors = emptyList(),
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_PURNIMA
            ))
        }
        ...
        if (moonStrength < 0.1) {
            ...
            yogas.add(Yoga(
                ...
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_AMAVASYA
            ))
        }
        ...
        if (house6FromMoon.isNotEmpty() && house7FromMoon.isNotEmpty() && house8FromMoon.isNotEmpty()) {
            ...
            yogas.add(Yoga(
                ...
                cancellationFactors = emptyList(),
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_CHANDRADHI
            ))
        }
    ...
    private fun evaluateMarsYogas(chart: VedicChart, houseLords: Map<Int, Planet>): List<Yoga> {
        ...
        if (marsPos.house == 10 && (YogaHelpers.isExalted(marsPos) || YogaHelpers.isInOwnSign(marsPos))) {
            ...
            yogas.add(Yoga(
                ...
                cancellationFactors = emptyList(),
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_VIJAYA
            ))
        }
        ...
        if (marsPos.house == 3 && (YogaHelpers.isExalted(marsPos) || YogaHelpers.isInOwnSign(marsPos) || YogaHelpers.isInFriendSign(marsPos))) {
            ...
            yogas.add(Yoga(
                ...
                activationPeriod = "Mars Dasha periods",
                cancellationFactors = emptyList(),
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_PARAKRAMA
            ))
        }
    ...
    private fun evaluateMercuryYogas(chart: VedicChart, houseLords: Map<Int, Planet>): List<Yoga> {
        ...
        if (mercuryPos.house in listOf(4, 5) && jupiterPos != null &&
            ...
            yogas.add(Yoga(
                ...
                cancellationFactors = emptyList(),
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_VIDYA
            ))
        }
        ...
        if ((YogaHelpers.isExalted(mercuryPos) || YogaHelpers.isInOwnSign(mercuryPos)) &&
            ...
            yogas.add(Yoga(
                ...
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_NIPUNA
            ))
        }
    ...
    private fun evaluateJupiterYogas(chart: VedicChart, houseLords: Map<Int, Planet>): List<Yoga> {
        ...
        if (marsPos != null && YogaHelpers.areConjunct(jupiterPos, marsPos)) {
            ...
            yogas.add(Yoga(
                ...
                cancellationFactors = emptyList(),
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_GURU_MANGALA
            ))
        }
        ...
        if (jupiterPos.house in listOf(1, 5, 9)) {
            ...
            yogas.add(Yoga(
                ...
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_DHARMA
            ))
        }
        ...
        if (jupiterPos.house in listOf(1, 4, 7, 10) &&
            ...
            yogas.add(Yoga(
                ...
                activationPeriod = "Jupiter Dasha periods",
                cancellationFactors = emptyList(),
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_BRAHMA
            ))
        }
        ...
        if (lord5 == Planet.JUPITER) {
            ...
            if (jupiterPos.house in listOf(1, 4, 5, 7, 9, 10, 11)) {
                yogas.add(Yoga(
                    ...
                    activationPeriod = "Jupiter Dasha periods",
                    cancellationFactors = emptyList(),
                    nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_GANAPATI
                ))
            }
        }
    ...
    private fun evaluateVenusYogas(chart: VedicChart, houseLords: Map<Int, Planet>): List<Yoga> {
        ...
        if (YogaHelpers.isExalted(venusPos) && mercuryPos != null &&
            ...
            yogas.add(Yoga(
                ...
                cancellationFactors = emptyList(),
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_BHARATHI_EXP
            ))
        }
        ...
        if ((venusPos.sign == ZodiacSign.TAURUS || venusPos.sign == ZodiacSign.LIBRA) &&
            ...
            yogas.add(Yoga(
                ...
                cancellationFactors = emptyList(),
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_KAMINI
            ))
        }
        ...
        if (lord7 == Planet.VENUS && venusPos.house in listOf(1, 4, 5, 7, 9, 10)) {
            ...
            yogas.add(Yoga(
                ...
                cancellationFactors = emptyList(),
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_KALATRA
            ))
        }
        ...
        if (venusPos.house == 7 && jupiterPos != null && YogaHelpers.isAspecting(jupiterPos, venusPos)) {
            ...
            yogas.add(Yoga(
                ...
                cancellationFactors = emptyList(),
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_MRIDANGA
            ))
        }
        ...
        if (venusPos.house in listOf(2, 11) && !YogaHelpers.isDebilitated(venusPos)) {
            ...
            yogas.add(Yoga(
                ...
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_SHUKRA_DIGNITY
            ))
        }
    ...
    private fun evaluateSaturnYogas(chart: VedicChart, houseLords: Map<Int, Planet>): List<Yoga> {
        ...
        if (saturnPos.house in listOf(3, 6, 11) && !YogaHelpers.isDebilitated(saturnPos)) {
            ...
            yogas.add(Yoga(
                ...
                cancellationFactors = emptyList(),
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_SHANI
            ))
        }
        ...
        if (saturnPos.house == 8 && YogaHelpers.isDebilitated(saturnPos)) {
            ...
            yogas.add(Yoga(
                ...
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_DUR
            ))
        }
        ...
        if (saturnPos.house in listOf(1, 5, 9, 10) &&
            ...
            yogas.add(Yoga(
                ...
                cancellationFactors = emptyList(),
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_AYUSH
            ))
        }
        ...
        if (rahuPos != null) {
            ...
            if (rahuPos.house in listOf(3, 6, 10, 11)) {
                ...
                yogas.add(Yoga(
                    ...
                    cancellationFactors = emptyList(),
                    nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_RAHU_UPACHAYA
                ))
            }
            ...
            if (jupiterPos != null && YogaHelpers.areConjunct(rahuPos, jupiterPos) &&
                ...
                yogas.add(Yoga(
                    ...
                    nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_VIJNAANA
                ))
            }
        }
        ...
        if (ketuPos != null) {
            ...
            if (ketuPos.house == 12) {
                ...
                yogas.add(Yoga(
                    ...
                    nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_MOKSHA
                ))
            }
    ...
    private fun evaluateDignityYogas(chart: VedicChart): List<Yoga> {
        ...
        if (exaltedPlanets.size >= 3) {
            ...
            yogas.add(Yoga(
                ...
                cancellationFactors = emptyList(),
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_UTTAMA_GRAHAS
            ))
        }
        ...
        if (ownSignPlanets.size >= 3) {
            ...
            yogas.add(Yoga(
                ...
                cancellationFactors = emptyList(),
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_SWAGRAHA
            ))
        }
        ...
        if (debilitatedPlanets.size >= 3) {
            ...
            yogas.add(Yoga(
                ...
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_NEECHA_GRAHAS
            ))
        }
        ...
        chart.planetPositions.forEach { pos ->
            ...
            if (d1Sign == d9Sign) {
                ...
                yogas.add(Yoga(
                    ...
                    cancellationFactors = emptyList(),
                    nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_VARGOTTAMA_SPEC
                ))
            }
        }
    ...
    private fun evaluateHousePositionYogas(chart: VedicChart, houseLords: Map<Int, Planet>): List<Yoga> {
        ...
        if (planetsInKendras.size >= 3 && allKendrasBenefic) {
            ...
            yogas.add(Yoga(
                ...
                cancellationFactors = emptyList(),
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_SUBHAPATI
            ))
        }
        ...
        if (maleficsIn1 && maleficsIn3) {
            ...
            yogas.add(Yoga(
                ...
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_DHANA_PAPA_KARTARI
            ))
        }
        ...
        houseCounts.filter { it.value.size >= 3 }.forEach { (house, positions) ->
            ...
            yogas.add(Yoga(
                ...
                nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_TRIGRAHA
            ))
        }
            ...
            for (j in i + 1 until mainPlanets.size) {
                ...
                if (normalizedDistance <= 1.0) {
                    ...
                    yogas.add(Yoga(
                        ...
                        nameKey = com.astro.vajra.core.common.StringKeyYogaExpanded.YOGA_GRAHAYUDDHA
                    ))
                }
            }
        }
