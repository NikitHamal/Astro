...
object DwadasamsaAnalyzer {
    ...
    private fun analyzeInheritance(d12: com.astro.vajra.ephemeris.DivisionalChartData, lang: Language): InheritanceAnalysis {
    ...
    private fun analyzeAncestralProperty(d12: com.astro.vajra.ephemeris.DivisionalChartData, lang: Language): List<String> {
    ...
    private fun analyzeFamilyLineage(d12: com.astro.vajra.ephemeris.DivisionalChartData, lang: Language): List<String> {
    ...
    private fun analyzeParentalLongevity(d12: com.astro.vajra.ephemeris.DivisionalChartData, lang: Language): ParentalLongevityIndicators {
