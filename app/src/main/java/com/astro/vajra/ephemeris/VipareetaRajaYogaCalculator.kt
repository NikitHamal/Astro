...
object VipareetaRajaYogaCalculator {
    ...
    enum class VipareetaYogaType(
        ...
        HARSHA(
            ...
            com.astro.vajra.core.common.StringKeyMatch.YOGA_VIPARITA, // Shared or specific
            com.astro.vajra.core.common.StringKeyYogaExpanded.VIP_DESC_HARSHA
        ),
        SARALA(
            "Sarala Yoga",
            "सरल योग",
            ...
            com.astro.vajra.core.common.StringKeyMatch.YOGA_VIPARITA,
            com.astro.vajra.core.common.StringKeyYogaExpanded.VIP_DESC_SARALA
        ),
        VIMALA(
            "Vimala Yoga",
            "विमल योग",
            ...
            com.astro.vajra.core.common.StringKeyMatch.YOGA_VIPARITA,
            com.astro.vajra.core.common.StringKeyYogaExpanded.VIP_DESC_VIMALA
        )
    }
     ...
     */
    enum class YogaStrength(val displayName: String, val score: Int, val key: com.astro.vajra.core.common.StringKeyInterface) {
        EXCEPTIONAL("Exceptional", 5, com.astro.vajra.core.common.StringKeyYogaExpanded.STRENGTH_EXCEPTIONAL),
        STRONG("Strong", 4, com.astro.vajra.core.common.StringKeyYogaExpanded.STRENGTH_STRONG_VIP),
        MODERATE("Moderate", 3, com.astro.vajra.core.common.StringKeyYogaExpanded.STRENGTH_MODERATE_VIP),
        MILD("Mild", 2, com.astro.vajra.core.common.StringKeyYogaExpanded.STRENGTH_MILD),
        WEAK("Weak", 1, com.astro.vajra.core.common.StringKeyYogaExpanded.STRENGTH_WEAK_VIP),
        NOT_FORMED("Not Formed", 0, com.astro.vajra.core.common.StringKeyYogaExpanded.STRENGTH_NOT_FORMED)
    }

    /**
     * Activation status of the yoga
     */
    enum class ActivationStatus(val displayName: String, val key: com.astro.vajra.core.common.StringKeyInterface) {
        FULLY_ACTIVE("Fully Active", com.astro.vajra.core.common.StringKeyYogaExpanded.STATUS_FULLY_ACTIVE),
        PARTIALLY_ACTIVE("Partially Active", com.astro.vajra.core.common.StringKeyYogaExpanded.STATUS_PARTIALLY_ACTIVE),
        LATENT("Latent - Awaiting Activation", com.astro.vajra.core.common.StringKeyYogaExpanded.STATUS_LATENT),
        DORMANT("Dormant", com.astro.vajra.core.common.StringKeyYogaExpanded.STATUS_DORMANT),
        CANCELLED("Cancelled by Afflictions", com.astro.vajra.core.common.StringKeyYogaExpanded.STATUS_CANCELLED)
    }
    ...
    private fun createDefaultYoga(
        ...
        return VipareetaYoga(
            ...
            dusthanaLordPosition = PlanetPosition(
                ...
                seconds = 0.0,
                isRetrograde = false,
                nakshatra = com.astro.vajra.core.model.Nakshatra.ASHWINI,
                nakshatraPada = 1,
                house = 1
            ),
            placedInHouse = 0,
