...
object YogaLocalization {
    ...
    fun getLocalizedYogaName(yoga: Yoga, language: Language): String {
        yoga.nameKey?.let { key ->
            ...
            if (yoga.category == YogaCategory.BHAVA_YOGA && yoga.houses.isNotEmpty()) {
                ...
                val houseName = StringResources.get(com.astro.vajra.core.common.StringKeyMatch.HOUSE_LABEL, language, yoga.houses.first())
    ...
    private fun getLordKey(planet: Planet?): com.astro.vajra.core.common.StringKeyInterface {
        return when (planet) {
            ...
            else -> com.astro.vajra.core.common.StringKeyMatch.REPORT_PLANET
        }
    }
