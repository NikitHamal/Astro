...
class ConjunctionYogaEvaluator : YogaEvaluator {
    ...
    private fun createPairYoga(
        chart: VedicChart,
        p1: com.astro.vajra.core.model.PlanetPosition,
        p2: com.astro.vajra.core.model.PlanetPosition,
        house: Int
    ): Yoga? {
    ...
    private fun createGroupYoga(
        chart: VedicChart,
        positions: List<com.astro.vajra.core.model.PlanetPosition>,
        house: Int
    ): Yoga {
    ...
    private fun getPairEffectKey(p1: Planet, p2: Planet): com.astro.vajra.core.common.StringKeyInterface? {
