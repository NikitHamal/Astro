...
object YogaHelpers {
    ...
    fun hasNeechaBhanga(pos: PlanetPosition, chart: VedicChart): Boolean {
        ...
        val exaltationSign = com.astro.vajra.ephemeris.AstrologicalConstants.EXALTATION_SIGNS[pos.planet]
        ...
        val planetExaltedInThisSign = com.astro.vajra.ephemeris.AstrologicalConstants.EXALTATION_SIGNS.filterValues { sign -> sign == debilitatedSign }.keys.firstOrNull()
    ...
    fun calculateDynamicYogaStrength(
        chart: VedicChart,
        positions: List<PlanetPosition>,
        shadbalaAnalysis: com.astro.vajra.ephemeris.ShadbalaAnalysis? = null
    ): Double {
