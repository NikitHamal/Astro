...
object SahamCalculator {
    ...
    private fun generateSahamInterpretation(type: SahamType, sign: com.astro.vajra.core.model.ZodiacSign, house: Int, lord: Planet, lordHouse: Int, lordStrength: String, language: Language): String {
