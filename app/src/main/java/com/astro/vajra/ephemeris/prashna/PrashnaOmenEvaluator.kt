...
import com.astro.vajra.ephemeris.prashna.PrashnaHelpers.calculateHoraLord
import com.astro.vajra.ephemeris.prashna.PrashnaHelpers.detectPlanetaryWars
import com.astro.vajra.ephemeris.prashna.PrashnaHelpers.getCombustionOrb
import com.astro.vajra.ephemeris.prashna.PrashnaHelpers.getDayLord
import com.astro.vajra.ephemeris.prashna.PrashnaHelpers.isAuspiciousNakshatra
...
object PrashnaOmenEvaluator {
    ...
    private fun getNakshatraIndication(nakshatra: com.astro.vajra.core.model.Nakshatra, language: Language): String {
