package com.astro.vajra.ephemeris.panchanga
...
data class PanchangaData(
    ...
    val moonriseTime: LocalTime? = null,
    val moonsetTime: LocalTime? = null,
    val sunriseJD: Double = 0.0,
    val sunsetJD: Double = 0.0,
    val moonriseJD: Double? = null,
    val moonsetJD: Double? = null,
