...
object NavamsaMarriageAnalyzer {
    ...
    private fun analyzeMultipleMarriageFactors(chart: VedicChart, d9: com.astro.vajra.ephemeris.DivisionalChartData, lang: Language): MultipleMarriageIndicators {
