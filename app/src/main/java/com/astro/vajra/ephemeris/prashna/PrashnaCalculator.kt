...
import com.astro.vajra.ephemeris.prashna.PrashnaConstants.AYANAMSA_LAHIRI
...
import com.astro.vajra.ephemeris.prashna.PrashnaConstants.SEFLG_SIDEREAL
import com.astro.vajra.ephemeris.prashna.PrashnaConstants.SEFLG_SPEED
import com.astro.vajra.ephemeris.prashna.PrashnaHelpers.calculateJulianDay
...
class PrashnaCalculator(context: Context) {
    ...
    private fun calculatePlanetPosition(
        ...
        val (nakshatra, pada) = com.astro.vajra.core.model.Nakshatra.fromLongitude(longitude)
