...
import com.astro.vajra.ephemeris.KemadrumaYogaCalculator
...
class ChandraYogaEvaluator : YogaEvaluator {
    ...
    private fun evaluateLunarPositionYogas(chart: VedicChart, moonPos: PlanetPosition, yogas: MutableList<Yoga>) {
        ...
        if (kemadrumaAnalysis.isKemadrumaFormed) {
            ...
            yogas.add(Yoga(
                ...
                nameKey = if (isFullyCancelled) com.astro.vajra.core.common.StringKeyMatch.YOGA_KEMADRUMA_BHANGA else com.astro.vajra.core.common.StringKeyMatch.YOGA_KEMADRUMA,
                effectsKey = if (isFullyCancelled) com.astro.vajra.core.common.StringKeyMatch.YOGA_EFFECT_KEMADRUMA_BHANGA else com.astro.vajra.core.common.StringKeyMatch.YOGA_EFFECT_KEMADRUMA
            ))
        }
    ...
    private fun createSunafaYoga(
        ...
        return Yoga(
            ...
            nameKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_SUNAFA,
            effectsKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_EFFECT_SUNAFA
        )
    }
    ...
    private fun createAnafaYoga(
        ...
        return Yoga(
            ...
            activationPeriod = "Moon and ${planets.first().displayName} periods",
            cancellationFactors = emptyList(),
            nameKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_ANAFA,
            effectsKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_EFFECT_ANAFA
        )
    }
    ...
    private fun createDurudharaYoga(
        ...
        return Yoga(
            ...
            cancellationFactors = emptyList(),
            nameKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_DURUDHARA,
            effectsKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_EFFECT_DURUDHARA
        )
    }
    ...
    private fun evaluateGajaKesariYoga(chart: VedicChart, moonPos: PlanetPosition): Yoga? {
        ...
        if (YogaHelpers.isInKendraFrom(jupiterPos, moonPos)) {
            ...
            return Yoga(
                ...
                nameKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_GAJA_KESARI,
                effectsKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_EFFECT_GAJA_KESARI
            )
        }
    ...
    private fun evaluateAdhiYoga(chart: VedicChart, moonPos: PlanetPosition): Yoga? {
        ...
        if (beneficsInAdhiHouses.size >= 2) {
            ...
            return Yoga(
                ...
                cancellationFactors = emptyList(),
                nameKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_ADHI,
                effectsKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_EFFECT_ADHI
            )
        }
