...
import com.astro.vajra.ephemeris.varshaphala.SolarReturnCalculator.calculateSolarReturnChart
import com.astro.vajra.ephemeris.varshaphala.SolarReturnCalculator.calculateSolarReturnTime
import com.astro.vajra.ephemeris.varshaphala.VarshaphalaConstants.AYANAMSA_LAHIRI
import com.astro.vajra.ephemeris.varshaphala.VarshaphalaEvaluator.calculateMuntha
import com.astro.vajra.ephemeris.varshaphala.VarshaphalaEvaluator.calculateTriPatakiChakra
import com.astro.vajra.ephemeris.varshaphala.VarshaphalaEvaluator.determineYearLord
...
class VarshaphalaCalculator(context: Context) {
    ...
    private fun getYearLordDignityDescription(planet: com.astro.vajra.core.model.Planet, chart: SolarReturnChart, language: Language): String {
