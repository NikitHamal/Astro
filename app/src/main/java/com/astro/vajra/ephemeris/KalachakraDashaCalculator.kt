...
object KalachakraDashaCalculator {
    ...
    private fun assessPlanetStrength(
        planet: Planet,
        position: com.astro.vajra.core.model.PlanetPosition?,
        chart: VedicChart,
        language: Language
    ): String {
    ...
    private fun getFavorableAreas(sign: ZodiacSign, signLord: Planet, language: Language): List<String> {
        ...
        areas.add("${getLocalizedPlanetName(signLord, language)}-${StringResources.get(com.astro.vajra.core.common.StringKey.VARSHAPHALA_KEY_DATES, language)}") // Fallback to "Key Dates" or similar if needed, but better to have specific key
    ...
    private fun getLocalizedPlanetName(planet: Planet, language: Language): String {
        val key = when (planet) {
            Planet.SUN -> com.astro.vajra.core.common.StringKey.PLANET_SUN
            Planet.MOON -> com.astro.vajra.core.common.StringKey.PLANET_MOON
            Planet.MARS -> com.astro.vajra.core.common.StringKey.PLANET_MARS
            Planet.MERCURY -> com.astro.vajra.core.common.StringKey.PLANET_MERCURY
            Planet.JUPITER -> com.astro.vajra.core.common.StringKey.PLANET_JUPITER
            Planet.VENUS -> com.astro.vajra.core.common.StringKey.PLANET_VENUS
            Planet.SATURN -> com.astro.vajra.core.common.StringKey.PLANET_SATURN
            Planet.RAHU -> com.astro.vajra.core.common.StringKey.PLANET_RAHU
            Planet.KETU -> com.astro.vajra.core.common.StringKey.PLANET_KETU
