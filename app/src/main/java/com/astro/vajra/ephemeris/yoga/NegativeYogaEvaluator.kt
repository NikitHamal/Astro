        ...
        if (houseFromJupiter in listOf(6, 8, 12)) {
            ...
            if (isCancelled) {
                ...
                return Yoga(
                    ...
                    nameKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_KEMADRUMA_BHANGA,
                    effectsKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_EFFECT_KEMADRUMA_BHANGA
                )
            }
            ...
            return Yoga(
                ...
                nameKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_SAKATA,
                effectsKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_EFFECT_SAKATA
            )
        }
    ...
    private fun evaluateDaridraYoga(chart: VedicChart, houseLords: Map<Int, Planet>): Yoga? {
        ...
        if (lord11Pos.house in listOf(6, 8, 12)) {
            ...
            return Yoga(
                ...
                nameKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_DARIDRA,
                effectsKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_EFFECT_DARIDRA
            )
        }
    ...
    private fun evaluateGuruChandalYoga(chart: VedicChart): Yoga? {
        ...
        if (YogaHelpers.areConjunct(jupiterPos, rahuPos, 10.0)) {
            ...
            return Yoga(
                ...
                nameKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_GURU_CHANDAL,
                effectsKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_EFFECT_GURU_CHANDAL
            )
        }
    ...
    private fun evaluateGrahanYogas(chart: VedicChart): List<Yoga> {
        ...
        if (sunPos != null && rahuPos != null && YogaHelpers.areConjunct(sunPos, rahuPos, 12.0)) {
            ...
            yogas.add(Yoga(
                ...
                nameKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_SURYA_GRAHAN,
                effectsKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_EFFECT_SURYA_GRAHAN
            ))
        }
        ...
        if (sunPos != null && ketuPos != null && YogaHelpers.areConjunct(sunPos, ketuPos, 12.0)) {
            ...
            yogas.add(Yoga(
                ...
                nameKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_SURYA_KETU_GRAHAN,
                effectsKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_EFFECT_SURYA_KETU_GRAHAN
            ))
        }
        ...
        if (moonPos != null && rahuPos != null && YogaHelpers.areConjunct(moonPos, rahuPos, 12.0)) {
            ...
            yogas.add(Yoga(
                ...
                nameKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_CHANDRA_GRAHAN,
                effectsKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_EFFECT_CHANDRA_GRAHAN
            ))
        }
        ...
        if (moonPos != null && ketuPos != null && YogaHelpers.areConjunct(moonPos, ketuPos, 12.0)) {
            ...
            yogas.add(Yoga(
                ...
                nameKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_CHANDRA_KETU,
                effectsKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_EFFECT_CHANDRA_KETU
            ))
        }
    ...
    private fun evaluateAngarakYoga(chart: VedicChart): Yoga? {
        ...
        if (YogaHelpers.areConjunct(marsPos, rahuPos, 10.0)) {
            ...
            return Yoga(
                ...
                nameKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_ANGARAK,
                effectsKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_EFFECT_ANGARAK
            )
        }
    ...
    private fun evaluateShrapitYoga(chart: VedicChart): Yoga? {
        ...
        if (YogaHelpers.areConjunct(saturnPos, rahuPos, 10.0)) {
            ...
            return Yoga(
                ...
                nameKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_SHRAPIT,
                effectsKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_EFFECT_SHRAPIT
            )
        }
    ...
    private fun evaluateKalaSarpaYoga(chart: VedicChart): Yoga? {
        ...
        if (isFullKalaSarpa || isPartialKalaSarpa) {
            ...
            return Yoga(
                ...
                nameKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_KALA_SARPA,
                effectsKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_EFFECT_KALA_SARPA
            )
        }
        ...
        if (ascendantPos != null) {
            ...
            if (hasMaleficBefore && hasMaleficAfter) {
                yogas.add(Yoga(
                    ...
                    nameKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_PAPAKARTARI,
                    effectsKey = com.astro.vajra.core.common.StringKeyMatch.YOGA_EFFECT_PAPAKARTARI
                ))
            }
        }
