...
object SaptamsaAnalyzer {
    ...
    enum class ChildGender(val key: com.astro.vajra.core.common.StringKeySaptamsa) {
        MALE(com.astro.vajra.core.common.StringKeySaptamsa.GENDER_MALE),
        FEMALE(com.astro.vajra.core.common.StringKeySaptamsa.GENDER_FEMALE),
        UNCERTAIN(com.astro.vajra.core.common.StringKeySaptamsa.GENDER_UNCERTAIN);

        val displayName: String get() = key.en
    }

    enum class RelationshipQuality(val key: com.astro.vajra.core.common.StringKeySaptamsa, val score: Int) {
        EXCELLENT(com.astro.vajra.core.common.StringKeySaptamsa.QUAL_EXCELLENT, 90),
        GOOD(com.astro.vajra.core.common.StringKeySaptamsa.QUAL_GOOD, 75),
        MODERATE(com.astro.vajra.core.common.StringKeySaptamsa.QUAL_MODERATE, 60),
        CHALLENGING(com.astro.vajra.core.common.StringKeySaptamsa.QUAL_CHALLENGING, 40),
        DIFFICULT(com.astro.vajra.core.common.StringKeySaptamsa.QUAL_DIFFICULT, 25);
    ...
    enum class FertilityStatus(val key: com.astro.vajra.core.common.StringKeySaptamsa) {
        HIGHLY_FAVORABLE(com.astro.vajra.core.common.StringKeySaptamsa.STATUS_HIGHLY_FAVORABLE),
        FAVORABLE(com.astro.vajra.core.common.StringKeySaptamsa.STATUS_FAVORABLE),
        MODERATE(com.astro.vajra.core.common.StringKeySaptamsa.STATUS_MODERATE),
        CHALLENGING(com.astro.vajra.core.common.StringKeySaptamsa.STATUS_CHALLENGING),
        NEEDS_ATTENTION(com.astro.vajra.core.common.StringKeySaptamsa.STATUS_NEEDS_ATTENTION);
    ...
    data class SanthanaYoga(
        ...
        val effect: String,
        val strength: Double,
        val nameKey: com.astro.vajra.core.common.StringKeySaptamsa,
        val sanskritKey: com.astro.vajra.core.common.StringKeySaptamsa,
        val effectKey: com.astro.vajra.core.common.StringKeySaptamsa
    )
