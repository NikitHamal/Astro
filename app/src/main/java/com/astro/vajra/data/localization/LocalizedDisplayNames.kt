...
import com.astro.vajra.core.model.Gender
...
import com.astro.vajra.core.model.Yoni
import com.astro.vajra.ephemeris.panchanga.Tithi
import com.astro.vajra.ephemeris.panchanga.TithiGroup
import com.astro.vajra.ephemeris.panchanga.Yoga as NityaYoga
import com.astro.vajra.ephemeris.panchanga.YogaNature
import com.astro.vajra.ephemeris.panchanga.Karana
import com.astro.vajra.ephemeris.panchanga.KaranaType
import com.astro.vajra.ephemeris.panchanga.Vara
import com.astro.vajra.ephemeris.panchanga.Paksha
...
import com.astro.vajra.ephemeris.TransitQuality as UpachayaTransitQuality
...
import com.astro.vajra.ephemeris.RetrogradeCombustionCalculator
import com.astro.vajra.ephemeris.yoga.YogaCategory
import com.astro.vajra.ephemeris.yoga.YogaStrength
import com.astro.vajra.ephemeris.remedy.RemedyCategory
 ...
 */
fun com.astro.vajra.ephemeris.PanchMahapurushaYogaCalculator.RecommendationType.getLocalizedName(language: Language): String {
    return when (this) {
        com.astro.vajra.ephemeris.PanchMahapurushaYogaCalculator.RecommendationType.STRENGTHENING -> if (language == Language.NEPALI) "सुदृढीकरण अभ्यास" else "Strengthening Practice"
        com.astro.vajra.ephemeris.PanchMahapurushaYogaCalculator.RecommendationType.CAREER -> if (language == Language.NEPALI) "क्यारियर संरेखण" else "Career Alignment"
        com.astro.vajra.ephemeris.PanchMahapurushaYogaCalculator.RecommendationType.GEMSTONE -> if (language == Language.NEPALI) "रत्न सिफारिस" else "Gemstone Recommendation"
        com.astro.vajra.ephemeris.PanchMahapurushaYogaCalculator.RecommendationType.MANTRA -> if (language == Language.NEPALI) "मन्त्र जप" else "Mantra Recitation"
        com.astro.vajra.ephemeris.PanchMahapurushaYogaCalculator.RecommendationType.CHARITY -> if (language == Language.NEPALI) "परोपकारी कार्य" else "Charitable Practice"
    }
}
 ...
 */
fun com.astro.vajra.ephemeris.HoroscopeCalculator.LifeArea.getLocalizedName(language: Language): String {
    return when (this) {
        com.astro.vajra.ephemeris.HoroscopeCalculator.LifeArea.CAREER -> StringResources.get(StringKey.LIFE_AREA_CAREER, language)
        com.astro.vajra.ephemeris.HoroscopeCalculator.LifeArea.LOVE -> StringResources.get(StringKey.LIFE_AREA_LOVE, language)
        com.astro.vajra.ephemeris.HoroscopeCalculator.LifeArea.HEALTH -> StringResources.get(StringKey.LIFE_AREA_HEALTH, language)
        com.astro.vajra.ephemeris.HoroscopeCalculator.LifeArea.FINANCE -> StringResources.get(StringKey.LIFE_AREA_FINANCE, language)
        com.astro.vajra.ephemeris.HoroscopeCalculator.LifeArea.FAMILY -> StringResources.get(StringKey.LIFE_AREA_FAMILY, language)
        com.astro.vajra.ephemeris.HoroscopeCalculator.LifeArea.SPIRITUALITY -> StringResources.get(StringKey.LIFE_AREA_SPIRITUALITY, language)
    }
}
 ...
 */
fun com.astro.vajra.ephemeris.HoroscopeCalculator.LifeArea.getLocalizedFullName(language: Language): String {
    return when (this) {
        com.astro.vajra.ephemeris.HoroscopeCalculator.LifeArea.CAREER -> StringResources.get(StringKey.LIFE_AREA_CAREER_FULL, language)
        com.astro.vajra.ephemeris.HoroscopeCalculator.LifeArea.LOVE -> StringResources.get(StringKey.LIFE_AREA_LOVE_FULL, language)
        com.astro.vajra.ephemeris.HoroscopeCalculator.LifeArea.HEALTH -> StringResources.get(StringKey.LIFE_AREA_HEALTH_FULL, language)
        com.astro.vajra.ephemeris.HoroscopeCalculator.LifeArea.FINANCE -> StringResources.get(StringKey.LIFE_AREA_FINANCE_FULL, language)
        com.astro.vajra.ephemeris.HoroscopeCalculator.LifeArea.FAMILY -> StringResources.get(StringKey.LIFE_AREA_FAMILY_FULL, language)
        com.astro.vajra.ephemeris.HoroscopeCalculator.LifeArea.SPIRITUALITY -> StringResources.get(StringKey.LIFE_AREA_SPIRITUALITY_FULL, language)
    }
}
 ...
 */
fun com.astro.vajra.ephemeris.HoroscopeCalculator.LifeArea.getLocalizedRecommendation(language: Language): String {
    return when (this) {
        com.astro.vajra.ephemeris.HoroscopeCalculator.LifeArea.CAREER -> StringResources.get(StringKey.AREA_REC_CAREER, language)
        com.astro.vajra.ephemeris.HoroscopeCalculator.LifeArea.LOVE -> StringResources.get(StringKey.AREA_REC_LOVE, language)
        com.astro.vajra.ephemeris.HoroscopeCalculator.LifeArea.HEALTH -> StringResources.get(StringKey.AREA_REC_HEALTH, language)
        com.astro.vajra.ephemeris.HoroscopeCalculator.LifeArea.FINANCE -> StringResources.get(StringKey.AREA_REC_FINANCE, language)
        com.astro.vajra.ephemeris.HoroscopeCalculator.LifeArea.FAMILY -> StringResources.get(StringKey.AREA_REC_FAMILY, language)
        com.astro.vajra.ephemeris.HoroscopeCalculator.LifeArea.SPIRITUALITY -> StringResources.get(StringKey.AREA_REC_SPIRITUALITY, language)
    }
}
