...
object PanchangaDataProvider {
     ...
     */
    fun getNakshatraData(nakshatra: com.astro.vajra.core.model.Nakshatra): LocalizedNakshatraData {
        return when (nakshatra) {
            com.astro.vajra.core.model.Nakshatra.ASHWINI -> LocalizedNakshatraData(
                sanskrit = "अश्विनी",
            ...
            com.astro.vajra.core.model.Nakshatra.BHARANI -> LocalizedNakshatraData(
                sanskrit = "भरणी",
     ...
     */
    fun getYogaData(yoga: com.astro.vajra.ephemeris.panchanga.Yoga): LocalizedYogaData {
        return when (yoga) {
            com.astro.vajra.ephemeris.panchanga.Yoga.VISHKUMBHA -> LocalizedYogaData(
                sanskrit = "विष्कुम्भ",
                number = 1,
            ...
            com.astro.vajra.ephemeris.panchanga.Yoga.PRITI -> LocalizedYogaData(
                sanskrit = "प्रीति",
                number = 2,
     ...
     */
    fun getKaranaData(karana: com.astro.vajra.ephemeris.panchanga.Karana): LocalizedKaranaData {
        val number = com.astro.vajra.ephemeris.panchanga.Karana.entries.indexOf(karana) + 1
        return when (karana) {
            com.astro.vajra.ephemeris.panchanga.Karana.BAVA -> LocalizedKaranaData(
                sanskrit = "बव",
                number = number,
                typeEn = "Movable",
                typeNe = "चर",
            ...
            com.astro.vajra.ephemeris.panchanga.Karana.BALAVA -> LocalizedKaranaData(
                sanskrit = "बालव",
                number = number,
                typeEn = "Movable",
                typeNe = "चर",
                ...
                typeNe = if (karana.type == com.astro.vajra.ephemeris.panchanga.KaranaType.FIXED) "स्थिर" else "चर",
                quality = Quality.NEUTRAL,
