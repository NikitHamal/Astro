...
fun PanchangaTabContent(chart: VedicChart) {
    ...
    LazyColumn(
        ...
        item {
            TithiCard(
                panchanga = panchanga,
                isExpanded = "Tithi" in expandedCardTitles,
                onToggleExpand = {
                    if (it) {
                        expandedCardTitles.add("Tithi")
                    } else {
                        expandedCardTitles.remove("Tithi")
                    }
                }
            )
        }
        ...
        item {
            NakshatraCard(
                panchanga = panchanga,
                isExpanded = "Nakshatra" in expandedCardTitles,
                onToggleExpand = {
                    if (it) {
                        expandedCardTitles.add("Nakshatra")
                    } else {
                        expandedCardTitles.remove("Nakshatra")
                    }
                }
            )
        }
        ...
        item {
            YogaCard(
                panchanga = panchanga,
                isExpanded = "Yoga" in expandedCardTitles,
                onToggleExpand = {
                    if (it) {
                        expandedCardTitles.add("Yoga")
                    } else {
                        expandedCardTitles.remove("Yoga")
                    }
                }
            )
        }
        ...
        item {
            KaranaCard(
                panchanga = panchanga,
                isExpanded = "Karana" in expandedCardTitles,
                onToggleExpand = {
                    if (it) {
                        expandedCardTitles.add("Karana")
                    } else {
                        expandedCardTitles.remove("Karana")
                    }
                }
            )
        }
        ...
        item {
            VaraCard(
                panchanga = panchanga,
                isExpanded = "Vara" in expandedCardTitles,
                onToggleExpand = {
                    if (it) {
                        expandedCardTitles.add("Vara")
                    } else {
                        expandedCardTitles.remove("Vara")
                    }
                }
            )
        }
        ...
        item {
            PanchangaInfoCard(
                isExpanded = "PanchangaInfo" in expandedCardTitles,
                onToggleExpand = {
                    if (it) {
                        expandedCardTitles.add("PanchangaInfo")
                    } else {
                        expandedCardTitles.remove("PanchangaInfo")
                    }
                }
            )
        }
...
@Composable
private fun PanchangaInfoCard(isExpanded: Boolean, onToggleExpand: (Boolean) -> Unit) {
    val rotation by animateFloatAsState(
        targetValue = if (isExpanded) 180f else 0f,
        label = "rotation"
    )
