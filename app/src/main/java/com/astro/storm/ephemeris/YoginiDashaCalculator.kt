...
object YoginiDashaCalculator {
    ...
    enum class Yogini(
        ...
        MANGALA(
            ...
            descriptionKey = StringKeyDashaPart3.YOGINI_MANGALA_DESC
        ),
        PINGALA(
            planet = Planet.SUN,
            years = 2,
            ...
            descriptionKey = StringKeyDashaPart3.YOGINI_PINGALA_DESC
        ),
        DHANYA(
            ...
            descriptionKey = StringKeyDashaPart3.YOGINI_DHANYA_DESC
        ),
        BHRAMARI(
            planet = Planet.MARS,
            years = 4,
            ...
            descriptionKey = StringKeyDashaPart2.YOGINI_BHRAMARI_DESC
        ),
        BHADRIKA(
            ...
            sanskrit = "भद्रिका",
            nature = YoginiNature.AUSPICIOUS,
            descriptionKey = StringKeyDashaPart2.YOGINI_BHADRIKA_DESC
        ),
        ULKA(
            ...
            sanskrit = "उल्का",
            nature = YoginiNature.CHALLENGING,
            descriptionKey = StringKeyDashaPart3.YOGINI_ULKA_DESC
        ),
        SIDDHA(
            planet = Planet.VENUS,
            years = 7,
            ...
            sanskrit = "सिद्धा",
            nature = YoginiNature.HIGHLY_AUSPICIOUS,
            descriptionKey = StringKeyDashaPart3.YOGINI_SIDDHA_DESC
        ),
        SANKATA(
            planet = Planet.RAHU,
            years = 8,
            ...
            descriptionKey = StringKeyDashaPart3.YOGINI_SANKATA_DESC
        );
    ...
    enum class YoginiNature {
        ...
        fun getLocalizedName(language: Language): String {
            return when (this) {
                HIGHLY_AUSPICIOUS -> StringResources.get(StringKeyDashaPart3.YOGINI_NATURE_HIGHLY_AUSPICIOUS, language)
                AUSPICIOUS -> StringResources.get(StringKeyDashaPart3.YOGINI_NATURE_AUSPICIOUS, language)
                MIXED -> StringResources.get(StringKeyDashaPart3.YOGINI_NATURE_MIXED, language)
                CHALLENGING -> StringResources.get(StringKeyDashaPart3.YOGINI_NATURE_CHALLENGING, language)
                DIFFICULT -> StringResources.get(StringKeyDashaPart3.YOGINI_NATURE_DIFFICULT, language)
            }
        }
    }
    ...
    fun generateInterpretation(
        ...
        val careerEffects = when (yogini) {
            Yogini.MANGALA -> StringResources.get(StringKeyDashaPart3.YOGINI_MANGALA_CAREER, language)
            Yogini.PINGALA -> StringResources.get(StringKeyDashaPart3.YOGINI_PINGALA_CAREER, language)
            Yogini.DHANYA -> StringResources.get(StringKeyDashaPart3.YOGINI_DHANYA_CAREER, language)
            Yogini.BHRAMARI -> StringResources.get(StringKeyDashaPart2.YOGINI_BHRAMARI_CAREER, language)
            Yogini.BHADRIKA -> StringResources.get(StringKeyDashaPart2.YOGINI_BHADRIKA_CAREER, language)
            Yogini.ULKA -> StringResources.get(StringKeyDashaPart3.YOGINI_ULKA_CAREER, language)
            Yogini.SIDDHA -> StringResources.get(StringKeyDashaPart3.YOGINI_SIDDHA_CAREER, language)
            Yogini.SANKATA -> StringResources.get(StringKeyDashaPart3.YOGINI_SANKATA_CAREER, language)
        }

        val relationshipEffects = when (yogini) {
            Yogini.MANGALA -> StringResources.get(StringKeyDashaPart3.YOGINI_MANGALA_RELATIONSHIP, language)
            Yogini.PINGALA -> StringResources.get(StringKeyDashaPart3.YOGINI_PINGALA_RELATIONSHIP, language)
            Yogini.DHANYA -> StringResources.get(StringKeyDashaPart3.YOGINI_DHANYA_RELATIONSHIP, language)
            Yogini.BHRAMARI -> StringResources.get(StringKeyDashaPart2.YOGINI_BHRAMARI_RELATIONSHIP, language)
            Yogini.BHADRIKA -> StringResources.get(StringKeyDashaPart2.YOGINI_BHADRIKA_RELATIONSHIP, language)
            Yogini.ULKA -> StringResources.get(StringKeyDashaPart3.YOGINI_ULKA_RELATIONSHIP, language)
            Yogini.SIDDHA -> StringResources.get(StringKeyDashaPart3.YOGINI_SIDDHA_RELATIONSHIP, language)
            Yogini.SANKATA -> StringResources.get(StringKeyDashaPart3.YOGINI_SANKATA_RELATIONSHIP, language)
        }

        val healthEffects = when (yogini) {
            Yogini.MANGALA -> StringResources.get(StringKeyDashaPart3.YOGINI_MANGALA_HEALTH, language)
            Yogini.PINGALA -> StringResources.get(StringKeyDashaPart3.YOGINI_PINGALA_HEALTH, language)
            Yogini.DHANYA -> StringResources.get(StringKeyDashaPart3.YOGINI_DHANYA_HEALTH, language)
            Yogini.BHRAMARI -> StringResources.get(StringKeyDashaPart2.YOGINI_BHRAMARI_HEALTH, language)
            Yogini.BHADRIKA -> StringResources.get(StringKeyDashaPart2.YOGINI_BHADRIKA_HEALTH, language)
            Yogini.ULKA -> StringResources.get(StringKeyDashaPart3.YOGINI_ULKA_HEALTH, language)
            Yogini.SIDDHA -> StringResources.get(StringKeyDashaPart3.YOGINI_SIDDHA_HEALTH, language)
            Yogini.SANKATA -> StringResources.get(StringKeyDashaPart3.YOGINI_SANKATA_HEALTH, language)
        }

        val spiritualEffects = when (yogini) {
            Yogini.MANGALA -> StringResources.get(StringKeyDashaPart3.YOGINI_MANGALA_SPIRITUAL, language)
            Yogini.PINGALA -> StringResources.get(StringKeyDashaPart3.YOGINI_PINGALA_SPIRITUAL, language)
            Yogini.DHANYA -> StringResources.get(StringKeyDashaPart3.YOGINI_DHANYA_SPIRITUAL, language)
            Yogini.BHRAMARI -> StringResources.get(StringKeyDashaPart2.YOGINI_BHRAMARI_SPIRITUAL, language)
            Yogini.BHADRIKA -> StringResources.get(StringKeyDashaPart2.YOGINI_BHADRIKA_SPIRITUAL, language)
            Yogini.ULKA -> StringResources.get(StringKeyDashaPart3.YOGINI_ULKA_SPIRITUAL, language)
            Yogini.SIDDHA -> StringResources.get(StringKeyDashaPart3.YOGINI_SIDDHA_SPIRITUAL, language)
            Yogini.SANKATA -> StringResources.get(StringKeyDashaPart3.YOGINI_SANKATA_SPIRITUAL, language)
        }

        val recommendations = when (yogini) {
            Yogini.MANGALA -> listOf(
                StringResources.get(StringKeyDashaPart3.YOGINI_MANGALA_REC_1, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_MANGALA_REC_2, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_MANGALA_REC_3, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_MANGALA_REC_4, language)
            )
            Yogini.PINGALA -> listOf(
                StringResources.get(StringKeyDashaPart3.YOGINI_PINGALA_REC_1, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_PINGALA_REC_2, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_PINGALA_REC_3, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_PINGALA_REC_4, language)
            )
            Yogini.DHANYA -> listOf(
                StringResources.get(StringKeyDashaPart3.YOGINI_DHANYA_REC_1, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_DHANYA_REC_2, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_DHANYA_REC_3, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_DHANYA_REC_4, language)
            )
            Yogini.BHRAMARI -> listOf(
                StringResources.get(StringKeyDashaPart2.YOGINI_BHRAMARI_REC_1, language),
                StringResources.get(StringKeyDashaPart2.YOGINI_BHRAMARI_REC_2, language),
                StringResources.get(StringKeyDashaPart2.YOGINI_BHRAMARI_REC_3, language),
                StringResources.get(StringKeyDashaPart2.YOGINI_BHRAMARI_REC_4, language)
            )
            Yogini.BHADRIKA -> listOf(
                StringResources.get(StringKeyDashaPart2.YOGINI_BHADRIKA_REC_1, language),
                StringResources.get(StringKeyDashaPart2.YOGINI_BHADRIKA_REC_2, language),
                StringResources.get(StringKeyDashaPart2.YOGINI_BHADRIKA_REC_3, language),
                StringResources.get(StringKeyDashaPart2.YOGINI_BHADRIKA_REC_4, language)
            )
            Yogini.ULKA -> listOf(
                StringResources.get(StringKeyDashaPart3.YOGINI_ULKA_REC_1, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_ULKA_REC_2, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_ULKA_REC_3, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_ULKA_REC_4, language)
            )
            Yogini.SIDDHA -> listOf(
                StringResources.get(StringKeyDashaPart3.YOGINI_SIDDHA_REC_1, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_SIDDHA_REC_2, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_SIDDHA_REC_3, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_SIDDHA_REC_4, language)
            )
            Yogini.SANKATA -> listOf(
                StringResources.get(StringKeyDashaPart3.YOGINI_SANKATA_REC_1, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_SANKATA_REC_2, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_SANKATA_REC_3, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_SANKATA_REC_4, language)
            )
        }

        val cautionAreas = when (yogini) {
            Yogini.MANGALA -> listOf(
                StringResources.get(StringKeyDashaPart3.YOGINI_MANGALA_CAUTION_1, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_MANGALA_CAUTION_2, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_MANGALA_CAUTION_3, language)
            )
            Yogini.PINGALA -> listOf(
                StringResources.get(StringKeyDashaPart3.YOGINI_PINGALA_CAUTION_1, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_PINGALA_CAUTION_2, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_PINGALA_CAUTION_3, language)
            )
            Yogini.DHANYA -> listOf(
                StringResources.get(StringKeyDashaPart3.YOGINI_DHANYA_CAUTION_1, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_DHANYA_CAUTION_2, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_DHANYA_CAUTION_3, language)
            )
            Yogini.BHRAMARI -> listOf(
                StringResources.get(StringKeyDashaPart2.YOGINI_BHRAMARI_CAUTION_1, language),
                StringResources.get(StringKeyDashaPart2.YOGINI_BHRAMARI_CAUTION_2, language),
                StringResources.get(StringKeyDashaPart2.YOGINI_BHRAMARI_CAUTION_3, language)
            )
            Yogini.BHADRIKA -> listOf(
                StringResources.get(StringKeyDashaPart2.YOGINI_BHADRIKA_CAUTION_1, language),
                StringResources.get(StringKeyDashaPart2.YOGINI_BHADRIKA_CAUTION_2, language),
                StringResources.get(StringKeyDashaPart2.YOGINI_BHADRIKA_CAUTION_3, language)
            )
            Yogini.ULKA -> listOf(
                StringResources.get(StringKeyDashaPart3.YOGINI_ULKA_CAUTION_1, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_ULKA_CAUTION_2, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_ULKA_CAUTION_3, language)
            )
            Yogini.SIDDHA -> listOf(
                StringResources.get(StringKeyDashaPart3.YOGINI_SIDDHA_CAUTION_1, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_SIDDHA_CAUTION_2, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_SIDDHA_CAUTION_3, language)
            )
            Yogini.SANKATA -> listOf(
                StringResources.get(StringKeyDashaPart3.YOGINI_SANKATA_CAUTION_1, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_SANKATA_CAUTION_2, language),
                StringResources.get(StringKeyDashaPart3.YOGINI_SANKATA_CAUTION_3, language)
            )
        }
    ...
    private fun generateAntardashaInterpretation(
        ...
        return when {
            isFriendly -> StringResources.get(
                StringKeyDashaPart2.YOGINI_ANTAR_FRIENDLY,
                language,
            ...
            isHostile -> StringResources.get(
                StringKeyDashaPart2.YOGINI_ANTAR_HOSTILE,
                language,
                mahaName, antarName,
                antarPlanetName, mahaPlanetName
            )
            else -> StringResources.get(
                StringKeyDashaPart2.YOGINI_ANTAR_NEUTRAL,
                language,
                mahaName, antarName,
                antarPlanetName, mahaPlanetName
            )
    ...
    private fun assessApplicability(chart: VedicChart?, language: Language): Applicability {
        if (chart == null) {
            return Applicability(
                ...
                reasons = listOf(StringResources.get(StringKeyDashaPart2.YOGINI_APP_UNIVERSAL, language))
            )
        }
        ...
        if (chart.birthData.gender == com.astro.storm.core.model.Gender.FEMALE) {
            score += 0.2
            reasons.add(StringResources.get(StringKeyDashaPart2.YOGINI_APP_FEMALE, language))
        }
        ...
        if (moonPosition != null) {
            ...
            if (moonSign == ZodiacSign.TAURUS || moonSign == ZodiacSign.CANCER) {
                score += 0.15
                reasons.add(StringResources.get(StringKeyDashaPart2.YOGINI_APP_STRONG_MOON, language, moonSign.getLocalizedName(language)))
            }
        }
        ...
        if (birthHour < 6 || birthHour >= 18) {
            score += 0.1
            reasons.add(StringResources.get(StringKeyDashaPart2.YOGINI_APP_NIGHT_BIRTH, language))
        }

        // Always applicable for relationship timing
        reasons.add(StringResources.get(StringKeyDashaPart2.YOGINI_APP_RELATIONSHIP, language))

        // Add general applicability statement
        reasons.add(StringResources.get(StringKeyDashaPart2.YOGINI_APP_VALIDATION, language))
    ...
    fun getCurrentPeriodSummary(result: YoginiDashaResult, language: Language = Language.ENGLISH): String {
        val maha = result.currentMahadasha ?: return StringResources.get(StringKeyDashaPart1.DASHA_NO_ACTIVE_PERIOD, language)
        ...
        return buildString {
            appendLine("${StringResources.get(StringKeyDashaPart3.YOGINI_DASHA_TITLE, language)}: ${maha.yogini.getLocalizedName(language)}")
            appendLine("${StringResources.get(StringKeyGeneralPart8.PLANET, language)}: ${maha.yogini.planet.getLocalizedName(language)}")
            appendLine("${StringResources.get(StringKeyDashaPart1.DASHA_DURATION, language)}: ${maha.durationYears} ${StringResources.get(StringKeyGeneralPart12.YEARS, language)}")
            appendLine("${StringResources.get(StringKeyDashaPart1.DASHA_PROGRESS, language)}: ${String.format("%.1f", maha.getProgressPercent())}%")
            appendLine("${StringResources.get(StringKeyDashaPart1.DASHA_REMAINING, language)}: ${formatDays(maha.getRemainingDays())}")

            if (antar != null) {
                appendLine()
                appendLine("${StringResources.get(StringKeyDashaPart1.DASHA_ANTARDASHA, language)}: ${antar.yogini.getLocalizedName(language)}")
                appendLine("${StringResources.get(StringKeyDashaPart1.DASHA_PROGRESS, language)}: ${String.format("%.1f", antar.getProgressPercent())}%")
                append("${StringResources.get(StringKeyDashaPart1.DASHA_REMAINING, language)}: ${formatDays(antar.getRemainingDays())}")
            }
        }
    }
    /**
