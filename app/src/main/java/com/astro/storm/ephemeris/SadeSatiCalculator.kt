...
object SadeSatiCalculator {
    ...
    private fun getRemedies(
        ...
        remedies.add(Remedy(
            ...
            titleKey = StringKeyRemedy.REMEDY_SHANI_MANTRA_TITLE,
            descriptionKey = StringKeyRemedy.REMEDY_SHANI_MANTRA_DESC,
        ...
        remedies.add(Remedy(
            ...
            titleKey = StringKeyRemedy.REMEDY_SATURDAY_CHARITY_TITLE,
            descriptionKey = StringKeyRemedy.REMEDY_SATURDAY_CHARITY_DESC,
        ...
        remedies.add(Remedy(
            ...
            titleKey = StringKeyRemedy.REMEDY_SATURDAY_FAST_TITLE,
            descriptionKey = StringKeyRemedy.REMEDY_SATURDAY_FAST_DESC,
            timing = "Every Saturday",
            mantra = null
        ))
        ...
        if (severity == Severity.SIGNIFICANT || severity == Severity.INTENSE) {
            remedies.add(Remedy(
                ...
                titleKey = StringKeyRemedy.REMEDY_HANUMAN_WORSHIP_TITLE,
                descriptionKey = StringKeyRemedy.REMEDY_HANUMAN_WORSHIP_DESC,
            ...
            remedies.add(Remedy(
                ...
                titleKey = StringKeyRemedy.REMEDY_BLUE_SAPPHIRE_TITLE,
                descriptionKey = StringKeyRemedy.REMEDY_BLUE_SAPPHIRE_DESC,
