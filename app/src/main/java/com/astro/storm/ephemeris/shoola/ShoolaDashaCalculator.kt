...
object ShoolaDashaCalculator {
    ...
    fun calculateShoolaDasha(chart: VedicChart): ShoolaDashaResult? {
        ...
        return ShoolaDashaResult(
            ...
            overallAssessment = StringResources.get(StringKeyDashaPart2.SHOOLA_SUMMARY_EN, Language.ENGLISH),
            overallAssessmentNe = StringResources.get(StringKeyDashaPart2.SHOOLA_SUMMARY_NE, Language.NEPALI),
