...
object DashamsaAnalyzer {
    ...
    private fun getCareerTypeFromPlanet(p: Planet, lang: Language): CareerType = when (p) {
        ...
        Planet.RAHU -> CareerType(StringResources.get(StringKeyDivisional.DASHAMSA_TYPE_UNCONVENTIONAL, lang), listOf(StringKeyDivisional.HORA_SUN_SOURCE_TECHNOLOGY, StringKeyDivisional.HORA_SUN_SOURCE_FOREIGN, StringKeyDivisional.HORA_SUN_SOURCE_RESEARCH, StringKeyPrashnaPart1.PRASHNA_CAT_GENERAL).map { StringResources.get(it, lang) }, StringResources.get(StringKeyDivisional.DASHAMSA_SUIT_UNCONVENTIONAL, lang))
        Planet.KETU -> CareerType(StringResources.get(StringKeyDivisional.DASHAMSA_TYPE_SPIRITUAL, lang), listOf(StringKeyDivisional.HORA_SUN_SOURCE_SPIRITUAL, StringKeyDivisional.HORA_SUN_SOURCE_OCCULT, StringKeyDivisional.HORA_SUN_SOURCE_RESEARCH, StringKeyPrashnaPart1.PRASHNA_CAT_HEALTH).map { StringResources.get(it, lang) }, StringResources.get(StringKeyDivisional.DASHAMSA_SUIT_SPIRITUAL, lang))
    ...
    private fun getIndustriesForPlanet(p: Planet, lang: Language): List<String> = when (p) {
        ...
        Planet.MARS -> listOf(StringKeyDivisional.NAVAMSA_PROF_MILITARY, StringKeyGeneralPart1.ACTIVITY_BUSINESS_NAME, StringKeyDivisional.NAVAMSA_PROF_MEDICINE, StringKeyDivisional.NAVAMSA_PROF_ENGINEERING, StringKeyDivisional.HORA_SUN_SOURCE_REAL_ESTATE)
        Planet.MERCURY -> listOf(StringKeyDivisional.NAVAMSA_PROF_BUSINESS, StringKeyPrashnaPart1.PRASHNA_CAT_FINANCE, StringKeyDivisional.NAVAMSA_PROF_WRITING, StringKeyDivisional.NAVAMSA_PROF_TECH, StringKeyDivisional.HORA_SUN_SOURCE_COMMUNICATION)
        ...
        Planet.RAHU -> listOf(StringKeyDivisional.HORA_SUN_SOURCE_TECHNOLOGY, StringKeyDivisional.HORA_SUN_SOURCE_TRADE, StringKeyGeneralPart1.ACTIVITY_TRAVEL_NAME, StringKeyDivisional.HORA_SUN_SOURCE_LIQUIDS)
        Planet.KETU -> listOf(StringKeyDivisional.HORA_SUN_SOURCE_SPIRITUAL, StringKeyDivisional.HORA_SUN_SOURCE_OCCULT, StringKeyGeneralPart1.ACTIVITY_MEDICAL_NAME, StringKeyDivisional.HORA_SUN_SOURCE_RESEARCH)
        else -> emptyList()
