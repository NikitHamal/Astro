...
object KalachakraDashaCalculator {
    ...
    enum class NakshatraGroup(val displayName: String, val description: String) {
        ...
        fun getLocalizedName(language: Language): String {
            return when (this) {
                SAVYA -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_GROUP_SAVYA, language)
                APSAVYA -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_GROUP_APSAVYA, language)
            }
        }

        fun getLocalizedDescription(language: Language): String {
            return when (this) {
                SAVYA -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_DESC_SAVYA, language)
                APSAVYA -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_DESC_APSAVYA, language)
            }
        }
    }
    ...
    enum class HealthIndicator(val displayName: String, val description: String, val score: Int) {
        ...
        fun getLocalizedName(language: Language): String {
             return when (this) {
                EXCELLENT -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_HEALTH_EXCELLENT, language)
                GOOD -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_HEALTH_GOOD, language)
                MODERATE -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_HEALTH_MODERATE, language)
                CHALLENGING -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_HEALTH_CHALLENGING, language)
                CRITICAL -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_HEALTH_CRITICAL, language)
            }
        }

        fun getLocalizedDescription(language: Language): String {
            return when (this) {
                EXCELLENT -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_HEALTH_DESC_EXCELLENT, language)
                GOOD -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_HEALTH_DESC_GOOD, language)
                MODERATE -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_HEALTH_DESC_MODERATE, language)
                CHALLENGING -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_HEALTH_DESC_CHALLENGING, language)
                CRITICAL -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_HEALTH_DESC_CRITICAL, language)
            }
        }
    }
    ...
    enum class DehaJeevaRelationship(val displayName: String, val description: String) {
        ...
        fun getLocalizedName(language: Language): String {
            return when (this) {
                HARMONIOUS -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_REL_HARMONIOUS, language)
                SUPPORTIVE -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_REL_SUPPORTIVE, language)
                NEUTRAL -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_REL_NEUTRAL, language)
                CHALLENGING -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_REL_CHALLENGING, language)
                TRANSFORMATIVE -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_REL_TRANSFORMATIVE, language)
            }
        }

        fun getLocalizedDescription(language: Language): String {
            return when (this) {
                HARMONIOUS -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_REL_DESC_HARMONIOUS, language)
                SUPPORTIVE -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_REL_DESC_SUPPORTIVE, language)
                NEUTRAL -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_REL_DESC_NEUTRAL, language)
                CHALLENGING -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_REL_DESC_CHALLENGING, language)
                TRANSFORMATIVE -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_REL_DESC_TRANSFORMATIVE, language)
            }
        }
    }
    ...
    private fun assessPlanetStrength(
        ...
        if (position == null) return StringResources.get(StringKeyGeneralPart8.PLANET_STRENGTH_UNKNOWN, language)

        return when {
            position.sign == planet.exaltationSign -> StringResources.get(StringKeyGeneralPart8.PLANET_STRENGTH_EXALTED, language)
            position.sign.ruler == planet -> StringResources.get(StringKeyGeneralPart8.PLANET_STRENGTH_OWN_SIGN, language)
            position.sign == planet.debilitationSign -> StringResources.get(StringKeyGeneralPart8.PLANET_STRENGTH_DEBILITATED, language)
            position.isRetrograde -> StringResources.get(StringKeyGeneralPart8.PLANET_STRENGTH_RETROGRADE, language)
            else -> StringResources.get(StringKeyGeneralPart8.PLANET_STRENGTH_MODERATE, language)
        }
    }
    ...
    private fun generateHealthPrediction(
        ...
        return buildString {
            ...
            append(StringResources.get(StringKeyDashaPart2.KALACHAKRA_PRED_INTRO_DEHA, language, dehaLordStrength, relationship.getLocalizedName(language)))
            
            val effect = when (relationship) {
                DehaJeevaRelationship.HARMONIOUS -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_HEALTH_PRED_HARMONIOUS, language)
                DehaJeevaRelationship.SUPPORTIVE -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_HEALTH_PRED_SUPPORTIVE, language)
                DehaJeevaRelationship.NEUTRAL -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_HEALTH_PRED_NEUTRAL, language)
                DehaJeevaRelationship.CHALLENGING -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_HEALTH_PRED_CHALLENGING, language)
                DehaJeevaRelationship.TRANSFORMATIVE -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_HEALTH_PRED_TRANSFORMATIVE, language)
            }
            append(effect)
        }
    }
    ...
    private fun generateSpiritualPrediction(
        ...
        return buildString {
            ...
            append(StringResources.get(StringKeyDashaPart2.KALACHAKRA_PRED_INTRO_JEEVA, language, jeevaLordStrength))
            
            val effect = when (relationship) {
                DehaJeevaRelationship.HARMONIOUS -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_SPIRITUAL_PRED_HARMONIOUS, language)
                DehaJeevaRelationship.SUPPORTIVE -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_SPIRITUAL_PRED_SUPPORTIVE, language)
                DehaJeevaRelationship.NEUTRAL -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_SPIRITUAL_PRED_NEUTRAL, language)
                DehaJeevaRelationship.CHALLENGING -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_SPIRITUAL_PRED_CHALLENGING, language)
                DehaJeevaRelationship.TRANSFORMATIVE -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_SPIRITUAL_PRED_TRANSFORMATIVE, language)
            }
            append(effect)
        }
    }
    ...
    private fun generateDehaJeevaRecommendations(
        ...
        recommendations.add(StringResources.get(StringKeyDashaPart2.KALACHAKRA_REC_DEHA_LORD, language, dehaLordName))

        // Jeeva lord remedies
        val jeevaLordName = jeevaLord.displayName // Ideally localized
        recommendations.add(StringResources.get(StringKeyDashaPart2.KALACHAKRA_REC_JEEVA_LORD, language, jeevaLordName))

        // Relationship-specific recommendations
        when (relationship) {
            DehaJeevaRelationship.HARMONIOUS -> {
                recommendations.add(StringResources.get(StringKeyDashaPart2.KALACHAKRA_REC_HARMONIOUS_1, language))
                recommendations.add(StringResources.get(StringKeyDashaPart2.KALACHAKRA_REC_HARMONIOUS_2, language))
            }
            DehaJeevaRelationship.SUPPORTIVE -> {
                recommendations.add(StringResources.get(StringKeyDashaPart2.KALACHAKRA_REC_SUPPORTIVE_1, language))
                recommendations.add(StringResources.get(StringKeyDashaPart2.KALACHAKRA_REC_SUPPORTIVE_2, language))
            }
            DehaJeevaRelationship.NEUTRAL -> {
                recommendations.add(StringResources.get(StringKeyDashaPart2.KALACHAKRA_REC_NEUTRAL_1, language))
                recommendations.add(StringResources.get(StringKeyDashaPart2.KALACHAKRA_REC_NEUTRAL_2, language))
            }
            DehaJeevaRelationship.CHALLENGING -> {
                recommendations.add(StringResources.get(StringKeyDashaPart2.KALACHAKRA_REC_CHALLENGING_1, language))
                recommendations.add(StringResources.get(StringKeyDashaPart2.KALACHAKRA_REC_CHALLENGING_2, language))
            }
            DehaJeevaRelationship.TRANSFORMATIVE -> {
                recommendations.add(StringResources.get(StringKeyDashaPart2.KALACHAKRA_REC_TRANSFORMATIVE_1, language))
                recommendations.add(StringResources.get(StringKeyDashaPart2.KALACHAKRA_REC_TRANSFORMATIVE_2, language))
            }
        }
    ...
    private fun generateMahadashaInterpretation(
        ...
        val healthPrediction = "${StringResources.get(StringKeyDashaPart2.KALACHAKRA_HEALTH_INDICATOR, language)}: ${healthIndicator.getLocalizedName(language)} - ${healthIndicator.getLocalizedDescription(language)}"
    ...
    private fun generateAntardashaInterpretation(
        ...
        return buildString {
            append("${antardashaSign.getLocalizedName(language)} ${StringResources.get(StringKeyDashaPart2.SUDARSHANA_FOCUS_GENERAL, language)} ${StringResources.get(StringKeyGeneralPart4.FROM_LABEL, language)} ${mahadashaSign.getLocalizedName(language)}: ")

            if (isDeha) {
                append(StringResources.get(StringKeyDashaPart1.KALACHAKRA_DEHA_ANALYSIS, language))
                append(". ")
            }
            if (isJeeva) {
                append(StringResources.get(StringKeyDashaPart2.KALACHAKRA_JEEVA_ANALYSIS, language))
                append(". ")
            }
            if (!isDeha && !isJeeva) {
                append("${StringResources.get(StringKeyDashaPart2.SUDARSHANA_FOCUS_GENERAL, language)} ${antardashaSign.getLocalizedName(language)}. ")
            }
    ...
    private fun generateKalachakraInterpretation(
        ...
        val systemOverview = StringResources.get(StringKeyDashaPart2.KALACHAKRA_OVERVIEW_TEXT, language)

        val nakshatraGroupAnalysis = String.format(
            StringResources.get(StringKeyDashaPart2.KALACHAKRA_INTERP_GROUP_ANALYSIS, language),
        ...
        val dehaJeevaSummary = String.format(
            StringResources.get(StringKeyDashaPart2.KALACHAKRA_INTERP_DEHA_JEEVA_SUMMARY, language),
        ...
        val currentPhaseAnalysis = if (currentMahadasha != null) {
            String.format(
                StringResources.get(StringKeyDashaPart2.KALACHAKRA_INTERP_CURRENT_PHASE, language),
            ...
            StringResources.get(StringKeyDashaPart2.KALACHAKRA_INTERP_NO_CURRENT, language)
        }
        ...
        val generalGuidance = listOf(
            StringResources.get(StringKeyDashaPart1.KALACHAKRA_GUIDANCE_1, language),
            StringResources.get(StringKeyDashaPart1.KALACHAKRA_GUIDANCE_2, language),
            StringResources.get(StringKeyDashaPart1.KALACHAKRA_GUIDANCE_3, language),
            StringResources.get(StringKeyDashaPart2.KALACHAKRA_GUIDANCE_4, language),
            StringResources.get(StringKeyDashaPart2.KALACHAKRA_GUIDANCE_5, language)
        )
    ...
    private fun getSignGeneralEffects(sign: ZodiacSign, language: Language): String {
        return when (sign) {
            ZodiacSign.ARIES -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_EFFECT_ARIES, language)
            ZodiacSign.TAURUS -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_EFFECT_TAURUS, language)
            ZodiacSign.GEMINI -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_EFFECT_GEMINI, language)
            ZodiacSign.CANCER -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_EFFECT_CANCER, language)
            ZodiacSign.LEO -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_EFFECT_LEO, language)
            ZodiacSign.VIRGO -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_EFFECT_VIRGO, language)
            ZodiacSign.LIBRA -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_EFFECT_LIBRA, language)
            ZodiacSign.SCORPIO -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_EFFECT_SCORPIO, language)
            ZodiacSign.SAGITTARIUS -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_EFFECT_SAGITTARIUS, language)
            ZodiacSign.CAPRICORN -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_EFFECT_CAPRICORN, language)
            ZodiacSign.AQUARIUS -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_EFFECT_AQUARIUS, language)
            ZodiacSign.PISCES -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_EFFECT_PISCES, language)
        }
    }

    private fun getSignSpiritualEffects(sign: ZodiacSign, language: Language): String {
        return when (sign.element) {
            "Fire" -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_SPIRITUAL_FIRE, language)
            "Earth" -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_SPIRITUAL_EARTH, language)
            "Air" -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_SPIRITUAL_AIR, language)
            "Water" -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_SPIRITUAL_WATER, language)
            else -> StringResources.get(StringKeyDashaPart2.KALACHAKRA_SPIRITUAL_GENERAL, language)
        }
    }
    ...
    private fun getSignMaterialEffects(sign: ZodiacSign, chart: VedicChart, language: Language): String {
        ...
        return buildString {
            append(String.format(StringResources.get(StringKeyDashaPart2.KALACHAKRA_MATERIAL_SIGN_FOCUS, language), sign.getLocalizedName(language)))
            append(" ")
            append(String.format(StringResources.get(StringKeyDashaPart2.KALACHAKRA_MATERIAL_LORD_POS, language), getLocalizedPlanetName(signLord, language), lordHouse))
            when (lordHouse) {
                1 -> append(StringResources.get(StringKeyDashaPart2.KALACHAKRA_MATERIAL_H1, language))
                2 -> append(StringResources.get(StringKeyDashaPart2.KALACHAKRA_MATERIAL_H2, language))
                3 -> append(StringResources.get(StringKeyDashaPart2.KALACHAKRA_MATERIAL_H3, language))
                4 -> append(StringResources.get(StringKeyDashaPart2.KALACHAKRA_MATERIAL_H4, language))
                5 -> append(StringResources.get(StringKeyDashaPart2.KALACHAKRA_MATERIAL_H5, language))
                6 -> append(StringResources.get(StringKeyDashaPart2.KALACHAKRA_MATERIAL_H6, language))
                7 -> append(StringResources.get(StringKeyDashaPart2.KALACHAKRA_MATERIAL_H7, language))
                8 -> append(StringResources.get(StringKeyDashaPart2.KALACHAKRA_MATERIAL_H8, language))
                9 -> append(StringResources.get(StringKeyDashaPart2.KALACHAKRA_MATERIAL_H9, language))
                10 -> append(StringResources.get(StringKeyDashaPart2.KALACHAKRA_MATERIAL_H10, language))
                11 -> append(StringResources.get(StringKeyDashaPart2.KALACHAKRA_MATERIAL_H11, language))
                12 -> append(StringResources.get(StringKeyDashaPart2.KALACHAKRA_MATERIAL_H12, language))
                else -> append(StringResources.get(StringKeyDashaPart2.KALACHAKRA_MATERIAL_GENERAL_PROGRESS, language))
            }
        }
    }
    ...
    private fun getFavorableAreas(sign: ZodiacSign, signLord: Planet, language: Language): List<String> {
        ...
        areas.add("${getLocalizedPlanetName(signLord, language)}-${StringResources.get(com.astro.storm.core.common.StringKeyVarshaphala.VARSHAPHALA_KEY_DATES, language)}") // Fallback to "Key Dates" or similar if needed, but better to have specific key

        when (sign.element) {
            "Fire" -> areas.addAll(listOf(
                StringResources.get(StringKeyDashaPart1.KALACHAKRA_AREA_LEADERSHIP, language),
                StringResources.get(StringKeyDashaPart1.KALACHAKRA_AREA_SPORTS, language),
                StringResources.get(StringKeyDashaPart1.KALACHAKRA_AREA_ENGINEERING, language),
                StringResources.get(StringKeyDashaPart1.KALACHAKRA_AREA_MILITARY, language)
            ))
            "Earth" -> areas.addAll(listOf(
                StringResources.get(StringKeyDashaPart1.KALACHAKRA_AREA_FINANCE, language),
                StringResources.get(StringKeyDashaPart1.KALACHAKRA_AREA_REAL_ESTATE, language),
                StringResources.get(StringKeyDashaPart1.KALACHAKRA_AREA_AGRICULTURE, language),
                StringResources.get(StringKeyDashaPart1.KALACHAKRA_AREA_CONSTRUCTION, language)
            ))
            "Air" -> areas.addAll(listOf(
                StringResources.get(StringKeyDashaPart1.KALACHAKRA_AREA_COMMUNICATION, language),
                StringResources.get(StringKeyDashaPart1.KALACHAKRA_AREA_EDUCATION, language),
                StringResources.get(StringKeyDashaPart1.KALACHAKRA_AREA_TRAVEL, language),
                StringResources.get(StringKeyDashaPart1.KALACHAKRA_AREA_TECHNOLOGY, language)
            ))
            "Water" -> areas.addAll(listOf(
                StringResources.get(StringKeyDashaPart1.KALACHAKRA_AREA_HEALING, language),
                StringResources.get(StringKeyDashaPart1.KALACHAKRA_AREA_ARTS, language),
                StringResources.get(StringKeyDashaPart1.KALACHAKRA_AREA_PSYCHOLOGY, language),
                StringResources.get(StringKeyDashaPart1.KALACHAKRA_AREA_SPIRITUALITY, language)
            ))
        }
    ...
    private fun getCautionAreas(sign: ZodiacSign, healthIndicator: HealthIndicator, language: Language): List<String> {
        ...
        if (healthIndicator.score <= 2) {
            areas.add(StringResources.get(StringKeyDashaPart1.KALACHAKRA_CAUTION_HEALTH, language))
        }

        val key = when (sign) {
            ZodiacSign.ARIES -> StringKeyDashaPart1.KALACHAKRA_CAUTION_ARIES
            ZodiacSign.TAURUS -> StringKeyDashaPart1.KALACHAKRA_CAUTION_TAURUS
            ZodiacSign.GEMINI -> StringKeyDashaPart1.KALACHAKRA_CAUTION_GEMINI
            ZodiacSign.CANCER -> StringKeyDashaPart1.KALACHAKRA_CAUTION_CANCER
            ZodiacSign.LEO -> StringKeyDashaPart1.KALACHAKRA_CAUTION_LEO
            ZodiacSign.VIRGO -> StringKeyDashaPart1.KALACHAKRA_CAUTION_VIRGO
            ZodiacSign.LIBRA -> StringKeyDashaPart1.KALACHAKRA_CAUTION_LIBRA
            ZodiacSign.SCORPIO -> StringKeyDashaPart1.KALACHAKRA_CAUTION_SCORPIO
            ZodiacSign.SAGITTARIUS -> StringKeyDashaPart1.KALACHAKRA_CAUTION_SAGITTARIUS
            ZodiacSign.CAPRICORN -> StringKeyDashaPart1.KALACHAKRA_CAUTION_CAPRICORN
            ZodiacSign.AQUARIUS -> StringKeyDashaPart1.KALACHAKRA_CAUTION_AQUARIUS
            ZodiacSign.PISCES -> StringKeyDashaPart1.KALACHAKRA_CAUTION_PISCES
        }
    ...
    private fun getKalachakraRemedies(sign: ZodiacSign, signLord: Planet, language: Language): List<String> {
        ...
        // Sign lord mantra
        remedies.add(String.format(StringResources.get(StringKeyDashaPart2.KALACHAKRA_REMEDY_MANTRA, language), getLocalizedPlanetName(signLord, language)))

        // Elemental remedies
        val elemKey = when (sign.element) {
            "Fire" -> StringKeyDashaPart2.KALACHAKRA_REMEDY_FIRE
            "Earth" -> StringKeyDashaPart2.KALACHAKRA_REMEDY_EARTH
            "Air" -> StringKeyDashaPart2.KALACHAKRA_REMEDY_AIR
            "Water" -> StringKeyDashaPart2.KALACHAKRA_REMEDY_WATER
            else -> null
        }
        elemKey?.let { remedies.add(StringResources.get(it, language)) }

        // Health-specific
        remedies.add(StringResources.get(StringKeyDashaPart2.KALACHAKRA_REMEDY_DEITY, language))
    ...
    private fun getSignBriefEffect(sign: ZodiacSign, language: Language): String {
        return when (sign) {
            ZodiacSign.ARIES -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_BRIEF_ARIES, language)
            ZodiacSign.TAURUS -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_BRIEF_TAURUS, language)
            ZodiacSign.GEMINI -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_BRIEF_GEMINI, language)
            ZodiacSign.CANCER -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_BRIEF_CANCER, language)
            ZodiacSign.LEO -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_BRIEF_LEO, language)
            ZodiacSign.VIRGO -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_BRIEF_VIRGO, language)
            ZodiacSign.LIBRA -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_BRIEF_LIBRA, language)
            ZodiacSign.SCORPIO -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_BRIEF_SCORPIO, language)
            ZodiacSign.SAGITTARIUS -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_BRIEF_SAGITTARIUS, language)
            ZodiacSign.CAPRICORN -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_BRIEF_CAPRICORN, language)
            ZodiacSign.AQUARIUS -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_BRIEF_AQUARIUS, language)
            ZodiacSign.PISCES -> StringResources.get(StringKeyDashaPart1.KALACHAKRA_BRIEF_PISCES, language)
        }
    }
    ...
    private fun getLocalizedPlanetName(planet: Planet, language: Language): String {
        val key = when (planet) {
            Planet.SUN -> com.astro.storm.core.common.StringKeyGeneralPart8.PLANET_SUN
            Planet.MOON -> com.astro.storm.core.common.StringKeyGeneralPart8.PLANET_MOON
            Planet.MARS -> com.astro.storm.core.common.StringKeyGeneralPart8.PLANET_MARS
            Planet.MERCURY -> com.astro.storm.core.common.StringKeyGeneralPart8.PLANET_MERCURY
            Planet.JUPITER -> com.astro.storm.core.common.StringKeyGeneralPart8.PLANET_JUPITER
            Planet.VENUS -> com.astro.storm.core.common.StringKeyGeneralPart8.PLANET_VENUS
            Planet.SATURN -> com.astro.storm.core.common.StringKeyGeneralPart8.PLANET_SATURN
            Planet.RAHU -> com.astro.storm.core.common.StringKeyGeneralPart8.PLANET_RAHU
            Planet.KETU -> com.astro.storm.core.common.StringKeyGeneralPart8.PLANET_KETU
