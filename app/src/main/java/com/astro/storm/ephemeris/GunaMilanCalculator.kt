...
/**
 * Enhanced Guna Milan (Ashtakoota) Calculator - Production Grade
 *
 * Calculates the 8 Gunas for Vedic matchmaking using enhanced precision:
...
object GunaMilanCalculator {
    ...
    /**
     * Calculate all 8 Guna analyses using enhanced precision
     */
    fun calculateAllGunas(
        ...
        return listOf(
            calculateVarnaEnhanced(brideMoonSign, groomMoonSign, language),
            calculateVashyaEnhanced(brideMoonSign, groomMoonSign, language),
            calculateTaraEnhanced(brideNakshatra, groomNakshatra, language),
            calculateYoniEnhanced(brideNakshatra, groomNakshatra, language),
            calculateGrahaMaitriEnhanced(brideMoonSign, groomMoonSign, language),
            calculateGanaEnhanced(brideNakshatra, groomNakshatra, language),
            calculateBhakootEnhanced(brideMoonSign, groomMoonSign, language),
            calculateNadiEnhanced(brideNakshatra, groomNakshatra, brideMoonSign, groomMoonSign, bridePada, groomPada, language)
        )
    }
    
    /**
     * Enhanced Guna calculations using the new core
     */
    private fun calculateVarnaEnhanced(
        brideSign: ZodiacSign,
        groomSign: ZodiacSign,
        language: Language
    ): GunaAnalysis {
        return try {
            GunaCalculationCore.calculateVarna(brideSign, groomSign, language)
        } catch (e: Exception) {
            // Fallback calculation
            calculateVarnaLegacy(brideSign, groomSign, language)
        }
    }
    
    private fun calculateVashyaEnhanced(
        brideSign: ZodiacSign,
        groomSign: ZodiacSign,
        language: Language
    ): GunaAnalysis {
        return try {
            GunaCalculationCore.calculateVashya(brideSign, groomSign, language)
        } catch (e: Exception) {
            calculateVashyaLegacy(brideSign, groomSign, language)
        }
    }
    
    private fun calculateTaraEnhanced(
        brideNakshatra: Nakshatra,
        groomNakshatra: Nakshatra,
        language: Language
    ): GunaAnalysis {
        return try {
            GunaCalculationCore.calculateTara(brideNakshatra, groomNakshatra, language)
        } catch (e: Exception) {
            calculateTaraLegacy(brideNakshatra, groomNakshatra, language)
        }
    }
    
    private fun calculateYoniEnhanced(
        brideNakshatra: Nakshatra,
        groomNakshatra: Nakshatra,
        language: Language
    ): GunaAnalysis {
        return try {
            GunaCalculationCore.calculateYoni(brideNakshatra, groomNakshatra, language)
        } catch (e: Exception) {
            calculateYoniLegacy(brideNakshatra, groomNakshatra, language)
        }
    }
    
    private fun calculateGrahaMaitriEnhanced(
        brideSign: ZodiacSign,
        groomSign: ZodiacSign,
        language: Language
    ): GunaAnalysis {
        return try {
            GunaCalculationCore.calculateGrahaMaitri(brideSign, groomSign, language)
        } catch (e: Exception) {
            calculateGrahaMaitriLegacy(brideSign, groomSign, language)
        }
    }
    
    private fun calculateGanaEnhanced(
        brideNakshatra: Nakshatra,
        groomNakshatra: Nakshatra,
        language: Language
    ): GunaAnalysis {
        return try {
            GunaCalculationCore.calculateGana(brideNakshatra, groomNakshatra, language)
        } catch (e: Exception) {
            calculateGanaLegacy(brideNakshatra, groomNakshatra, language)
        }
    }
    ...
    private fun calculateBhakootEnhanced(
        ...
        return try {
            GunaCalculationCore.calculateBhakoot?.invoke(brideSign, groomSign, language) 
                ?: calculateBhakootLegacy(brideSign, groomSign, language)
        } catch (e: Exception) {
            calculateBhakootLegacy(brideSign, groomSign, language)
        }
    }
    ...
    private fun calculateNadiEnhanced(
        ...
        return try {
            GunaCalculationCore.calculateNadi?.invoke(brideNakshatra, groomNakshatra, brideMoonSign, groomMoonSign, bridePada, groomPada, language)
                ?: calculateNadiLegacy(brideNakshatra, groomNakshatra, brideMoonSign, groomMoonSign, bridePada, groomPada, language)
        } catch (e: Exception) {
            calculateNadiLegacy(brideNakshatra, groomNakshatra, brideMoonSign, groomMoonSign, bridePada, groomPada, language)
        }
    }
    ...
    // ============================================
    // LEGACY CALCULATION METHODS (Fallback)
    // ============================================

    private fun calculateVarnaLegacy(
        brideSign: ZodiacSign,
        groomSign: ZodiacSign,
        language: Language
    ): GunaAnalysis {
    ...
    private fun calculateVashyaLegacy(
        brideSign: ZodiacSign,
        groomSign: ZodiacSign,
        language: Language
    ): GunaAnalysis {
        ...
        val points = calculateVashyaPointsLegacy(brideVashya, groomVashya, brideSign, groomSign)
    ...
    private fun calculateTaraLegacy(
        brideNakshatra: Nakshatra,
        groomNakshatra: Nakshatra,
        language: Language
    ): GunaAnalysis {
        val brideToGroom = calculateTaraNumberLegacy(brideNakshatra, groomNakshatra)
        val groomToBride = calculateTaraNumberLegacy(groomNakshatra, brideNakshatra)

        val brideTara = getTaraNameLegacy(brideToGroom, language)
        val groomTara = getTaraNameLegacy(groomToBride, language)

        val brideAuspicious = isAuspiciousTaraLegacy(brideToGroom)
        val groomAuspicious = isAuspiciousTaraLegacy(groomToBride)
    ...
    private fun calculateYoniLegacy(
        brideNakshatra: Nakshatra,
        groomNakshatra: Nakshatra,
        language: Language
    ): GunaAnalysis {
        ...
        val points = calculateYoniPointsLegacy(brideYoni, groomYoni)
    ...
    private fun calculateGrahaMaitriLegacy(
        brideSign: ZodiacSign,
        groomSign: ZodiacSign,
        language: Language
    ): GunaAnalysis {
        ...
        val points = calculateGrahaMaitriPointsLegacy(brideLord, groomLord)
    ...
    private fun calculateGanaLegacy(
        brideNakshatra: Nakshatra,
        groomNakshatra: Nakshatra,
        language: Language
    ): GunaAnalysis {
        ...
        val points = calculateGanaPointsLegacy(brideGana, groomGana)
    ...
    private fun calculateBhakootLegacy(
        brideSign: ZodiacSign,
        groomSign: ZodiacSign,
        language: Language
    ): GunaAnalysis {
        ...
        val (points, doshaType, doshaDescription) = calculateBhakootPointsLegacy(
    ...
    private fun calculateNadiLegacy(
        brideNakshatra: Nakshatra,
        groomNakshatra: Nakshatra,
        brideMoonSign: ZodiacSign,
        groomMoonSign: ZodiacSign,
    ...
    private fun calculateVashyaPointsLegacy(
        brideVashya: Vashya,
        groomVashya: Vashya,
        brideSign: ZodiacSign,
        groomSign: ZodiacSign
    ...
    private fun calculateTaraNumberLegacy(fromNakshatra: Nakshatra, toNakshatra: Nakshatra): Int {
        val diff = (toNakshatra.number - fromNakshatra.number + 27) % 27
        return if (diff == 0) 9 else ((diff - 1) % 9) + 1
    }

    private fun getTaraNameLegacy(taraNumber: Int, language: Language): String = when (taraNumber) {
    ...
    private fun isAuspiciousTaraLegacy(taraNumber: Int): Boolean = taraNumber in listOf(2, 4, 6, 8, 9)

    private fun calculateYoniPointsLegacy(brideYoni: Yoni, groomYoni: Yoni): Double {
    ...
    private fun calculateGrahaMaitriPointsLegacy(lord1: Planet, lord2: Planet): Double {
    ...
    private fun calculateGanaPointsLegacy(brideGana: Gana, groomGana: Gana): Double = when {
    ...
    private fun calculateBhakootPointsLegacy(
        brideNumber: Int,
        groomNumber: Int,
        brideSign: ZodiacSign,
        groomSign: ZodiacSign,
        ...
        if (is2_12 || is6_8) {
            val cancellation = checkBhakootDoshaCancellationLegacy(brideSign, groomSign, brideLord, groomLord, is6_8, language)
    ...
    private fun checkBhakootDoshaCancellationLegacy(
        brideSign: ZodiacSign,
        groomSign: ZodiacSign,
        brideLord: Planet,
        groomLord: Planet,
