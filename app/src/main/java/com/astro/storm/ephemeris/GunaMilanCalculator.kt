...
object GunaMilanCalculator {
    ...
    fun calculateVarna(
        ...
        val analysis = buildString {
            if (points > 0) {
                append(StringResources.get(StringKeyMatchmakingPart1.VARNA_COMPATIBLE, language)
                    .replace("{groom}", groomVarna.getLocalizedName(language))
                    .replace("{bride}", brideVarna.getLocalizedName(language)))
                append(" ")
                append(StringResources.get(StringKeyMatchmakingPart1.VARNA_DETAILED_COMPATIBLE, language))
            } else {
                append(StringResources.get(StringKeyMatchmakingPart1.VARNA_INCOMPATIBLE, language)
                    .replace("{bride}", brideVarna.getLocalizedName(language))
                    .replace("{groom}", groomVarna.getLocalizedName(language)))
                append(" ")
                append(StringResources.get(StringKeyMatchmakingPart1.VARNA_DETAILED_INCOMPATIBLE, language))
            }
        }
        ...
        return GunaAnalysis(
            ...
            description = StringResources.get(StringKeyMatchmakingPart1.VARNA_DESC, language),
    ...
    fun calculateVashya(
        ...
        val analysisKey = when {
            points >= 2.0 -> StringKeyMatchmakingPart1.VASHYA_EXCELLENT
            points >= 1.5 -> StringKeyMatchmakingPart1.VASHYA_VERY_GOOD
            points >= 1.0 -> StringKeyMatchmakingPart1.VASHYA_GOOD
            points >= 0.5 -> StringKeyMatchmakingPart1.VASHYA_PARTIAL
            else -> StringKeyMatchmakingPart1.VASHYA_INCOMPATIBLE
        }
        ...
        return GunaAnalysis(
            ...
            obtainedPoints = points,
            description = StringResources.get(StringKeyMatchmakingPart1.VASHYA_DESC, language),
    ...
    fun calculateTara(
        ...
        val analysisKey = when {
            points >= 3.0 -> StringKeyGeneralPart11.TARA_EXCELLENT
            points >= 1.5 -> StringKeyGeneralPart11.TARA_MODERATE
            else -> StringKeyGeneralPart11.TARA_INAUSPICIOUS
        }
        ...
        return GunaAnalysis(
            ...
            obtainedPoints = points,
            description = StringResources.get(StringKeyGeneralPart11.TARA_DESC, language),
    ...
    private fun getTaraName(taraNumber: Int, language: Language): String = when (taraNumber) {
        1 -> StringResources.get(StringKeyGeneralPart11.TARA_JANMA, language)
        2 -> StringResources.get(StringKeyGeneralPart11.TARA_SAMPAT, language)
        3 -> StringResources.get(StringKeyGeneralPart11.TARA_VIPAT, language)
        4 -> StringResources.get(StringKeyGeneralPart11.TARA_KSHEMA, language)
        5 -> StringResources.get(StringKeyGeneralPart11.TARA_PRATYARI, language)
        6 -> StringResources.get(StringKeyGeneralPart11.TARA_SADHANA, language)
        7 -> StringResources.get(StringKeyGeneralPart11.TARA_VADHA, language)
        8 -> StringResources.get(StringKeyGeneralPart11.TARA_MITRA, language)
        9 -> StringResources.get(StringKeyGeneralPart11.TARA_PARAMA_MITRA, language)
        else -> StringResources.get(StringKeyGeneralPart11.TARA_JANMA, language)
    }
    ...
    fun calculateYoni(
        ...
        val analysisKey = when {
            points >= 4.0 -> StringKeyMatchmakingPart2.YONI_SAME
            points >= 3.0 -> StringKeyMatchmakingPart2.YONI_FRIENDLY
            points >= 2.0 -> StringKeyMatchmakingPart2.YONI_NEUTRAL
            points >= 1.0 -> StringKeyMatchmakingPart2.YONI_UNFRIENDLY
            else -> StringKeyMatchmakingPart1.YONI_ENEMY
        }
        ...
        return GunaAnalysis(
            ...
            obtainedPoints = points,
            description = StringResources.get(StringKeyMatchmakingPart1.YONI_DESC, language),
    ...
    fun calculateGrahaMaitri(
        ...
        val analysisKey = when {
            points >= 5.0 -> StringKeyGeneralPart4.GRAHA_MAITRI_EXCELLENT
            points >= 4.0 -> StringKeyGeneralPart4.GRAHA_MAITRI_VERY_GOOD
            points >= 3.0 -> StringKeyGeneralPart4.GRAHA_MAITRI_AVERAGE
            points >= 1.0 -> StringKeyGeneralPart4.GRAHA_MAITRI_FRICTION
            else -> StringKeyGeneralPart4.GRAHA_MAITRI_INCOMPATIBLE
        }
        ...
        return GunaAnalysis(
            ...
            obtainedPoints = points,
            description = StringResources.get(StringKeyGeneralPart4.GRAHA_MAITRI_DESC, language),
    ...
    fun calculateGana(
        ...
        val analysisKey = when {
            points >= 6.0 -> StringKeyMatchmakingPart1.GANA_SAME
            points >= 5.0 -> StringKeyMatchmakingPart1.GANA_COMPATIBLE
            points >= 3.0 -> StringKeyMatchmakingPart1.GANA_PARTIAL
            points >= 1.0 -> StringKeyMatchmakingPart1.GANA_DIFFERENT
            else -> StringKeyMatchmakingPart1.GANA_OPPOSITE
        }
        ...
        return GunaAnalysis(
            ...
            obtainedPoints = points,
            description = StringResources.get(StringKeyMatchmakingPart1.GANA_DESC, language),
    ...
    fun calculateBhakoot(
        ...
        val analysis = when (doshaType) {
            "None" -> StringResources.get(StringKeyGeneralPart2.BHAKOOT_NO_DOSHA, language)
            "Cancelled" -> "${StringResources.get(StringKeyGeneralPart2.BHAKOOT_CANCELLED, language)} - $doshaDescription"
            "2-12" -> "${StringResources.get(StringKeyGeneralPart2.BHAKOOT_2_12, language)} $doshaDescription"
            "6-8" -> "${StringResources.get(StringKeyGeneralPart2.BHAKOOT_6_8, language)} $doshaDescription"
            "5-9" -> "${StringResources.get(StringKeyGeneralPart2.BHAKOOT_5_9, language)} $doshaDescription"
        ...
        return GunaAnalysis(
            ...
            obtainedPoints = points,
            description = StringResources.get(StringKeyGeneralPart2.BHAKOOT_DESC, language),
    ...
    private fun calculateBhakootPoints(
        ...
        if (is2_12 || is6_8 || is5_9) {
            ...
            return when {
                is2_12 -> Triple(0.0, "2-12", StringResources.get(StringKeyGeneralPart2.BHAKOOT_2_12_DESC, language))
                is6_8 -> Triple(0.0, "6-8", StringResources.get(StringKeyGeneralPart2.BHAKOOT_6_8_DESC, language))
                is5_9 -> Triple(0.0, "5-9", StringResources.get(StringKeyGeneralPart2.BHAKOOT_5_9_DESC, language))
                else -> Triple(0.0, "Unknown", "")
            }
        }

        // All other positions (1-1, 3-11, 4-10) are auspicious or neutral-good
        return Triple(7.0, "None", StringResources.get(StringKeyGeneralPart2.BHAKOOT_FAVORABLE, language))
    }
    ...
    private fun checkBhakootDoshaCancellation(
        ...
        if (brideLord == groomLord) {
            return StringResources.get(StringKeyGeneralPart2.BHAKOOT_CANCEL_SAME_LORD, language)
        ...
        if (rel1 == PlanetaryRelationship.FRIEND && rel2 == PlanetaryRelationship.FRIEND) {
            return StringResources.get(StringKeyGeneralPart2.BHAKOOT_CANCEL_MUTUAL_FRIENDS, language)
        ...
        if (brideElement == groomElement) {
            return StringResources.get(StringKeyGeneralPart2.BHAKOOT_CANCEL_ELEMENT, language).replace("{element}", brideElement)
        }
        ...
        if ((rel1 == PlanetaryRelationship.FRIEND && rel2 == PlanetaryRelationship.NEUTRAL) ||
            (rel1 == PlanetaryRelationship.NEUTRAL && rel2 == PlanetaryRelationship.FRIEND)) {
             return StringResources.get(StringKeyGeneralPart2.BHAKOOT_CANCEL_FRIENDLY, language)
        }
    ...
    fun calculateNadi(
        ...
        val analysis = when {
            hasDosha -> StringResources.get(StringKeyMatchmakingPart1.NADI_DOSHA_PRESENT, language)
                .replace("{nadi}", brideNadi.getLocalizedName(language))
            cancellationReason != null -> "${StringResources.get(StringKeyMatchmakingPart1.NADI_DOSHA_CANCELLED, language)} $cancellationReason"
            else -> StringResources.get(StringKeyMatchmakingPart1.NADI_DIFFERENT, language)
        ...
        return GunaAnalysis(
            ...
            obtainedPoints = points,
            description = StringResources.get(StringKeyMatchmakingPart1.NADI_DESC, language),
    ...
    private fun checkNadiDoshaCancellation(
        ...
        if (brideNakshatra == groomNakshatra && brideMoonSign != groomMoonSign) {
            return StringResources.get(StringKeyMatchmakingPart1.NADI_CANCEL_SAME_NAK_DIFF_RASHI, language)
        ...
        if (brideMoonSign == groomMoonSign && brideNakshatra != groomNakshatra) {
            return StringResources.get(StringKeyMatchmakingPart1.NADI_CANCEL_SAME_RASHI_DIFF_NAK, language)
        ...
        if (brideNakshatra == groomNakshatra && brideMoonSign == groomMoonSign && bridePada != groomPada) {
            return StringResources.get(StringKeyMatchmakingPart1.NADI_CANCEL_DIFF_PADA, language)
        ...
        for (pair in Nadi.cancellingPairs) {
            if (pair.contains(brideNakshatra) && pair.contains(groomNakshatra)) {
                return StringResources.get(StringKeyMatchmakingPart1.NADI_CANCEL_SPECIAL_PAIR, language)
        ...
        if (brideLord != groomLord) {
            ...
            if (rel1 == PlanetaryRelationship.FRIEND && rel2 == PlanetaryRelationship.FRIEND) {
                return StringResources.get(StringKeyMatchmakingPart1.NADI_CANCEL_LORDS_FRIENDS, language)
                    .replace("{lord1}", brideLord.getLocalizedName(language))
                    .replace("{lord2}", groomLord.getLocalizedName(language))
            }
        }
        ...
        if (brideNakshatra.ruler == groomNakshatra.ruler) {
            return StringResources.get(StringKeyMatchmakingPart1.NADI_CANCEL_SAME_NAK_LORD, language)
    ...
    private fun getSignElement(sign: ZodiacSign, language: Language): String = when (sign) {
        ZodiacSign.ARIES, ZodiacSign.LEO, ZodiacSign.SAGITTARIUS -> StringResources.get(StringKeyGeneralPart4.ELEMENT_FIRE, language)
        ZodiacSign.TAURUS, ZodiacSign.VIRGO, ZodiacSign.CAPRICORN -> StringResources.get(StringKeyGeneralPart4.ELEMENT_EARTH, language)
        ZodiacSign.GEMINI, ZodiacSign.LIBRA, ZodiacSign.AQUARIUS -> StringResources.get(StringKeyGeneralPart4.ELEMENT_AIR, language)
        ZodiacSign.CANCER, ZodiacSign.SCORPIO, ZodiacSign.PISCES -> StringResources.get(StringKeyGeneralPart4.ELEMENT_WATER, language)
    }
