...
object DrekkanaAnalyzer {
    ...
    private fun analyzeSiblings(d3: com.astro.storm.ephemeris.DivisionalChartData, lang: Language): SiblingIndicators {
    ...
    private fun assessSiblingWelfare(d3: com.astro.storm.ephemeris.DivisionalChartData, lang: Language): List<String> {
    ...
    private fun analyzeCourage(mars: PlanetPosition?, thirdLord: PlanetPosition?, d3: com.astro.storm.ephemeris.DivisionalChartData, lang: Language): CourageAnalysis {
    ...
    private fun analyzeShortJourneys(d3: com.astro.storm.ephemeris.DivisionalChartData, lang: Language): List<String> {
        val res = mutableListOf<String>(); val t = d3.planetPositions.filter { it.house == 3 }.map { it.planet }
