...
/**
 * Yoga Localization Utilities
 *
 * This object provides localization functions for yoga names, effects,
 * Sanskrit names, and house significations.
 *
...
object YogaLocalization {
    ...
    /**
     * Get localized yoga Sanskrit name (Devanagari script for Nepali)
     */
