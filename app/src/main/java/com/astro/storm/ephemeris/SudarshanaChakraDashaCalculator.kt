...
object SudarshanaChakraDashaCalculator {
        ...
        return when (house) {
            1 -> HouseSignificance(
                ...
                primaryThemes = listOf(
                    StringResources.get(StringKeyDashaPart2.SUDARSHANA_THEME_H1_1, language),
                    StringResources.get(StringKeyDashaPart2.SUDARSHANA_THEME_H1_2, language),
                    "Personality", "New beginnings"
                ),
                secondaryThemes = listOf("Health", "Appearance", "Character"),
                karakas = listOf(Planet.SUN),
                description = StringResources.get(StringKeyDashaPart2.SUDARSHANA_HOUSE_1_DESC, language)
            )
            2 -> HouseSignificance(
                house = 2,
                primaryThemes = listOf(
                    StringResources.get(StringKeyDashaPart2.SUDARSHANA_THEME_H2_1, language),
                    StringResources.get(StringKeyDashaPart2.SUDARSHANA_THEME_H2_2, language),
                    "Speech", "Values"
                ),
                secondaryThemes = listOf("Food", "Face", "Early education"),
                karakas = listOf(Planet.JUPITER, Planet.VENUS),
                description = StringResources.get(StringKeyDashaPart2.SUDARSHANA_HOUSE_2_DESC, language)
            )
            3 -> HouseSignificance(
                house = 3,
                primaryThemes = listOf(
                    StringResources.get(StringKeyDashaPart2.SUDARSHANA_THEME_H3_1, language),
                    StringResources.get(StringKeyDashaPart2.SUDARSHANA_THEME_H3_2, language),
                    "Communication", "Short journeys"
                ),
                secondaryThemes = listOf("Skills", "Neighbors", "Hands"),
                karakas = listOf(Planet.MARS, Planet.MERCURY),
                description = StringResources.get(StringKeyDashaPart2.SUDARSHANA_HOUSE_3_DESC, language)
            )
            4 -> HouseSignificance(
                house = 4,
                primaryThemes = listOf(
                    StringResources.get(StringKeyDashaPart2.SUDARSHANA_THEME_H4_1, language),
                    StringResources.get(StringKeyDashaPart2.SUDARSHANA_THEME_H4_2, language),
                    "Property", "Emotions"
                ),
                secondaryThemes = listOf("Vehicles", "Education", "Peace of mind"),
                karakas = listOf(Planet.MOON),
                description = StringResources.get(StringKeyDashaPart2.SUDARSHANA_HOUSE_4_DESC, language)
            )
            5 -> HouseSignificance(
                house = 5,
                primaryThemes = listOf(
                    StringResources.get(StringKeyDashaPart2.SUDARSHANA_THEME_H5_1, language),
                    StringResources.get(StringKeyDashaPart2.SUDARSHANA_THEME_H5_2, language),
                    "Creativity", "Intelligence"
                ),
                secondaryThemes = listOf("Speculation", "Past-life merit", "Mantras"),
                karakas = listOf(Planet.JUPITER),
                description = StringResources.get(StringKeyDashaPart2.SUDARSHANA_HOUSE_5_DESC, language)
            )
            6 -> HouseSignificance(
                house = 6,
                primaryThemes = listOf(
                    StringResources.get(StringKeyDashaPart2.SUDARSHANA_THEME_H6_1, language),
                    StringResources.get(StringKeyDashaPart2.SUDARSHANA_THEME_H6_2, language),
                    "Service", "Daily work"
                ),
                secondaryThemes = listOf("Debts", "Litigation", "Pets"),
                karakas = listOf(Planet.MARS, Planet.SATURN),
                description = StringResources.get(StringKeyDashaPart2.SUDARSHANA_HOUSE_6_DESC, language)
            )
            7 -> HouseSignificance(
                house = 7,
                primaryThemes = listOf(
                    StringResources.get(StringKeyDashaPart2.SUDARSHANA_THEME_H7_1, language),
                    StringResources.get(StringKeyDashaPart2.SUDARSHANA_THEME_H7_2, language),
                    "Business", "Foreign travel"
                ),
                secondaryThemes = listOf("Public life", "Contracts", "Others"),
                karakas = listOf(Planet.VENUS),
                description = StringResources.get(StringKeyDashaPart2.SUDARSHANA_HOUSE_7_DESC, language)
            )
            8 -> HouseSignificance(
                house = 8,
                primaryThemes = listOf(
                    StringResources.get(StringKeyDashaPart2.SUDARSHANA_THEME_H8_1, language),
                    StringResources.get(StringKeyDashaPart2.SUDARSHANA_THEME_H8_2, language),
                    "Occult", "Inheritance"
                ),
                secondaryThemes = listOf("Research", "Insurance", "In-laws"),
                karakas = listOf(Planet.SATURN),
                description = StringResources.get(StringKeyDashaPart2.SUDARSHANA_HOUSE_8_DESC, language)
            )
            9 -> HouseSignificance(
                house = 9,
                primaryThemes = listOf(
                    StringResources.get(StringKeyDashaPart2.SUDARSHANA_THEME_H9_1, language),
                    StringResources.get(StringKeyDashaPart2.SUDARSHANA_THEME_H9_2, language),
                    "Dharma", "Higher education"
                ),
                secondaryThemes = listOf("Long journeys", "Religion", "Guru"),
                karakas = listOf(Planet.JUPITER, Planet.SUN),
                description = StringResources.get(StringKeyDashaPart2.SUDARSHANA_HOUSE_9_DESC, language)
            )
            10 -> HouseSignificance(
                house = 10,
                primaryThemes = listOf(
                    StringResources.get(StringKeyDashaPart2.SUDARSHANA_THEME_H10_1, language),
                    StringResources.get(StringKeyDashaPart2.SUDARSHANA_THEME_H10_2, language),
                    "Karma", "Authority"
                ),
                secondaryThemes = listOf("Government", "Fame", "Father's profession"),
                karakas = listOf(Planet.SUN, Planet.SATURN, Planet.MERCURY),
                description = StringResources.get(StringKeyDashaPart2.SUDARSHANA_HOUSE_10_DESC, language)
            )
            11 -> HouseSignificance(
                house = 11,
                primaryThemes = listOf(
                    StringResources.get(StringKeyDashaPart2.SUDARSHANA_THEME_H11_1, language),
                    StringResources.get(StringKeyDashaPart2.SUDARSHANA_THEME_H11_2, language),
                    "Friends", "Aspirations"
                ),
                secondaryThemes = listOf("Elder siblings", "Social networks", "Fulfillment"),
                karakas = listOf(Planet.JUPITER),
                description = StringResources.get(StringKeyDashaPart2.SUDARSHANA_HOUSE_11_DESC, language)
            )
            12 -> HouseSignificance(
                house = 12,
                primaryThemes = listOf(
                    StringResources.get(StringKeyDashaPart2.SUDARSHANA_THEME_H12_1, language),
                    StringResources.get(StringKeyDashaPart2.SUDARSHANA_THEME_H12_2, language),
                ...
                description = StringResources.get(StringKeyDashaPart2.SUDARSHANA_HOUSE_12_DESC, language)
            )
    ...
    private fun getSignEffects(sign: ZodiacSign, lord: Planet, chart: VedicChart, language: Language): List<String> {
        ...
        effects.add(
            StringResources.get(
                StringKeyDashaPart2.SUDARSHANA_EFFECT_ACTIVATED, language,
        ...
        when (sign.quality) {
            Quality.CARDINAL ->
                effects.add(StringResources.get(StringKeyDashaPart2.SUDARSHANA_EFFECT_MOVABLE, language))
            Quality.FIXED ->
                effects.add(StringResources.get(StringKeyDashaPart2.SUDARSHANA_EFFECT_FIXED, language))
            Quality.MUTABLE ->
                effects.add(StringResources.get(StringKeyDashaPart2.SUDARSHANA_EFFECT_DUAL, language))
        }
        ...
        lordPosition?.let { pos ->
            ...
            effects.add(
                StringResources.get(
                    StringKeyDashaPart2.SUDARSHANA_EFFECT_LORD_POS, language,
            ...
            if (AstrologicalConstants.isExalted(lord, pos.sign)) {
                effects.add(StringResources.get(StringKeyDashaPart2.SUDARSHANA_EFFECT_EXALTED, language))
            } else if (AstrologicalConstants.isDebilitated(lord, pos.sign)) {
                effects.add(StringResources.get(StringKeyDashaPart2.SUDARSHANA_EFFECT_DEBILITATED, language))
            } else {
                effects.add(StringResources.get(StringKeyDashaPart2.SUDARSHANA_EFFECT_NORMAL, language))
            }
        }
    ...
    private fun analyzePlanetaryInfluences(
        ...
        planetsInSign.forEach { pos ->
            effects.add(
                StringResources.get(
                    StringKeyDashaPart2.SUDARSHANA_INFLUENCE_PRESENT, language,
        ...
        aspectingPlanets.forEach { asp ->
            effects.add(
                StringResources.get(
                    StringKeyDashaPart2.SUDARSHANA_INFLUENCE_ASPECT, language,
    ...
    private fun calculateChakraStrength(
        ...
        return ChakraStrength(
            ...
            factors = buildList {
                add(
                    StringResources.get(
                        StringKeyDashaPart2.SUDARSHANA_FACTOR_DIGNITY, language,
                ...
                if (planetsInSign.isNotEmpty()) {
                    add(
                        String.format(
                            StringResources.get(StringKeyDashaPart2.SUDARSHANA_FACTOR_PLANETS, language),
                            planetsInSign.size
                        )
                    )
                }
                if (aspectingPlanets.isNotEmpty()) {
                    add(
                        String.format(
                            StringResources.get(StringKeyDashaPart2.SUDARSHANA_FACTOR_ASPECTS, language),
    ...
    private fun getDignitySummary(planet: Planet, sign: ZodiacSign, language: Language): String {
        return when {
            AstrologicalConstants.isExalted(planet, sign) -> StringResources.get(StringKeyDashaPart2.SUDARSHANA_DIG_EXALTED, language)
            AstrologicalConstants.isInOwnSign(planet, sign) -> StringResources.get(StringKeyDashaPart2.SUDARSHANA_DIG_OWN, language)
            AstrologicalConstants.isDebilitated(planet, sign) -> StringResources.get(StringKeyDashaPart2.SUDARSHANA_DIG_DEBILITATED, language)
            else -> StringResources.get(StringKeyDashaPart2.SUDARSHANA_DIG_NORMAL, language)
        }
    }
    ...
    private fun synthesizeResults(
        ...
        val overallAssessment = when {
            combinedStrength >= 65 && conflictingThemes.isEmpty() ->
                StringResources.get(StringKeyDashaPart2.SUDARSHANA_ASSESSMENT_HIGHLY_FAVORABLE, language)
            combinedStrength >= 55 ->
                StringResources.get(StringKeyDashaPart2.SUDARSHANA_ASSESSMENT_POSITIVE, language)
            combinedStrength >= 45 ->
                StringResources.get(StringKeyDashaPart2.SUDARSHANA_ASSESSMENT_MIXED, language)
            else ->
                StringResources.get(StringKeyDashaPart2.SUDARSHANA_ASSESSMENT_CHALLENGING, language)
        }
        ...
        return SudarshanasSynthesis(
            ...
            lagnaContribution = StringResources.get(StringKeyDashaPart2.SUDARSHANA_CONTRIB_LAGNA, language, lagnaChakra.strength.level.name),
            chandraContribution = StringResources.get(StringKeyDashaPart2.SUDARSHANA_CONTRIB_CHANDRA, language, moonChakra.strength.level.name),
            suryaContribution = StringResources.get(StringKeyDashaPart2.SUDARSHANA_CONTRIB_SURYA, language, sunChakra.strength.level.name)
        )
    }
    ...
    private fun findCommonThemes(
        ...
        if (lagna.activeHouse == moon.activeHouse || lagna.activeHouse == sun.activeHouse ||
            ...
            allThemes.add(
                StringResources.get(
                    StringKeyDashaPart2.SUDARSHANA_THEME_MULTIPLE, language,
        ...
        commonKarakas.forEach { (planet, _) ->
            allThemes.add(
                StringResources.get(
                    StringKeyDashaPart2.SUDARSHANA_THEME_ACTIVATED, language,
    ...
    private fun findConflictingThemes(
        ...
        if (strengthDiff > 30) {
            conflicts.add(StringResources.get(StringKeyDashaPart2.SUDARSHANA_THEME_VARIATION, language))
        }
    ...
    private fun determinePrimaryFocus(
        ...
        return strongest?.let {
            StringResources.get(
                StringKeyDashaPart2.SUDARSHANA_FOCUS_FROM, language,
                it.houseSignificance.primaryThemes.firstOrNull() ?: StringResources.get(StringKeyDashaPart2.SUDARSHANA_FOCUS_GENERAL, language),
                it.reference.name
            )
    ...
    private fun summarizeYear(data: InternalChakraData, language: Language): String {
        return StringResources.get(
            StringKeyDashaPart2.SUDARSHANA_YEAR_SUMMARY, language,
            data.age,
    ...
    private fun determineTrend(
        ...
        return when {
            currentHouse in listOf(1, 5, 9, 10, 11) -> StringResources.get(StringKeyDashaPart2.SUDARSHANA_TREND_FAVORABLE, language)
            currentHouse in listOf(6, 8, 12) -> StringResources.get(StringKeyDashaPart2.SUDARSHANA_TREND_CHALLENGING, language)
            else -> StringResources.get(StringKeyDashaPart2.SUDARSHANA_TREND_NEUTRAL, language)
        }
    }
    ...
    private fun generateRecommendations(synthesis: SudarshanasSynthesis, language: Language): List<String> {
        ...
        when {
            synthesis.combinedStrengthScore >= 65 -> {
                recommendations.add(StringResources.get(StringKeyDashaPart2.SUDARSHANA_REC_FAVORABLE, language, synthesis.primaryFocus))
                recommendations.add(StringResources.get(StringKeyDashaPart2.SUDARSHANA_REC_EXPAND, language, synthesis.secondaryFocus))
            }
            synthesis.combinedStrengthScore >= 45 -> {
                recommendations.add(StringResources.get(StringKeyDashaPart2.SUDARSHANA_REC_BALANCED, language, synthesis.primaryFocus))
                recommendations.add(StringResources.get(StringKeyDashaPart2.SUDARSHANA_REC_PATIENCE, language, synthesis.conflictingThemes.firstOrNull() ?: "challenges"))
            }
            else -> {
                recommendations.add(StringResources.get(StringKeyDashaPart2.SUDARSHANA_REC_CHALLENGING, language))
                recommendations.add(StringResources.get(StringKeyDashaPart2.SUDARSHANA_REC_SPIRITUAL, language))
            }
        }

        recommendations.add(StringResources.get(StringKeyDashaPart2.SUDARSHANA_REC_REVIEW, language))
