...
class TransitAnalyzer @Inject constructor(
    ...
    companion object {
        ...
        private val GOCHARA_FAVORABLE_KEYS = mapOf(
            Planet.SUN to mapOf(3 to StringKeyTransitPart1.GOCHARA_SUN_3, 6 to StringKeyTransitPart1.GOCHARA_SUN_6, 10 to StringKeyTransitPart1.GOCHARA_SUN_10, 11 to StringKeyTransitPart1.GOCHARA_SUN_11),
            Planet.MOON to mapOf(1 to StringKeyTransitPart1.GOCHARA_MOON_1, 3 to StringKeyTransitPart1.GOCHARA_MOON_3, 6 to StringKeyTransitPart1.GOCHARA_MOON_6, 7 to StringKeyTransitPart1.GOCHARA_MOON_7, 10 to StringKeyTransitPart1.GOCHARA_MOON_10, 11 to StringKeyTransitPart1.GOCHARA_MOON_11),
            Planet.MARS to mapOf(3 to StringKeyTransitPart1.GOCHARA_MARS_3, 6 to StringKeyTransitPart1.GOCHARA_MARS_6, 11 to StringKeyTransitPart1.GOCHARA_MARS_11),
            Planet.MERCURY to mapOf(2 to StringKeyTransitPart1.GOCHARA_MERCURY_2, 4 to StringKeyTransitPart1.GOCHARA_MERCURY_4, 6 to StringKeyTransitPart1.GOCHARA_MERCURY_6, 8 to StringKeyTransitPart1.GOCHARA_MERCURY_8, 10 to StringKeyTransitPart1.GOCHARA_MERCURY_10, 11 to StringKeyTransitPart1.GOCHARA_MERCURY_11),
            Planet.JUPITER to mapOf(2 to StringKeyTransitPart1.GOCHARA_JUPITER_2, 5 to StringKeyTransitPart1.GOCHARA_JUPITER_5, 7 to StringKeyTransitPart1.GOCHARA_JUPITER_7, 9 to StringKeyTransitPart1.GOCHARA_JUPITER_9, 11 to StringKeyTransitPart1.GOCHARA_JUPITER_11),
            Planet.VENUS to mapOf(1 to StringKeyTransitPart1.GOCHARA_VENUS_1, 2 to StringKeyTransitPart1.GOCHARA_VENUS_2, 3 to StringKeyTransitPart1.GOCHARA_VENUS_3, 4 to StringKeyTransitPart1.GOCHARA_VENUS_4, 5 to StringKeyTransitPart1.GOCHARA_VENUS_5, 8 to StringKeyTransitPart1.GOCHARA_VENUS_8, 9 to StringKeyTransitPart1.GOCHARA_VENUS_9, 11 to StringKeyTransitPart1.GOCHARA_VENUS_11, 12 to StringKeyTransitPart1.GOCHARA_VENUS_12),
            Planet.SATURN to mapOf(3 to StringKeyTransitPart1.GOCHARA_SATURN_3, 6 to StringKeyTransitPart1.GOCHARA_SATURN_6, 11 to StringKeyTransitPart1.GOCHARA_SATURN_11),
            Planet.RAHU to mapOf(3 to StringKeyTransitPart1.GOCHARA_RAHU_3, 6 to StringKeyTransitPart1.GOCHARA_RAHU_6, 10 to StringKeyTransitPart1.GOCHARA_RAHU_10, 11 to StringKeyTransitPart1.GOCHARA_RAHU_11),
            Planet.KETU to mapOf(3 to StringKeyTransitPart1.GOCHARA_KETU_3, 6 to StringKeyTransitPart1.GOCHARA_KETU_6, 9 to StringKeyTransitPart1.GOCHARA_KETU_9, 11 to StringKeyTransitPart1.GOCHARA_KETU_11)
        )

        private val GOCHARA_UNFAVORABLE_KEYS = mapOf(
            Planet.SUN to mapOf(1 to StringKeyTransitPart1.GOCHARA_SUN_1, 2 to StringKeyTransitPart1.GOCHARA_SUN_2, 4 to StringKeyTransitPart1.GOCHARA_SUN_4, 5 to StringKeyTransitPart1.GOCHARA_SUN_5, 7 to StringKeyTransitPart1.GOCHARA_SUN_7, 8 to StringKeyTransitPart1.GOCHARA_SUN_8, 9 to StringKeyTransitPart1.GOCHARA_SUN_9, 12 to StringKeyTransitPart1.GOCHARA_SUN_12),
            Planet.MOON to mapOf(2 to StringKeyTransitPart1.GOCHARA_MOON_2, 4 to StringKeyTransitPart1.GOCHARA_MOON_4, 5 to StringKeyTransitPart1.GOCHARA_MOON_5, 8 to StringKeyTransitPart1.GOCHARA_MOON_8, 9 to StringKeyTransitPart1.GOCHARA_MOON_9, 12 to StringKeyTransitPart1.GOCHARA_MOON_12),
            Planet.MARS to mapOf(1 to StringKeyTransitPart1.GOCHARA_MARS_1, 2 to StringKeyTransitPart1.GOCHARA_MARS_2, 4 to StringKeyTransitPart1.GOCHARA_MARS_4, 5 to StringKeyTransitPart1.GOCHARA_MARS_5, 7 to StringKeyTransitPart1.GOCHARA_MARS_7, 8 to StringKeyTransitPart1.GOCHARA_MARS_8, 9 to StringKeyTransitPart1.GOCHARA_MARS_9, 10 to StringKeyTransitPart1.GOCHARA_MARS_10, 12 to StringKeyTransitPart1.GOCHARA_MARS_12),
            Planet.MERCURY to mapOf(1 to StringKeyTransitPart1.GOCHARA_MERCURY_1, 3 to StringKeyTransitPart1.GOCHARA_MERCURY_3, 5 to StringKeyTransitPart1.GOCHARA_MERCURY_5, 7 to StringKeyTransitPart1.GOCHARA_MERCURY_7, 9 to StringKeyTransitPart1.GOCHARA_MERCURY_9, 12 to StringKeyTransitPart1.GOCHARA_MERCURY_12),
            Planet.JUPITER to mapOf(1 to StringKeyTransitPart1.GOCHARA_JUPITER_1, 3 to StringKeyTransitPart1.GOCHARA_JUPITER_3, 4 to StringKeyTransitPart1.GOCHARA_JUPITER_4, 6 to StringKeyTransitPart1.GOCHARA_JUPITER_6, 8 to StringKeyTransitPart1.GOCHARA_JUPITER_8, 10 to StringKeyTransitPart1.GOCHARA_JUPITER_10, 12 to StringKeyTransitPart1.GOCHARA_JUPITER_12),
            Planet.SATURN to mapOf(1 to StringKeyTransitPart1.GOCHARA_SATURN_1, 2 to StringKeyTransitPart1.GOCHARA_SATURN_2, 4 to StringKeyTransitPart1.GOCHARA_SATURN_4, 5 to StringKeyTransitPart1.GOCHARA_SATURN_5, 7 to StringKeyTransitPart1.GOCHARA_SATURN_7, 8 to StringKeyTransitPart1.GOCHARA_SATURN_8, 9 to StringKeyTransitPart1.GOCHARA_SATURN_9, 10 to StringKeyTransitPart1.GOCHARA_SATURN_10, 12 to StringKeyTransitPart1.GOCHARA_SATURN_12),
            Planet.RAHU to mapOf(1 to StringKeyTransitPart1.GOCHARA_RAHU_1, 2 to StringKeyTransitPart1.GOCHARA_RAHU_2, 4 to StringKeyTransitPart1.GOCHARA_RAHU_4, 5 to StringKeyTransitPart1.GOCHARA_RAHU_5, 7 to StringKeyTransitPart1.GOCHARA_RAHU_7, 8 to StringKeyTransitPart1.GOCHARA_RAHU_8, 9 to StringKeyTransitPart1.GOCHARA_RAHU_9, 12 to StringKeyTransitPart1.GOCHARA_RAHU_12),
            Planet.KETU to mapOf(1 to StringKeyTransitPart1.GOCHARA_KETU_1, 2 to StringKeyTransitPart1.GOCHARA_KETU_2, 4 to StringKeyTransitPart1.GOCHARA_KETU_4, 5 to StringKeyTransitPart1.GOCHARA_KETU_5, 7 to StringKeyTransitPart1.GOCHARA_KETU_7, 8 to StringKeyTransitPart1.GOCHARA_KETU_8, 10 to StringKeyTransitPart1.GOCHARA_KETU_10, 12 to StringKeyTransitPart1.GOCHARA_KETU_12)
        )
    ...
    private fun generateGocharaInterpretation(
        ...
        return if (isVedhaAffected) {
            baseInterpretation + getString(StringKeyGeneralPart12.VEDHA_OBSTRUCTION, "...") // Analyzer doesn't always have source here
        } else {
            baseInterpretation
        }
    }
