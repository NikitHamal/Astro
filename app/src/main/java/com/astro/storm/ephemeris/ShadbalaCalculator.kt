...
data class PlanetaryShadbala(
    ...
    fun getInterpretation(language: Language = Language.ENGLISH): String = buildString {
        appendLine(StringResources.get(StringKeyAnalysis.SHADBALA_PLANET_ANALYSIS, language, planet.getLocalizedName(language)))
        appendLine("═══════════════════════════════════════")
        appendLine()
        appendLine("${StringResources.get(StringKeyAnalysis.SHADBALA_TOTAL_STRENGTH, language)}: ${FORMAT_TWO_DECIMAL.format(totalRupas)} ${StringResources.get(StringKeyAnalysis.SHADBALA_RUPAS, language)}")
        appendLine("${StringResources.get(StringKeyAnalysis.SHADBALA_REQUIRED, language)}: ${FORMAT_TWO_DECIMAL.format(requiredRupas)} ${StringResources.get(StringKeyAnalysis.SHADBALA_RUPAS, language)}")
        appendLine("${StringResources.get(StringKeyAnalysis.SHADBALA_PERCENTAGE, language)}: ${FORMAT_ONE_DECIMAL.format(percentageOfRequired)}%")
        appendLine("${StringResources.get(StringKeyAnalysis.SHADBALA_RATING, language)}: ${strengthRating.getLocalizedName(language)}")
        appendLine()
        appendLine("${StringResources.get(StringKeyAnalysis.SHADBALA_BREAKDOWN, language)} (${StringResources.get(StringKeyAnalysis.SHADBALA_VIRUPAS, language)}):")
        appendLine("───────────────────────────────────────")
        appendLine("1. ${StringResources.get(StringKeyAnalysis.SHADBALA_STHANA_BALA, language)}: ${FORMAT_TWO_DECIMAL.format(sthanaBala.total)}")
        appendLine("   • ${StringResources.get(StringKeyAnalysis.SHADBALA_UCCHA_BALA, language)}: ${FORMAT_TWO_DECIMAL.format(sthanaBala.ucchaBala)}")
        appendLine("   • ${StringResources.get(StringKeyAnalysis.SHADBALA_SAPTAVARGAJA_BALA, language)}: ${FORMAT_TWO_DECIMAL.format(sthanaBala.saptavargajaBala)}")
        appendLine("   • ${StringResources.get(StringKeyAnalysis.SHADBALA_OJHAYUGMA_BALA, language)}: ${FORMAT_TWO_DECIMAL.format(sthanaBala.ojhayugmarasyamsaBala)}")
        appendLine("   • ${StringResources.get(StringKeyAnalysis.SHADBALA_KENDRADI_BALA, language)}: ${FORMAT_TWO_DECIMAL.format(sthanaBala.kendradiBala)}")
        appendLine("   • ${StringResources.get(StringKeyAnalysis.SHADBALA_DREKKANA_BALA, language)}: ${FORMAT_TWO_DECIMAL.format(sthanaBala.drekkanaBala)}")
        appendLine()
        appendLine("2. ${StringResources.get(StringKeyAnalysis.SHADBALA_DIG_BALA, language)}: ${FORMAT_TWO_DECIMAL.format(digBala)}")
        appendLine()
        appendLine("3. ${StringResources.get(StringKeyAnalysis.SHADBALA_KALA_BALA, language)}: ${FORMAT_TWO_DECIMAL.format(kalaBala.total)}")
        appendLine("   • ${StringResources.get(StringKeyAnalysis.SHADBALA_NATHONNATHA_BALA, language)}: ${FORMAT_TWO_DECIMAL.format(kalaBala.nathonnathaBala)}")
        appendLine("   • ${StringResources.get(StringKeyAnalysis.SHADBALA_PAKSHA_BALA, language)}: ${FORMAT_TWO_DECIMAL.format(kalaBala.pakshaBala)}")
        appendLine("   • ${StringResources.get(StringKeyAnalysis.SHADBALA_TRIBHAGA_BALA, language)}: ${FORMAT_TWO_DECIMAL.format(kalaBala.tribhagaBala)}")
        appendLine("   • ${StringResources.get(StringKeyAnalysis.SHADBALA_HORA_BALA, language)}: ${FORMAT_TWO_DECIMAL.format(kalaBala.horaAdiBala)}")
        appendLine("   • ${StringResources.get(StringKeyAnalysis.SHADBALA_AYANA_BALA, language)}: ${FORMAT_TWO_DECIMAL.format(kalaBala.ayanaBala)}")
        appendLine("   • ${StringResources.get(StringKeyAnalysis.SHADBALA_YUDDHA_BALA, language)}: ${FORMAT_TWO_DECIMAL.format(kalaBala.yuddhaBala)}")
        appendLine()
        appendLine("4. ${StringResources.get(StringKeyAnalysis.SHADBALA_CHESTA_BALA, language)}: ${FORMAT_TWO_DECIMAL.format(chestaBala)}")
        appendLine()
        appendLine("5. ${StringResources.get(StringKeyAnalysis.SHADBALA_NAISARGIKA_BALA, language)}: ${FORMAT_TWO_DECIMAL.format(naisargikaBala)}")
        appendLine()
        appendLine("6. ${StringResources.get(StringKeyAnalysis.SHADBALA_DRIK_BALA, language)}: ${FORMAT_TWO_DECIMAL.format(drikBala)}")
    }
...
data class ShadbalaAnalysis(
    ...
    fun getSummaryInterpretation(language: Language = Language.ENGLISH): String {
        ...
        return buildString {
            appendLine(StringResources.get(StringKeyAnalysis.SHADBALA_TITLE, language) + " " + StringResources.get(StringKeyAnalysis.SHADBALA_OVERVIEW, language))
            appendLine("═══════════════════════════════════════")
            appendLine()
            appendLine("${StringResources.get(StringKeyAnalysis.SHADBALA_OVERALL_STRENGTH, language)}: ${String.format("%.1f", overallStrengthScore)}%")
            appendLine("${StringResources.get(StringKeyAnalysis.SHADBALA_STRONG_COUNT, language, strong)}")
            appendLine("${StringResources.get(StringKeyAnalysis.SHADBALA_WEAK_COUNT, language, weak)}")
            appendLine()
            appendLine("${StringResources.get(StringKeyAnalysis.SHADBALA_STRONGEST_PLANET, language)}: ${strongestPlanet.getLocalizedName(language)}")
            appendLine("${StringResources.get(StringKeyAnalysis.SHADBALA_WEAKEST_PLANET, language)}: ${weakestPlanet.getLocalizedName(language)}")
            appendLine()
            appendLine("${StringResources.get(StringKeyAnalysis.SHADBALA_BREAKDOWN, language)} (${StringResources.get(StringKeyAnalysis.SHADBALA_RUPAS, language)}):")
            appendLine("───────────────────────────────────────")
