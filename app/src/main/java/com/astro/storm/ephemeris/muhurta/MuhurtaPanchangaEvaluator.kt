...
import com.astro.storm.ephemeris.muhurta.MuhurtaConstants.BHADRA_TITHIS
import com.astro.storm.ephemeris.muhurta.MuhurtaConstants.DEGREES_PER_KARANA
import com.astro.storm.ephemeris.muhurta.MuhurtaConstants.DEGREES_PER_TITHI
import com.astro.storm.ephemeris.muhurta.MuhurtaConstants.DEGREES_PER_YOGA
import com.astro.storm.ephemeris.muhurta.MuhurtaConstants.INAUSPICIOUS_YOGAS
import com.astro.storm.ephemeris.muhurta.MuhurtaConstants.JAYA_TITHIS
import com.astro.storm.ephemeris.muhurta.MuhurtaConstants.MOVABLE_KARANAS
import com.astro.storm.ephemeris.muhurta.MuhurtaConstants.NANDA_TITHIS
import com.astro.storm.ephemeris.muhurta.MuhurtaConstants.PURNA_TITHIS
import com.astro.storm.ephemeris.muhurta.MuhurtaConstants.RIKTA_TITHIS
import com.astro.storm.ephemeris.muhurta.MuhurtaConstants.TITHI_NAMES
import com.astro.storm.ephemeris.muhurta.MuhurtaConstants.TOTAL_KARANAS
import com.astro.storm.ephemeris.muhurta.MuhurtaConstants.TOTAL_TITHIS
import com.astro.storm.ephemeris.muhurta.MuhurtaConstants.TOTAL_YOGAS
import com.astro.storm.ephemeris.muhurta.MuhurtaConstants.YOGA_NAMES
import com.astro.storm.ephemeris.muhurta.MuhurtaAstronomicalCalculator.normalizeDegrees
