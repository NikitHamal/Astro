...
enum class DivisionalChartType(
    ...
    fun getLocalizedDisplayName(language: Language): String = when (this) {
        D1_RASHI -> StringResources.get(StringKeyVargaPart1.VARGA_D1_TITLE, language)
        D2_HORA -> StringResources.get(StringKeyVargaPart2.VARGA_D2_TITLE, language)
        D3_DREKKANA -> StringResources.get(StringKeyVargaPart2.VARGA_D3_TITLE, language)
        D4_CHATURTHAMSA -> StringResources.get(StringKeyVargaPart2.VARGA_D4_TITLE, language)
        D5_PANCHAMSA -> StringResources.get(StringKeyVargaPart2.VARGA_D5_TITLE, language)
        D6_SHASTHAMSA -> StringResources.get(StringKeyVargaPart2.VARGA_D6_TITLE, language)
        D7_SAPTAMSA -> StringResources.get(StringKeyVargaPart2.VARGA_D7_TITLE, language)
        D8_ASHTAMSA -> StringResources.get(StringKeyVargaPart2.VARGA_D8_TITLE, language)
        D9_NAVAMSA -> StringResources.get(StringKeyVargaPart2.VARGA_D9_TITLE, language)
        D10_DASAMSA -> StringResources.get(StringKeyVargaPart1.VARGA_D10_TITLE, language)
        D11_RUDRAMSA -> StringResources.get(StringKeyVargaPart1.VARGA_D11_TITLE, language)
        D12_DWADASAMSA -> StringResources.get(StringKeyVargaPart1.VARGA_D12_TITLE, language)
        D16_SHODASAMSA -> StringResources.get(StringKeyVargaPart1.VARGA_D16_TITLE, language)
        D20_VIMSAMSA -> StringResources.get(StringKeyVargaPart2.VARGA_D20_TITLE, language)
        D24_CHATURVIMSAMSA -> StringResources.get(StringKeyVargaPart2.VARGA_D24_TITLE, language)
        D27_SAPTAVIMSAMSA -> StringResources.get(StringKeyVargaPart2.VARGA_D27_TITLE, language)
        D30_TRIMSAMSA -> StringResources.get(StringKeyVargaPart2.VARGA_D30_TITLE, language)
        D40_KHAVEDAMSA -> StringResources.get(StringKeyVargaPart2.VARGA_D40_TITLE, language)
        D45_AKSHAVEDAMSA -> StringResources.get(StringKeyVargaPart2.VARGA_D45_TITLE, language)
        D60_SHASHTIAMSA -> StringResources.get(StringKeyVargaPart2.VARGA_D60_TITLE, language)
        D81_NAVNAVAMSA -> StringResources.get(StringKeyVargaPart2.VARGA_D81_TITLE, language)
        D108_ASHTOTTARSHAMSA -> StringResources.get(StringKeyVargaPart1.VARGA_D108_TITLE, language)
        D144_DWADASH_DWADASHAMSA -> StringResources.get(StringKeyVargaPart1.VARGA_D144_TITLE, language)
    }

    fun getLocalizedDescription(language: Language): String = when (this) {
        D1_RASHI -> StringResources.get(StringKeyVargaPart1.VARGA_D1_DESC, language)
        D2_HORA -> StringResources.get(StringKeyVargaPart2.VARGA_D2_DESC, language)
        D3_DREKKANA -> StringResources.get(StringKeyVargaPart2.VARGA_D3_DESC, language)
        D4_CHATURTHAMSA -> StringResources.get(StringKeyVargaPart2.VARGA_D4_DESC, language)
        D5_PANCHAMSA -> StringResources.get(StringKeyVargaPart2.VARGA_D5_DESC, language)
        D6_SHASTHAMSA -> StringResources.get(StringKeyVargaPart2.VARGA_D6_DESC, language)
        D7_SAPTAMSA -> StringResources.get(StringKeyVargaPart2.VARGA_D7_DESC, language)
        D8_ASHTAMSA -> StringResources.get(StringKeyVargaPart2.VARGA_D8_DESC, language)
        D9_NAVAMSA -> StringResources.get(StringKeyVargaPart2.VARGA_D9_DESC, language)
        D10_DASAMSA -> StringResources.get(StringKeyVargaPart1.VARGA_D10_DESC, language)
        D11_RUDRAMSA -> StringResources.get(StringKeyVargaPart1.VARGA_D11_DESC, language)
        D12_DWADASAMSA -> StringResources.get(StringKeyVargaPart1.VARGA_D12_DESC, language)
        D16_SHODASAMSA -> StringResources.get(StringKeyVargaPart1.VARGA_D16_DESC, language)
        D20_VIMSAMSA -> StringResources.get(StringKeyVargaPart1.VARGA_D20_DESC, language)
        D24_CHATURVIMSAMSA -> StringResources.get(StringKeyVargaPart2.VARGA_D24_DESC, language)
        D27_SAPTAVIMSAMSA -> StringResources.get(StringKeyVargaPart2.VARGA_D27_DESC, language)
        D30_TRIMSAMSA -> StringResources.get(StringKeyVargaPart2.VARGA_D30_DESC, language)
        D40_KHAVEDAMSA -> StringResources.get(StringKeyVargaPart2.VARGA_D40_DESC, language)
        D45_AKSHAVEDAMSA -> StringResources.get(StringKeyVargaPart2.VARGA_D45_DESC, language)
        D60_SHASHTIAMSA -> StringResources.get(StringKeyVargaPart2.VARGA_D60_DESC, language)
        D81_NAVNAVAMSA -> StringResources.get(StringKeyVargaPart2.VARGA_D81_DESC, language)
        D108_ASHTOTTARSHAMSA -> StringResources.get(StringKeyVargaPart1.VARGA_D108_DESC, language)
        D144_DWADASH_DWADASHAMSA -> StringResources.get(StringKeyVargaPart1.VARGA_D144_DESC, language)
    }
...
data class DivisionalChartData(
    ...
    fun toLocalizedPlainText(language: Language): String {
        val ascendantLabel = StringResources.get(StringKeyGeneralPart3.CHART_LAGNA, language)
        val planetaryPositionsLabel = StringResources.get(StringKeyGeneralPart3.CHART_PLANETARY_POSITIONS, language)
        val houseLabel = StringResources.get(StringKeyGeneralPart5.HOUSE, language)
        val retroLabel = StringResources.get(StringKeyGeneralPart3.CHART_LEGEND_RETRO_SHORT, language)
