...
object YogaCalculator {
        ...
        if (planetsIn2ndFromMoon.isNotEmpty()) {
            ...
            yogas.add(
                Yoga(
                    ...
                    effects = LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_SUNAFA),
                    strength = strengthFromPercentage(strength),
                    strengthPercentage = strength,
                    isAuspicious = true,
        ...
        if (planetsIn12thFromMoon.isNotEmpty()) {
            ...
            yogas.add(
                Yoga(
                    ...
                    effects = LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_ANAFA),
                    strength = strengthFromPercentage(strength),
                    strengthPercentage = strength,
                    isAuspicious = true,
                    activationPeriod = LocalizableString.Resource(StringKeyYoga.ACTIVATION_MOON_AND_RELATED),
        ...
        if (planetsIn2ndFromMoon.isNotEmpty() && planetsIn12thFromMoon.isNotEmpty()) {
            ...
            yogas.add(
                Yoga(
                    ...
                    effects = LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_DURUDHARA),
                    strength = strengthFromPercentage(strength),
                    strengthPercentage = strength,
                    isAuspicious = true,
            ...
            if (houseFromMoon in listOf(1, 4, 7, 10)) {
                ...
                yogas.add(
                    Yoga(
                        ...
                        effects = LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_GAJA_KESARI),
                        strength = strengthFromPercentage(strength),
                        strengthPercentage = strength,
                        isAuspicious = true,
        ...
        if (beneficsFrom678.size >= 2) {
            ...
            yogas.add(
                Yoga(
                    ...
                    effects = LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_ADHI),
                    strength = strengthFromPercentage(strength),
                    strengthPercentage = strength,
                    isAuspicious = true,
        ...
        if (planetsIn2ndFromSun.isNotEmpty() && planetsIn12thFromSun.isNotEmpty()) {
            ...
            yogas.add(
                Yoga(
                    ...
                    effects = LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_UBHAYACHARI),
                    strength = strengthFromPercentage(strength),
                    strengthPercentage = strength,
                    isAuspicious = true,
            ...
            yogas.add(
                Yoga(
                    ...
                    effects = if (cancellations.isEmpty())
                        LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_KEMADRUMA_UNCANCELLED)
                    else
                        LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_KEMADRUMA_CANCELLED),
            ...
            if (moonFromJupiter in listOf(6, 8, 12)) {
                yogas.add(
                    Yoga(
                        ...
                        effects = LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_SHAKATA),
                        strength = YogaStrength.MODERATE,
        ...
        if (jupiterPos != null && rahuPos != null && areConjunct(jupiterPos, rahuPos)) {
            yogas.add(
                Yoga(
                    ...
                    effects = LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_GURU_CHANDAL),
                    strength = YogaStrength.MODERATE,
        ...
        if (sunPos != null && rahuPos != null && areConjunct(sunPos, rahuPos)) {
            ...
            yogas.add(
                Yoga(
                    ...
                    effects = LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_SURYA_GRAHAN),
                    strength = if (cancellations.isEmpty()) YogaStrength.STRONG else YogaStrength.WEAK,
        ...
        if (sunPos != null && ketuPos != null && areConjunct(sunPos, ketuPos)) {
            yogas.add(
                Yoga(
                    ...
                    effects = LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_SURYA_KETU_GRAHAN),
                    strength = YogaStrength.MODERATE,
        ...
        if (rahuPos != null && areConjunct(moonPos, rahuPos)) {
            ...
            yogas.add(
                Yoga(
                    ...
                    effects = LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_CHANDRA_GRAHAN),
                    strength = if (cancellations.isEmpty()) YogaStrength.STRONG else YogaStrength.WEAK,
        ...
        if (ketuPos != null && areConjunct(moonPos, ketuPos)) {
            yogas.add(
                Yoga(
                    ...
                    effects = LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_CHANDRA_KETU),
                    strength = YogaStrength.MODERATE,
                    strengthPercentage = 50.0,
                    isAuspicious = false,
        ...
        if (marsPos != null && rahuPos != null && areConjunct(marsPos, rahuPos)) {
            ...
            yogas.add(
                Yoga(
                    ...
                    effects = LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_ANGARAK),
        ...
        if (saturnPos != null && rahuPos != null && areConjunct(saturnPos, rahuPos)) {
            yogas.add(
                Yoga(
                    ...
                    effects = LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_SHRAPIT),
        ...
        if (hasMaleficIn2nd && hasMaleficIn12th) {
            ...
            yogas.add(
                Yoga(
                    ...
                    effects = LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_PAPAKARTARI),
                    strength = YogaStrength.MODERATE,
                    strengthPercentage = 60.0,
                    isAuspicious = false,
        ...
        if (sunPos != null && mercuryPos != null && areConjunct(sunPos, mercuryPos, customOrb = 6.0)) {
            ...
            yogas.add(
                Yoga(
                    ...
                    effects = LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_BUDHA_ADITYA),
                    strength = strengthFromPercentage(strength),
                    strengthPercentage = strength,
                    isAuspicious = true,
            ...
            if (allInGoodHouses && jupiterStrong) {
                ...
                yogas.add(
                    Yoga(
                        ...
                        effects = LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_SARASWATI),
                        strength = strengthFromPercentage(strength),
                        strengthPercentage = strength,
                        isAuspicious = true,
                        activationPeriod = LocalizableString.Resource(StringKeyYoga.ACTIVATION_JUPITER_MERCURY),
        ...
        if (beneficsInKendras.isNotEmpty() && maleficsInKendras.isEmpty()) {
            ...
            yogas.add(
                Yoga(
                    ...
                    effects = LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_PARVATA),
                    strength = strengthFromPercentage(strength),
                    strengthPercentage = strength,
                    isAuspicious = true,
                    activationPeriod = LocalizableString.Resource(StringKeyYoga.ACTIVATION_BENEFIC_PLANETS),
            ...
            if (lord4Pos != null && lord9Pos != null) {
                if (areConjunct(lord4Pos, lord9Pos) || areMutuallyAspecting(lord4Pos, lord9Pos) || areInExchange(lord4Pos, lord9Pos)) {
                    ...
                    yogas.add(
                        ...
                        effects = LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_KAHALA),
                            strength = strengthFromPercentage(strength),
                            strengthPercentage = strength,
                            isAuspicious = true,
        ...
        if (hasBeneficIn2nd && hasBeneficIn12th) {
            ...
            yogas.add(
                Yoga(
                    ...
                    effects = LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_SHUBHAKARTARI),
                    strength = strengthFromPercentage(strength),
                    strengthPercentage = strength,
                    isAuspicious = true,
                ...
                if (isSanyasaHouse || hasSaturn || hasKetu) {
                    ...
                    yogas.add(
                        Yoga(
                            ...
                            effects = LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_SANYASA),
                            strength = strengthFromPercentage(strength),
                            strengthPercentage = strength,
                ...
                if (jupiterPos != null && isAspecting(jupiterPos, lord1Pos)) {
                    ...
                    yogas.add(
                        Yoga(
                            ...
                            effects = LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_CHAMARA),
                            strength = strengthFromPercentage(strength),
                            strengthPercentage = strength,
                            isAuspicious = true,
            ...
            if (areConjunct(lord9Pos, lord10Pos) || areMutuallyAspecting(lord9Pos, lord10Pos) || areInExchange(lord9Pos, lord10Pos)) {
                ...
                yogas.add(
                    Yoga(
                        ...
                        effects = LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_DHARMA_KARMADHIPATI),
                        strength = strengthFromPercentage(strength),
                        strengthPercentage = strength,
                        isAuspicious = true,
    ...
    private fun createKendraTrikonaRajaYoga(
        ...
        return Yoga(
            name = StringKeyYoga.YOGA_KENDRA_TRIKONA_RAJA,
            sanskritName = StringKeyYoga.YOGA_KENDRA_TRIKONA_RAJA,
            category = YogaCategory.RAJA_YOGA,
            ...
            description = LocalizableString.ResourceWithArgs(
                if (type == "conjunction") StringKeyYoga.YOGA_DESC_KENDRA_TRIKONA_RAJA_CONJUNCTION else StringKeyYoga.YOGA_DESC_KENDRA_TRIKONA_RAJA_ASPECT,
                listOf(planetToStringKey(kendraLord), planetToStringKey(trikonaLord))
            ),
            effects = LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_KENDRA_TRIKONA_RAJA),
    ...
    private fun createParivartanaRajaYoga(
        ...
        return Yoga(
            name = StringKeyYoga.YOGA_PARIVARTANA_RAJA,
            sanskritName = StringKeyYoga.YOGA_PARIVARTANA_RAJA,
            category = YogaCategory.RAJA_YOGA,
            planets = listOf(planet1, planet2),
            houses = listOfNotNull(pos1?.house, pos2?.house),
            description = LocalizableString.ResourceWithArgs(StringKeyYoga.YOGA_DESC_PARIVARTANA_RAJA, listOf(planetToStringKey(planet1), planetToStringKey(planet2))),
            effects = LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_PARIVARTANA_RAJA),
            strength = strengthFromPercentage(adjustedStrength),
            strengthPercentage = adjustedStrength,
            isAuspicious = true,
    ...
    private fun createViparitaRajaYoga(
        ...
        return Yoga(
            name = StringKeyYoga.YOGA_VIPARITA_RAJA,
            sanskritName = StringKeyYoga.YOGA_VIPARITA_RAJA,
            category = YogaCategory.RAJA_YOGA,
            planets = listOf(planet1, planet2),
            houses = positions.map { it.house },
            description = LocalizableString.Resource(StringKeyYoga.YOGA_DESC_VIPARITA_RAJA),
            effects = LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_VIPARITA_RAJA),
            strength = strengthFromPercentage(adjustedStrength),
            strengthPercentage = adjustedStrength,
            isAuspicious = true,
            activationPeriod = LocalizableString.ResourceWithArgs(StringKeyYoga.ACTIVATION_DHANA_YOGA, listOf(planetToStringKey(planet1), planetToStringKey(planet2))),
    ...
    private fun createNeechaBhangaRajaYoga(
        ...
        return Yoga(
            name = StringKeyYoga.YOGA_NEECHA_BHANGA_RAJA,
            sanskritName = StringKeyYoga.YOGA_NEECHA_BHANGA_RAJA,
            category = YogaCategory.RAJA_YOGA,
            planets = listOf(planet),
            houses = listOfNotNull(pos?.house),
            description = LocalizableString.ResourceWithArgs(StringKeyYoga.YOGA_DESC_NEECHA_BHANGA_RAJA, listOf(planetToStringKey(planet))),
            effects = LocalizableString.Resource(StringKeyYoga.YOGA_EFFECTS_NEECHA_BHANGA_RAJA),
