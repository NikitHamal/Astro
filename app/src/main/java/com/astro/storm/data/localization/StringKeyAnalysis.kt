...
enum class StringKeyAnalysis(override val en: String, override val ne: String) : StringKeyInterface {
    ...
    ARGALA_LORD_PLACEMENT("Lord {0} in {1}", "स्वामी {0} {1} मा"),
    ARGALA_JUPITER_EXPANSION("Jupiter brings expansion and wisdom", "बृहस्पतिले विस्तार र बुद्धि ल्याउँछ"),
    ARGALA_VENUS_BEAUTY("Venus brings beauty and relationships", "शुक्रले सौन्दर्य र सम्बन्ध ल्याउँछ"),
    ARGALA_MARS_CONFLICT("Mars brings energy and conflict", "मंगलले ऊर्जा र द्वन्द्व ल्याउँछ"),
    ARGALA_SATURN_DELAY("Saturn brings discipline and delay", "शनिले अनुशासन र ढिलाइ ल्याउँछ"),
    ARGALA_SUN_AUTHORITY("Sun brings authority and ego", "सूर्यले अधिकार र अहंकार ल्याउँछ"),
    ARGALA_MOON_EMOTION("Moon brings emotions and nurturing", "चन्द्रमाले भावना र पोषण ल्याउँछ"),
    ARGALA_MERCURY_COMM("Mercury brings communication and intellect", "बुधले सञ्चार र बुद्धि ल्याउँछ"),
    ARGALA_RAHU_ILLUSION("Rahu brings illusion and foreign influence", "राहुले भ्रम र विदेशी प्रभाव ल्याउँछ"),
    ARGALA_KETU_DETACHMENT("Ketu brings detachment and spirituality", "केतुले वैराग्य र आध्यात्मिकता ल्याउँछ"),
    ARGALA_GENERAL_EFFECT("General planetary influences", "सामान्य ग्रह प्रभावहरू"),
    ARGALA_PLANETS_INFLUENCE("{0} influencing with {1} nature", "{0} ले {1} प्रकृतिसँग प्रभाव पार्दै"),
    ARGALA_NO_PLANETS("No planets influencing", "कुनै ग्रहले प्रभाव पारेको छैन"),
    ARGALA_HOUSE_INTERP_DESC("House {0} receives argala from {1} planets in house {2}, indicating {3}", "भाव {0} ले भाव {2} मा रहेका {1} ग्रहहरूबाट अर्गला प्राप्त गर्दछ, जसले {3} को संकेत गर्दछ"),
    ARGALA_REMEDY_1("Strengthen house {0} lord {1} through mantras and charity", "मन्त्र र दान मार्फत भाव {0} को स्वामी {1} लाई बलियो बनाउनुहोस्"),
    ARGALA_MIXED_NATURE("mixed", "मिश्रित"),
    ...
    TRANSIT_TITLE("Transit Prediction", "गोचर फल"),

    // Ashtakavarga
    SAV_HEADER("Sarvashtakavarga (SAV)", "सर्वाष्टकवर्ग (एसेभी)"),
    BAV_HEADER("Bhinnashtakavarga (BAV)", "भिन्नाष्टकवर्ग (बीएभी)"),
    TOTAL_SAV_BINDUS("Total SAV Bindus", "कुल एसेभी बिन्दुहरू"),
    AVG_PER_SIGN("Average per Sign", "प्रति राशि औसत"),
    KAKSHA_LORD("Kaksha Lord", "कक्षा स्वामी"),
    BINDU_STRENGTH_ANALYSIS("Bindu strength analysis", "बिन्दु बल विश्लेषण"),
    ASHTAKAVARGA_INFO("Ashtakavarga information", "अष्टकवर्ग जानकारी"),
    ASHTAKAVARGA_SUMMARY("Ashtakavarga Summary", "अष्टकवर्ग सारांश"),
    BINDU_DIST_ANALYSIS("Bindu distribution analysis", "बिन्दु वितरण विश्लेषण"),
    AVG_PER_HOUSE("Avg/House", "औसत/भाव"),
    STRENGTH_TOTAL("Total Strength", "कुल बल"),
    OVERALL_CHART_STRENGTH("Overall Chart Strength", "सम्पूर्ण कुण्डली बल"),
    HOUSE_STRENGTH_DIST("House Strength Distribution", "भाव बल वितरण"),
    LEGEND_STRONG(">30 Strong", ">३० बलियो"),
    LEGEND_GOOD("25-30 Good", "२५-३० राम्रो"),
    LEGEND_WEAK("<25 Weak", "<२५ कमजोर"),
    LABEL_BINDUS("bindus", "बिन्दुहरू"),
    
    // Planet Matters for Ashtakavarga
    MATTERS_AUTHORITY("authority, father, health, and career", "अधिकार, पिता, स्वास्थ्य, र करियर"),
    MATTERS_MIND("mind, emotions, mother, and public image", "मन, भावना, आमा, र सार्वजनिक छवि"),
    MATTERS_ENERGY("energy, siblings, property, and courage", "उर्जा, दाजुभाइ, सम्पत्ति, र साहस"),
    MATTERS_INTELLECT("communication, intellect, and business", "सञ्चार, बुद्धि, र व्यापार"),
    MATTERS_WISDOM("wisdom, children, fortune, and spirituality", "ज्ञान, सन्तान, भाग्य, र आध्यात्मिकता"),
    MATTERS_RELATIONSHIPS("relationships, luxury, arts, and vehicles", "सम्बन्ध, विलासिता, कला, र सवारी साधन"),
    MATTERS_DISCIPLINE("career, longevity, and discipline", "करियर, दीर्घायु, र अनुशासन"),

    // House area matters for Ashtakavarga
    HOUSE_MATTERS_1("self, personality, and health", "आफैं, व्यक्तित्व, र स्वास्थ्य"),
    HOUSE_MATTERS_2("wealth, family, and speech", "धन, परिवार, र बोली"),
    HOUSE_MATTERS_3("courage, siblings, and communication", "साहस, दाजुभाइ, र सञ्चार"),
    HOUSE_MATTERS_4("home, mother, and comfort", "घर, आमा, र आराम"),
    HOUSE_MATTERS_5("children, intelligence, and romance", "सन्तान, बुद्धि, र प्रेम"),
    HOUSE_MATTERS_6("enemies, health issues, and service", "शत्रु, स्वास्थ्य समस्या, र सेवा"),
    HOUSE_MATTERS_7("partnership, marriage, and business", "साझेदारी, विवाह, र व्यापार"),
    HOUSE_MATTERS_8("transformation, inheritance, and occult", "परिवर्तन, पैतृक सम्पत्ति, र गुप्त विद्या"),
    HOUSE_MATTERS_9("luck, father, and higher learning", "भाग्य, पिता, र उच्च शिक्षा"),
    HOUSE_MATTERS_10("career, status, and authority", "करियर, स्थिति, र अधिकार"),
    HOUSE_MATTERS_11("gains, friends, and aspirations", "लाभ, साथीहरू, र आकांक्षाहरू"),
    HOUSE_MATTERS_12("losses, spirituality, and foreign travels", "खर्च, आध्यात्मिकता, र विदेश यात्रा"),
    ...
    ARGALA_GAINS_ARGALA("Argala from Gains", "लाभबाट अर्गला"),
    
    // Arudha Pada Names
    ARUDHA_NAME_AL("AL", "एएल (AL)"),
    ARUDHA_FULL_AL("Arudha Lagna (Pada Lagna)", "आरुढ लग्न (पद लग्न)"),
    ARUDHA_NAME_UL("UL", "यूएल (UL)"),
    ARUDHA_FULL_UL("Upapada (Spouse Indicator)", "उपपद (जीवनसाथी सूचक)"),
    ARUDHA_NAME_A7("A7", "ए७ (A7)"),
    ARUDHA_FULL_A7("Dara Pada (Spouse/Business)", "दार पद (पति/पत्नी/व्यापार)"),
    ARUDHA_NAME_A10("A10", "ए१० (A10)"),
    ARUDHA_FULL_A10("Rajya Pada (Career/Authority)", "राज्य पद (करियर/अधिकार)"),
    ARUDHA_NAME_A11("A11", "ए११ (A11)"),
    ARUDHA_FULL_A11("Labha Pada (Gains)", "लाभ पद (लाभहरू)"),
    ARUDHA_GENERIC_FULL("Arudha of House %d", "घर %d को आरुढ"),

    // Arudha Interpretation fragments
    ARUDHA_AREA_1("public image and how you are perceived", "सार्वजनिक छवि र तपाईलाई कसरी हेरिन्छ"),
    ARUDHA_AREA_2("wealth manifestation and family status", "धनको अभिव्यक्ति र पारिवारिक स्थिति"),
    ARUDHA_AREA_3("display of courage and sibling matters", "साहसको प्रदर्शन र दाजुभाइका कुराहरू"),
    ARUDHA_AREA_4("property and comfort in life", "सम्पत्ति र जीवनमा आराम"),
    ARUDHA_AREA_5("intelligence recognition and children", "बुद्धिको मान्यता र बच्चाहरू"),
    ARUDHA_AREA_6("enemies, debts, and health matters", "शत्रुहरू, ऋण, र स्वास्थ्य मामिलाहरू"),
    ARUDHA_AREA_7("business partnerships and marriage", "व्यापार साझेदारी र विवाह"),
    ARUDHA_AREA_8("inheritance and hidden transformations", "पैतृक सम्पत्ति र लुकेका परिवर्तनहरू"),
    ARUDHA_AREA_9("fortune and spiritual pursuits", "भाग्य र आध्यात्मिक खोज"),
    ARUDHA_AREA_10("career and authoritative position", "करियर र आधिकारिक स्थिति"),
    ARUDHA_AREA_11("gains and fulfillment of desires", "लाभ र इच्छाहरूको पूर्ति"),
    ARUDHA_AREA_12("spouse characteristics and marriage outcome", "पति/पत्नीका विशेषताहरू र विवाहको परिणाम"),

    // Significations
    SIG_PUBLIC_IMAGE("Public image", "सार्वजनिक छवि"),
    SIG_PHYSICAL_APP("Physical appearance", "शारीरिक बनावट"),
    SIG_PERCEPTION("How others perceive you", "अरूले तपाईंलाई कसरी हेर्छन्"),
    SIG_MAYA_SELF("Maya/Illusion of self", "माया/आफैंको भ्रम"),
    SIG_WEALTH_PERC("Wealth perception", "धनको धारणा"),
    SIG_FAMILY_STATUS("Family status", "पारिवारिक स्थिति"),
    SIG_SPEECH_COMM("Speech and communication", "बोली र सञ्चार"),
    SIG_FOOD_HABITS("Food habits", "खानपान बानी"),
    SIG_COURAGE_DISP("Courage display", "साहस प्रदर्शन"),
    SIG_SIBLINGS_STATUS("Siblings' status", "दाजुभाइ/दिदीबहिनीको स्थिति"),
    SIG_COMM_SKILLS("Communication skills", "सञ्चार सीप"),
    SIG_SHORT_TRAVELS("Short travels", "छोटो यात्रा"),
    SIG_PROPERTY_MATTERS("Property matters", "सम्पत्ति मामिलाहरू"),
    SIG_MOTHER_IMAGE("Mother's image", "आमाको छवि"),
    SIG_VEHICLES("Vehicles", "सवारी साधनहरू"),
    SIG_COMFORT_LUXURY("Comfort and luxury", "आराम र विलासिता"),
    SIG_INTEL_DISP("Intelligence display", "बुद्धि प्रदर्शन"),
    SIG_CHILDREN_IMAGE("Children's image", "छोराछोरीको छवि"),
    SIG_SPEC_GAINS("Speculative gains", "सट्टा लाभ"),
    SIG_COUNSEL_GIVEN("Counsel given", "दिइएको सल्लाह"),
    SIG_ENEMIES_STR("Enemies' strength", "शत्रुहरूको बल"),
    SIG_DISEASE_MANIF("Disease manifestation", "रोगको अभिव्यक्ति"),
    SIG_DEBTS("Debts", "ऋण"),
    SIG_SERVICE_COND("Service conditions", "सेवा सर्तहरू"),
    SIG_BUS_PARTNERS("Business partnerships", "व्यापार साझेदारी"),
    SIG_TRADE("Trade", "व्यापार"),
    SIG_PUBLIC_DEALINGS("Public dealings", "सार्वजनिक व्यवहार"),
    SIG_MARRIAGE_MANIF("Marriage manifestation", "विवाहको अभिव्यक्ति"),
    SIG_HIDDEN_MATTERS("Hidden matters", "लुकेका कुराहरू"),
    SIG_INSURANCE_LEGACY("Insurance/Legacy", "बीमा/विरासत"),
    SIG_TRANSFORMATION("Transformation", "परिवर्तन"),
    SIG_RESEARCH("Research", "अनुसन्धान"),
    SIG_GURU_IMAGE("Guru/Father image", "गुरु/पिताको छवि"),
    SIG_FORTUNE_MANIF("Fortune manifestation", "भाग्यको अभिव्यक्ति"),
    SIG_RELIGIOUS_DISP("Religious displays", "धार्मिक प्रदर्शन"),
    SIG_HIGHER_LEARNING("Higher learning", "उच्च शिक्षा"),
    SIG_CAREER_MANIF("Career manifestation", "करियरको अभिव्यक्ति"),
    SIG_REPUTATION("Reputation", "प्रतिष्ठा"),
    SIG_GOVT_DEALINGS("Government dealings", "सरकारी व्यवहार"),
    SIG_GAINS_PROFITS("Gains and profits", "लाभ र नाफा"),
    SIG_ELDER_SIBLINGS("Elder siblings", "जेठा दाजुभाइ/दिदीबहिनी"),
    SIG_NETWORKS("Networks", "नेटवर्क"),
    SIG_SPOUSE_CHAR("Spouse characteristics", "पति/पत्नीका विशेषताहरू"),
    SIG_MARRIAGE_OUTCOME("Marriage outcome", "विवाहको परिणाम"),
    SIG_BEDROOM_MATTERS("Bedroom matters", "भोजन र शयन"),
    SIG_FOREIGN_LANDS("Foreign lands", "विदेशी भूमि"),

    // Sign Nature
    NATURE_FIRE_VISIBLE("dynamic and visible", "गतिशील र दृश्य"),
    NATURE_EARTH_PRACTICAL("practical and tangible", "व्यावहारिक र मूर्त"),
    NATURE_AIR_SOCIAL("intellectual and social", "बौद्धिक र सामाजिक"),
    NATURE_WATER_INTUITIVE("emotional and intuitive", "भावनात्मक र सहज"),

    // Sign Image Descriptions
    SIG_DESC_ARIES("a dynamic, pioneering, and leadership-oriented personality", "एक गतिशील, अग्रणी, र नेतृत्व-मुखी व्यक्तित्व"),
    SIG_DESC_TAURUS("a stable, wealthy, and comfort-loving image", "एक स्थिर, धनी, र विलासी छवि"),
    SIG_DESC_GEMINI("an intellectual, communicative, and versatile personality", "एक बौद्धिक, सञ्चारशील, र बहुमुखी व्यक्तित्व"),
    SIG_DESC_CANCER("a nurturing, emotional, and family-oriented image", "एक पालनपोषण गर्ने, भावनात्मक, र पारिवारिक छवि"),
    SIG_DESC_LEO("a royal, authoritative, and creative personality", "एक शाही, आधिकारिक, र रचनात्मक व्यक्तित्व"),
    SIG_DESC_VIRGO("a practical, analytical, and service-oriented image", "एक व्यावहारिक, विश्लेषणात्मक, र सेवा-मुखी छवि"),
    SIG_DESC_LIBRA("a balanced, diplomatic, and artistic personality", "एक सन्तुलित, कूटनीतिक, र कलात्मक व्यक्तित्व"),
    SIG_DESC_SCORPIO("a mysterious, intense, and transformative image", "एक रहस्यमय, गहिरो, र परिवर्तनकारी छवि"),
    SIG_DESC_SAGITTARIUS("a philosophical, adventurous, and teaching personality", "एक दार्शनिक, साहसी, र शिक्षण उन्मुख व्यक्तित्व"),
    SIG_DESC_CAPRICORN("a professional, disciplined, and ambitious image", "एक पेशेवर, अनुशासित, र महत्वाकांक्षी छवि"),
    SIG_DESC_AQUARIUS("an innovative, humanitarian, and unconventional personality", "एक अभिनव, परोपकारी, र अपरम्परागत व्यक्तित्व"),
    SIG_DESC_PISCES("a spiritual, compassionate, and artistic image", "एक आध्यात्मिक, दयालु, र कलात्मक छवि"),

    // Business (A7) Descriptions
    A7_BUS_FIRE("Business success through leadership, entrepreneurship, and bold ventures", "नेतृत्व, उद्यमशीलता, र साहसी कार्यहरू मार्फत व्यापार सफलता"),
    A7_BUS_EARTH("Business success through practical dealings, real estate, and steady growth", "व्यावहारिक व्यवहार, घरजग्गा, र स्थिर वृद्धि मार्फत व्यापार सफलता"),
    A7_BUS_AIR("Business success through communication, networking, and intellectual services", "सञ्चार, नेटवर्किङ, र बौद्धिक सेवाहरू मार्फत व्यापार सफलता"),
    A7_BUS_WATER("Business success through intuition, healing, or emotionally satisfying services", "सहज ज्ञान, उपचार, वा भावनात्मक रूपमा सन्तोषजनक सेवाहरू मार्फत व्यापार सफलता"),

    // Career (A10) Descriptions
    A10_CAR_SUN("Authority in government, administration, or leadership roles", "सरकार, प्रशासन, वा नेतृत्व भूमिकाहरूमा अधिकार"),
    A10_CAR_MOON("Public-facing roles, hospitality, or nurturing professions", "सार्वजनिक भूमिका, आतिथ्य, वा पालनपोषण पेशाहरू"),
    A10_CAR_MARS("Technical, engineering, military, or competitive fields", "प्राविधिक, इन्जिनियरिङ, सैन्य, वा प्रतिस्पर्धात्मक क्षेत्रहरू"),
    A10_CAR_MERCURY("Communication, commerce, writing, or analytical work", "सञ्चार, वाणिज्य, लेखन, वा विश्लेषणात्मक कार्य"),
    A10_CAR_JUPITER("Teaching, law, consultancy, or spiritual guidance", "शिक्षण, कानुन, परामर्श, वा आध्यात्मिक मार्गदर्शन"),
    A10_CAR_VENUS("Arts, entertainment, luxury goods, or beauty industry", "कला, मनोरञ्जन, विलासी सामान, वा सौन्दर्य उद्योग"),
    A10_CAR_SATURN("Structured organizations, labor, or traditional fields", "व्यवस्थित संगठनहरू, श्रम, वा परम्परागत क्षेत्रहरू"),

    // Spouse (UL) Descriptions
    UL_SPOUSE_ARIES("Spouse may be energetic, independent, and pioneering", "जीवनसाथी ऊर्जावान, स्वतन्त्र र अग्रणी हुन सक्छ"),
    UL_SPOUSE_TAURUS("Spouse may be attractive, stable, and comfort-loving", "जीवनसाथी आकर्षक, स्थिर र विलासी हुन सक्छ"),
    UL_SPOUSE_GEMINI("Spouse may be intellectual, communicative, and versatile", "जीवनसाथी बौद्धिक, सञ्चारशील र बहुमुखी हुन सक्छ"),
    UL_SPOUSE_CANCER("Spouse may be nurturing, emotional, and family-oriented", "जीवनसाथी पालनपोषण गर्ने, भावनात्मक र पारिवारिक हुन सक्छ"),
    UL_SPOUSE_LEO("Spouse may be dignified, creative, and authoritative", "जीवनसाथी सम्मानित, रचनात्मक र आधिकारिक हुन सक्छ"),
    UL_SPOUSE_VIRGO("Spouse may be practical, analytical, and health-conscious", "जीवनसाथी व्यावहारिक, विश्लेषणात्मक र स्वास्थ्यप्रति सचेत हुन सक्छ"),
    UL_SPOUSE_LIBRA("Spouse may be attractive, diplomatic, and artistic", "जीवनसाथी आकर्षक, कूटनीतिक र कलात्मक हुन सक्छ"),
    UL_SPOUSE_SCORPIO("Spouse may be intense, mysterious, and transformative", "जीवनसाथी गहिरो, रहस्यमय र परिवर्तनकारी हुन सक्छ"),
    UL_SPOUSE_SAGITTARIUS("Spouse may be philosophical, adventurous, and optimistic", "जीवनसाथी दार्शनिक, साहसी र आशावादी हुन सक्छ"),
    UL_SPOUSE_CAPRICORN("Spouse may be professional, disciplined, and ambitious", "जीवनसाथी पेशेवर, अनुशासित र महत्वाकांक्षी हुन सक्छ"),
    UL_SPOUSE_AQUARIUS("Spouse may be innovative, independent, and unconventional", "जीवनसाथी अभिनव, स्वतन्त्र र अपरम्परागत हुन सक्छ"),
    UL_SPOUSE_PISCES("Spouse may be spiritual, artistic, and compassionate", "जीवनसाथी आध्यात्मिक, कलात्मक र दयालु हुन सक्छ"),

    // Arudha Strength
    ARUDHA_STR_VERY_STRONG("This Arudha is exceptionally strong, indicating powerful manifestation", "यो आरुढ असाधारण रूपमा बलियो छ, जसले शक्तिशाली अभिव्यक्तिको संकेत गर्दछ"),
    ARUDHA_STR_STRONG("This Arudha is well-placed for positive results", "सकारात्मक परिणामका लागि यो आरुढ राम्रो ठाउँमा छ"),
    ARUDHA_STR_MODERATE("This Arudha shows mixed results depending on periods", "यो आरुढले समय अनुसार मिश्रित परिणामहरू देखाउँछ"),
    ARUDHA_STR_WEAK("This Arudha needs strengthening for better outcomes", "राम्रो परिणामका लागि यो आरुढलाई बलियो बनाउन आवश्यक छ"),
    ARUDHA_STR_VERY_WEAK("This Arudha is challenged and may struggle to manifest", "यो आरुढ चुनौतीपूर्ण छ र प्रकट हुन संघर्ष गर्न सक्छ"),

    // Ashtakavarga
    ASHTAKAVARGA_TOTAL_BINDUS("Total SAV Bindus", "कुल SAV बिन्दुहरू"),
    ASHTAKAVARGA_AVG_PER_SIGN("Average per Sign", "प्रति राशि औसत"),
    ASHTAKAVARGA_PLANET_BAV("%s Ashtakavarga", "%s अष्टकवर्ग"),
    ASHTAKAVARGA_STRENGTH_BAR("[%s]", "[%s]"),
    ASHTAKAVARGA_KAKSHA_ASC("Ascendant", "लग्न"),
    ...
    // Argala Interpretation Fragments
    ARGALA_INTERP_SUPPORT("Receives beneficial intervention supporting its significations.", "यसको कारकत्वहरूलाई समर्थन गर्ने फाइदाजनक हस्तक्षेप प्राप्त गर्दछ।"),
    ARGALA_INTERP_FLOURISH("The matters of this house tend to flourish with external support.", "यो भावका मामिलाहरू बाह्य सहयोगको साथ फस्टाउने प्रवृत्ति राख्छन्।"),
    ARGALA_INTERP_CHALLENGE("Receives challenging intervention creating obstacles.", "बाधाहरू सिर्जना गर्ने चुनौतीपूर्ण हस्तक्षेप प्राप्त गर्दछ।"),
    ARGALA_INTERP_OVERCOME("Requires conscious effort to overcome limitations.", "सीमाहरू पार गर्न सचेत प्रयास आवश्यक छ।"),
    ARGALA_INTERP_MIXED("Receives mixed intervention - both support and challenges.", "मिश्रित हस्तक्षेप प्राप्त गर्दछ - दुवै समर्थन र चुनौतीहरू।"),
    ARGALA_INTERP_DEPENDS("Results depend on current dasha and transits.", "परिणामहरू वर्तमान दशा र गोचरमा निर्भर हुन्छन्।"),
    ARGALA_PLANET_SUPPORTED("Strongly supported by beneficial Argala.", "फाइदाजनक अर्गलाबाट कडा रूपमा समर्थित।"),
    ARGALA_PLANET_MODERATE("Moderately supported by Argala.", "अर्गलाबाट मध्यम रूपमा समर्थित।"),
    ARGALA_PLANET_OBSTRUCTED("Faces some obstruction through Argala.", "अर्गला मार्फत केही बाधाको सामना गर्दछ।"),
    ARGALA_PLANET_CHALLENGED("Significantly challenged by malefic Argala.", "पापपूर्ण अर्गलाबाट महत्त्वपूर्ण रूपमा चुनौती दिइएको।"),
    ARGALA_PLANET_INFLUENCES("Receives %d Argala influence(s).", "%d अर्गला प्रभाव(हरू) प्राप्त गर्दछ।"),

    // Argala Karma Patterns
    ARGALA_KARMA_DHARMA_STRONG("Strong dharmic support through Argala - spiritual growth is favored", "अर्गला मार्फत बलियो धार्मिक समर्थन - आध्यात्मिक विकासको लागि अनुकूल छ"),
    ARGALA_KARMA_DHARMA_WEAK("Dharma houses need strengthening through spiritual practices", "आध्यात्मिक अभ्यासहरू मार्फत धर्म भावहरूलाई बलियो बनाउन आवश्यक छ"),
    ARGALA_KARMA_ARTHA_STRONG("Career and wealth houses well supported by Argala", "पेशा र धन भावहरू अर्गलाबाट राम्ररी समर्थित छन्"),
    ARGALA_KARMA_ARTHA_WEAK("Material success requires overcoming Argala obstacles", "भौतिक सफलताको लागि अर्गलाका बाधाहरू पार गर्न आवश्यक छ"),
    ARGALA_KARMA_KAMA_STRONG("Relationships and desires supported by beneficial Argala", "सम्बन्ध र इच्छाहरू फाइदाजनक अर्गलाबाट समर्थित छन्"),
    ARGALA_KARMA_KAMA_WEAK("Fulfillment of desires faces Argala-based challenges", "इच्छाहरूको पूर्तिले अर्गला-आधारित चुनौतीहरूको सामना गर्दछ"),
    ARGALA_KARMA_MOKSHA_STRONG("Liberation and inner peace supported by Argala patterns", "अर्गला ढाँचाहरूबाट मुक्ति र आन्तरिक शान्ति समर्थित छ"),

    // Argala Recommendations
    ARGALA_REC_FAVORABLE("Overall Argala pattern is favorable - utilize periods when Argala lords are active in dasha", "समग्र अर्गला ढाँचा अनुकूल छ - अर्गला स्वामीहरू दशामा सक्रिय हुँदा ती अवधिको उपयोग गर्नुहोस्"),
    ARGALA_REC_CHALLENGING("Focus on strengthening houses with Virodha Argala for better obstruction of malefic influences", "पाप प्रभावहरूको राम्रो अवरोधको लागि विरोध अर्गला भएका भावहरूलाई बलियो बनाउनमा ध्यान दिनुहोस्"),
    ARGALA_REC_REMEDY_SUN("Strengthen Sun and ascendant lord through mantras", "मन्त्रहरू मार्फत सूर्य र लग्न स्वामीलाई बलियो बनाउनुहोस्"),
    ARGALA_REC_REMEDY_VENUS("Strengthen Venus through white clothing and charity on Fridays", "सेतो कपडा र शुक्रबार दान मार्फत शुक्रलाई बलियो बनाउनुहोस्"),
    ARGALA_REC_REMEDY_SATURN("Strengthen Saturn through service and discipline", "सेवा र अनुशासन मार्फत शनिलाई बलियो बनाउनुहोस्"),
    ARGALA_REC_REMEDY_GENERIC("Perform remedies for house %d lord", "भाव %d स्वामीको लागि उपायहरू गर्नुहोस्"),

    // Life Area Effects
    ARGALA_AREA_EFFECT("Through %s, there is %s for %s", "%s मार्फत, %s को लागि %s छ"),
    ARGALA_EFFECT_SUPPORT("support", "समर्थन"),
    ARGALA_EFFECT_CHALLENGE("challenge", "चुनौती"),
    ARGALA_SOURCE_WEALTH("wealth and resources", "धन र स्रोतहरू"),
    ARGALA_SOURCE_HAPPINESS("happiness and comfort", "सुख र सुविधा"),
    ARGALA_SOURCE_GAINS("gains and aspirations", "लाभ र अकांक्षाहरू"),
    ARGALA_SOURCE_INTELLIGENCE("intelligence and creativity", "बुद्धि र सिर्जनशीलता"),
    ARGALA_TARGET_PERSONALITY("personality and health", "व्यक्तित्व र स्वास्थ्य"),
    ARGALA_TARGET_RELATIONSHIPS("relationships and marriage", "सम्बन्ध र विवाह"),
    ARGALA_TARGET_CAREER("career and public life", "पेशा र सार्वजनिक जीवन"),
    ARGALA_TARGET_HOME("home and mother", "घर र आमा"),
    ARGALA_TARGET_CHILDREN("children and creativity", "सन्तान र सिर्जनशीलता"),
    ARGALA_TARGET_GENERIC("house %d matters", "भाव %d का मामिलाहरू"),
