...
enum class StringKeyDosha(override val en: String, override val ne: String) : StringKeyInterface {
    ...
    KEMA_ABOUT_DESC("Kemadruma Yoga forms when the Moon is isolated in the birth chart - specifically when there are no planets in the houses immediately before and after the Moon (2nd and 12th from Moon). This yoga is traditionally associated with emotional challenges, financial instability, and social difficulties. However, many factors can cancel (Bhanga) this yoga, such as planets in Kendra from Moon or Lagna.", "केमद्रुम योग तब बन्छ जब चन्द्रमाको दोस्रो र बाह्रौं भावमा कुनै ग्रहहरू हुँदैनन्। यसले भावनात्मक चुनौती र आर्थिक अस्थिरता संकेत गर्छ। यद्यपि, केन्द्रमा रहेका ग्रहहरूले यो योग भंग गर्न सक्छन्।"),
