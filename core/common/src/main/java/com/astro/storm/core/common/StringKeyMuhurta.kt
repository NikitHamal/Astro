...
enum class StringKeyMuhurta(override val en: String, override val ne: String, override val hi: String) : StringKeyInterface {
    ...
    ,
    PANCHAKA_NONE("No Panchaka Dosha", "पञ्चक दोष छैन", "पञ्चक दोष हैैन"),
    ,
    ...
    // Severities
    SEVERITY_EXTREME("Extremely Severe - Avoid all important activities", "अत्यन्त गम्भीर - सबै महत्त्वपूर्ण गतिविधिहरूबाट बच्नुहोस्", "अत्यन्त गम्भीर - सभी महत्त्वपूर्ण गतिविधिबाट बच्नुहोस्"),
    ,
    SEVERITY_SEVERE("Severe - Exercise extreme caution", "गम्भीर - अत्यधिक सावधानी अपनाउनुहोस्", "गम्भीर - अत्यधिक सावधानी अपनाउनुहोस्"),
    ,
    SEVERITY_MODERATE("Moderate - Proceed with caution", "मध्यम - सावधानीका साथ अगाडि बढ्नुहोस्", "मध्यम - सावधानी के साथ अगाडि बढ्नुहोस्"),
    ,
    SEVERITY_MILD("Mild - Minor obstacles possible", "सामान्य - साना बाधाहरू सम्भव", "सामान्य - साना बाधा सम्भव"),
    ,
    SEVERITY_VERY_MILD("Very Mild - Usually negligible", "अति सामान्य - सामान्यतया नगन्य", "अति सामान्य - सामान्यतया नगन्य"),
    ,
    SEVERITY_NONE("None - No dosha present", "छैन - कुनै दोष छैन", "हैैन - कुनै दोष हैैन"),
    ...
    // Status
    SAFE("Safe - No Panchaka", "सुरक्षित - पञ्चक छैन", "सुरक्षित - पञ्चक हैैन"),
    ,
    ...
    // Messages
    SEARCH_EMPTY_TITLE("Search Muhurta", "मुहूर्त खोज्नुहोस्", "मुहूर्त खोज्नुहोस्"),
    ,
