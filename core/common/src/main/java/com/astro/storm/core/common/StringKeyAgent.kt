...
enum class StringKeyAgent(override val en: String, override val ne: String, override val hi: String) : StringKeyInterface {
    ...
    AGENT_DESCRIPTION("Your Vedic Astrology AI Assistant", "तपाईंको वैदिक ज्योतिष AI सहायक", "आपका वैदिक ज्योतिष AI सहायक"),
    ...
    TOOL_GET_CURRENT_DASHA("Get Current Dasha", "हालको दशा प्राप्त गर्नुहोस्", "हालको दशा प्राप्त करें"),
    TOOL_GET_YOGAS("Get Yogas", "योगहरू प्राप्त गर्नुहोस्", "योग प्राप्त करें"),
    TOOL_GET_ASHTAKAVARGA("Get Ashtakavarga", "अष्टकवर्ग प्राप्त गर्नुहोस्", "अष्टकवर्ग प्राप्त करें"),
    TOOL_GET_TRANSITS("Get Transits", "गोचरहरू प्राप्त गर्नुहोस्", "गोचरहरू प्राप्त करें"),
    ...
    // Status Messages
    STATUS_THINKING("Stormy is thinking...", "स्टोर्मी सोच्दै छ...", "स्टोर्मी सोच्दै छ..."),
    STATUS_CALLING_TOOL("Using %s...", "%s प्रयोग गर्दै...", "%s प्रयोग गर्दै..."),
    ...
    // Chat UI
    NEW_CHAT("New Chat", "नयाँ च्याट", "नया चैट"),
    CHAT_CONTEXT_ERROR("No conversation context", "च्याट सन्दर्भ छैन", "चैट सन्दर्भ छैन"),
    CHAT_NO_MODEL("No AI model available. Please configure models in settings.", "कुनै AI मोडेल उपलब्ध छैन। कृपया सेटिङ्समा मोडेलहरू कन्फिगर गर्नुहोस्।", "कुनै AI मोडेल उपलब्ध छैन। कृपया सेटिंग्समा मोडेलहरू कन्फिगर करें।"),
    RESPONSE_CANCELLED("Response cancelled", "प्रतिक्रिया रद्द गरियो", "प्रतिक्रिया रद्द गरियो"),
    
    // Agent Sections
    SECTION_REASONING("Reasoning", "तर्क", "तर्क"),
    SECTION_CONTENT("Content", "सामग्री", "सामग्री"),
    SECTION_TOOLS("Tools Used", "प्रयोग गरिएका उपकरणहरू", "प्रयोग गरिएका उपकरणहरू"),
    SECTION_TASKS("Tasks", "कार्यहरू", "कार्यहरू"),
    
    // User Interaction Tools
    ASK_USER_TITLE("Stormy asks:", "स्टोर्मी सोध्छ:", "स्टोर्मी सोध्छ:"),
    OPTION_LABEL("Option %d", "विकल्प %d", "विकल्प %d"),
    
    // Profile Tools
    PROFILE_CREATED("Profile created successfully", "प्रोफाइल सफलतापूर्वक बनाइयो", "प्रोफाइल सफलतापूर्वक बनाइयो"),
    PROFILE_UPDATED("Profile updated successfully", "प्रोफाइल सफलतापूर्वक अपडेट गरियो", "प्रोफाइल सफलतापूर्वक अपडेट गरियो"),
    PROFILE_DELETED("Profile deleted successfully", "प्रोफाइल सफलतापूर्वक मेटाइयो", "प्रोफाइल सफलतापूर्वक मेटाइयो"),
    PROFILE_ACTIVATED("Profile activated successfully", "प्रोफाइल सफलतापूर्वक सक्रिय गरियो", "प्रोफाइल सफलतापूर्वक सक्रिय गरियो"),
}
