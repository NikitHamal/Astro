...
enum class StringKeyUICommon(override val en: String, override val ne: String, override val hi: String) : StringKeyInterface {
    ...
    ,
    CHARACTERISTICS("Characteristics", "विशेषताहरू", "विशेषता"),
    ...
    ,
    STRENGTH_VERY_STRONG("Very Strong", "धेरै बलियो", "धेरै बलियह"),
    ,
    ...
    ,
    STRENGTH_EXTREMELY_STRONG("Extremely Strong", "अत्यधिक बलियो", "अत्यधिक बलियह"),
    ,
    ...
    // Generic Messages
    LOADING("Loading...", "लोड हुँदैछ...", "लोड हुँदैहै..."),
    ,
    ...
    ,
    ERROR_OCCURRED("An error occurred", "एउटा त्रुटि भयो", "एउटा त्रुटि भयह"),
    ,
    NO_DATA("No data available", "कुनै डाटा उपलब्ध छैन", "कुनै डाटा उपलब्ध हैैन"),
    ...
    ,
    SEARCH_TIMEZONE("Search timezone", "समय क्षेत्र खोज्नुहोस्", "समय क्षेत्र खोज्नुहोस्"),
    ,
    ALL_TIMEZONES("All Timezones", "सबै समय क्षेत्रहरू", "सभी समय क्षेत्र"),
    ,
    COMMON_TIMEZONES("Common Timezones", "साझा समय क्षेत्रहरू", "साझा समय क्षेत्र"),
    ,
    NO_TIMEZONES_FOUND("No timezones found", "कुनै समय क्षेत्र फेला परेन", "कुनै समय क्षेत्र फेला परेन"),
    ,
    CLEAR_SEARCH("Clear search", "खोज हटाउनुहोस्", "खोज हटाएं"),
    ,
    ...
    // Agentic UI Status
    TASKS("Tasks", "कार्यहरू", "कार्य"),
    ,
    COMPLETED("completed", "पूरा भयो", "पूरा भयह"),
    ,
    RUNNING("running", "चल्दैछ", "चल्दैहै"),
    ,
    FAILED("failed", "असफल भयो", "असफल भयह"),
    ,
    TOOL_PLURAL("tools", "उपकरणहरू", "उपकरण"),
    ,
