...
enum class StringKeyDeepHealth(override val en: String, override val ne: String, override val hi: String) : StringKeyInterface {
    ...
    DIETARY_RECS("Dietary Recommendations", "आहार सिफारिसहरू", "आहार सिफारिसहरू"),
    LIFESTYLE_RECS("Lifestyle Recommendations", "जीवनशैली सिफारिसहरू", "जीवनशैली सिफारिसहरू"),
    EXERCISE_RECS("Exercise Recommendations", "व्यायाम सिफारिसहरू", "व्यायाम सिफारिसहरू"),
    ...
    SIXTH_HOUSE_PLANETS("Planets in 6th House", "षष्ठ भावमा ग्रहहरू", "षष्ठ भावमा ग्रह"),
    ...
    POTENTIAL_AILMENTS("Potential Ailments", "सम्भावित रोगहरू", "सम्भावित रोगहरू"),
    ...
    EIGHTH_HOUSE_PLANETS("Planets in 8th House", "अष्टम भावमा ग्रहहरू", "अष्टम भावमा ग्रह"),
    CHRONIC_PATTERNS("Chronic Health Patterns", "दीर्घकालीन स्वास्थ्य ढाँचाहरू", "दीर्घकालीन स्वास्थ्य ढाँचाहरू"),
    REGENERATIVE_CAPACITY("Regenerative Capacity", "पुनर्जनन क्षमता", "पुनर्जनन क्षमता"),
    CRITICAL_PERIODS("Critical Health Periods", "महत्वपूर्ण स्वास्थ्य अवधिहरू", "महत्वपूर्ण स्वास्थ्य अवधिहरू"),
    ...
    MOON_HEALTH("Moon Health Influence", "चन्द्रमा स्वास्थ्य प्रभाव", "चन्द्रमा स्वास्थ्य प्रभाव"),
    ...
    // Body Part Mapping
    BODY_HEAD("Head & Face", "टाउको र अनुहार", "टाउको और अनुहार"),
    BODY_THROAT("Throat & Neck", "घाँटी र घाँटी", "घाँटी और घाँटी"),
    BODY_ARMS("Arms & Shoulders", "हातहरू र काँधहरू", "हातहरू और काँधहरू"),
    BODY_CHEST("Chest & Heart", "छाती र मुटु", "छाती और मुटु"),
    BODY_STOMACH("Stomach & Digestion", "पेट र पाचन", "पेट और पाचन"),
    BODY_INTESTINES("Intestines", "आन्द्राहरू", "आन्द्राहरू"),
    BODY_LOWER_ABDOMEN("Lower Abdomen", "तल्लो पेट", "तल्लो पेट"),
    BODY_REPRODUCTIVE("Reproductive System", "प्रजनन प्रणाली", "प्रजनन प्रणाली"),
    BODY_THIGHS("Thighs", "थाईहरू", "थाईहरू"),
    BODY_KNEES("Knees", "घुँडाहरू", "घुँडाहरू"),
    BODY_ANKLES("Ankles & Calves", "गोलीगाँठाहरू र पिँडौलाहरू", "गोलीगाँठाहरू और पिँडौलाहरू"),
    BODY_FEET("Feet", "खुट्टाहरू", "खुट्टाहरू"),
    
    // Health Vulnerabilities
    VULNERABILITIES_TITLE("Health Vulnerabilities", "स्वास्थ्य कमजोरीहरू", "स्वास्थ्य कमजोरीहरू"),
    ...
    // Health Strengths
    HEALTH_STRENGTHS("Health Strengths", "स्वास्थ्य शक्तिहरू", "स्वास्थ्य शक्तिहरू"),
    ROBUST_AREAS("Robust Health Areas", "बलियो स्वास्थ्य क्षेत्रहरू", "बलियो स्वास्थ्य क्षेत्रहरू"),
    
    // Preventive Focus
    PRIORITY_AREAS("Priority Focus Areas", "प्राथमिकता फोकस क्षेत्रहरू", "प्राथमिकता फोकस क्षेत्रहरू"),
    SEASONAL_GUIDELINES("Seasonal Health Guidelines", "मौसमी स्वास्थ्य दिशानिर्देशहरू", "मौसमी स्वास्थ्य दिशानिर्देशहरू"),
    YOGA_PRACTICES("Yoga Practices", "योग अभ्यासहरू", "योग अभ्यासहरू"),
    AYURVEDIC_RECS("Ayurvedic Recommendations", "आयुर्वेदिक सिफारिसहरू", "आयुर्वेदिक सिफारिसहरू"),
    ...
    HEALTH_CONCERN_AREAS("Health Concern Areas", "स्वास्थ्य चिन्ता क्षेत्रहरू", "स्वास्थ्य चिन्ता क्षेत्रहरू"),
    ...
    LONGEVITY_SHORT("Short Lifespan Indicators", "छोटो आयु सूचकहरू", "छोटो आयु सूचकहरू"),
    LONGEVITY_MEDIUM("Medium Lifespan Indicators", "मध्यम आयु सूचकहरू", "मध्यम आयु सूचकहरू"),
    LONGEVITY_LONG("Long Lifespan Indicators", "लामो आयु सूचकहरू", "लामो आयु सूचकहरू"),
    SUPPORTING_FACTORS("Supporting Longevity Factors", "दीर्घायु समर्थन कारकहरू", "दीर्घायु समर्थन कारकहरू"),
    CHALLENGING_FACTORS("Challenging Factors", "चुनौतीपूर्ण कारकहरू", "चुनौतीपूर्ण कारकहरू"),
