...
enum class StringKeyDeepCharacter(override val en: String, override val ne: String, override val hi: String) : StringKeyInterface {
    ...
    SECTION_MOON_ANALYSIS("Moon Analysis", "चन्द्रमा विश्लेषण", "चन्द्रमा विश्लेषण"),
    ...
    SECTION_PERSONALITY_YOGAS("Personality Yogas", "व्यक्तित्व योगहरू", "व्यक्तित्व योग"),
    ...
    ASC_TAURUS_DESC("Steady, sensual, materially focused personality", "स्थिर, संवेदी, भौतिक रूपमा केन्द्रित व्यक्तित्व", "स्थिर, संवेदी, भौतिक रूपमा केन्द्रित व्यक्तित्व"),
    ASC_GEMINI_TITLE("Gemini Rising", "मिथुन लग्न", "मिथुन लग्न"),
    ASC_GEMINI_DESC("Curious, communicative, mentally agile personality", "जिज्ञासु, सञ्चारी, मानसिक रूपमा चुस्त व्यक्तित्व", "जिज्ञासु, सञ्चारी, मानसिक रूपमा चुस्त व्यक्तित्व"),
    ASC_CANCER_TITLE("Cancer Rising", "कर्कट लग्न", "कर्कट लग्न"),
    ASC_CANCER_DESC("Nurturing, emotional, family-oriented personality", "पालनपोषण गर्ने, भावनात्मक, परिवार-उन्मुख व्यक्तित्व", "पालनपोषण गर्ने, भावनात्मक, परिवार-उन्मुख व्यक्तित्व"),
    ...
    ASC_PISCES_DESC("Intuitive, compassionate, spiritually inclined personality", "अन्तर्ज्ञानी, दयालु, आध्यात्मिक रूपमा झुकाव भएको व्यक्तित्व", "अन्तर्ज्ञानी, दयालु, आध्यात्मिक रूपमा झुकाव भएको व्यक्तित्व"),

    // Physical Appearance
    APPEARANCE_TITLE("Physical Appearance", "शारीरिक रूप", "शारीरिक रूप"),
    APPEARANCE_BODY_TYPE("Body Type", "शरीर प्रकार", "शरीर प्रकार"),
    APPEARANCE_FACE("Facial Features", "अनुहार विशेषताहरू", "अनुहार विशेषताहरू"),
    APPEARANCE_COMPLEXION("Complexion", "रंग", "रंग"),
    APPEARANCE_OVERALL("Overall Appearance", "समग्र रूप", "समग्र रूप"),
    
    // First Impression
    FIRST_IMPRESSION_TITLE("First Impression", "पहिलो छाप", "पहिलो छाप"),
    FIRST_IMPRESSION_POSITIVE("Positive First Impression", "सकारात्मक पहिलो छाप", "सकारात्मक पहिलो छाप"),
    FIRST_IMPRESSION_NEUTRAL("Neutral First Impression", "तटस्थ पहिलो छाप", "तटस्थ पहिलो छाप"),
    ...
    // Moon Signs
    MOON_ARIES("Moon in Aries", "मेषमा चन्द्रमा", "मेषमा चन्द्रमा"),
    MOON_TAURUS("Moon in Taurus", "वृषमा चन्द्रमा", "वृषमा चन्द्रमा"),
    MOON_GEMINI("Moon in Gemini", "मिथुनमा चन्द्रमा", "मिथुनमा चन्द्रमा"),
    MOON_CANCER("Moon in Cancer", "कर्कटमा चन्द्रमा", "कर्कटमा चन्द्रमा"),
    MOON_LEO("Moon in Leo", "सिंहमा चन्द्रमा", "सिंहमा चन्द्रमा"),
    MOON_VIRGO("Moon in Virgo", "कन्यामा चन्द्रमा", "कन्यामा चन्द्रमा"),
    MOON_LIBRA("Moon in Libra", "तुलामा चन्द्रमा", "तुलामा चन्द्रमा"),
    MOON_SCORPIO("Moon in Scorpio", "वृश्चिकमा चन्द्रमा", "वृश्चिकमा चन्द्रमा"),
    MOON_SAGITTARIUS("Moon in Sagittarius", "धनुमा चन्द्रमा", "धनुमा चन्द्रमा"),
    MOON_CAPRICORN("Moon in Capricorn", "मकरमा चन्द्रमा", "मकरमा चन्द्रमा"),
    MOON_AQUARIUS("Moon in Aquarius", "कुम्भमा चन्द्रमा", "कुम्भमा चन्द्रमा"),
    MOON_PISCES("Moon in Pisces", "मीनमा चन्द्रमा", "मीनमा चन्द्रमा"),
    ...
    EMOTIONAL_TRIGGERS("Emotional Triggers", "भावनात्मक ट्रिगरहरू", "भावनात्मक ट्रिगरहरू"),
    EMOTIONAL_STRENGTHS("Emotional Strengths", "भावनात्मक शक्तिहरू", "भावनात्मक शक्तिहरू"),
    EMOTIONAL_CHALLENGES("Emotional Challenges", "भावनात्मक चुनौतीहरू", "भावनात्मक चुनौतियां"),
    ...
    // Inner Needs
    INNER_NEEDS_TITLE("Inner Needs", "आन्तरिक आवश्यकताहरू", "आन्तरिक आवश्यकताहरू"),
    NEED_SECURITY("Need for Security", "सुरक्षाको आवश्यकता", "सुरक्षाको आवश्यकता"),
    NEED_RECOGNITION("Need for Recognition", "मान्यताको आवश्यकता", "मान्यताको आवश्यकता"),
    NEED_CONNECTION("Need for Connection", "सम्बन्धको आवश्यकता", "संबंधको आवश्यकता"),
    NEED_FREEDOM("Need for Freedom", "स्वतन्त्रताको आवश्यकता", "स्वतन्त्रताको आवश्यकता"),
    
    // Stress Response
    STRESS_RESPONSE_TITLE("Stress Response", "तनाव प्रतिक्रिया", "तनाव प्रतिक्रिया"),
    STRESS_COPING("Coping Mechanisms", "सामना गर्ने तंत्रहरू", "सामना गर्ने तंत्रहरू"),
    STRESS_TRIGGERS("Stress Triggers", "तनाव ट्रिगरहरू", "तनाव ट्रिगरहरू"),
    
    // Family Relationships
    MOTHER_RELATIONSHIP("Relationship with Mother", "आमासँगको सम्बन्ध", "आमासँगको संबंध"),
    FATHER_RELATIONSHIP("Relationship with Father", "बुबासँगको सम्बन्ध", "बुबासँगको संबंध"),
    ...
    ATMAKARAKA_SOUL_DESIRE("Soul's Desire", "आत्माको इच्छा", "आत्माको इच्छा"),
    ...
    INTELLECT_STRENGTHS("Intellectual Strengths", "बौद्धिक शक्तिहरू", "बौद्धिक शक्तिहरू"),
    INTELLECT_CHALLENGES("Intellectual Challenges", "बौद्धिक चुनौतीहरू", "बौद्धिक चुनौतियां"),
    ...
    SOCIAL_STRENGTHS("Social Strengths", "सामाजिक शक्तिहरू", "सामाजिक शक्तिहरू"),
    SOCIAL_CHALLENGES("Social Challenges", "सामाजिक चुनौतीहरू", "सामाजिक चुनौतियां"),
    
    // Planetary Influences
    PLANET_INFLUENCE_TITLE("Planetary Personality Influences", "ग्रहीय व्यक्तित्व प्रभावहरू", "ग्रहीय व्यक्तित्व प्रभाव"),
    STRONG_PLANET_INFLUENCE("Strong Planet Influence", "बलियो ग्रह प्रभाव", "बलियो ग्रह प्रभाव"),
    ...
    // Personality Yogas
    YOGA_PERSONALITY_TITLE("Personality Yogas", "व्यक्तित्व योगहरू", "व्यक्तित्व योग"),
    YOGA_EFFECT("Yoga Effect", "योग प्रभाव", "योग प्रभाव"),
    ...
    KEY_TRAITS("Key Personality Traits", "मुख्य व्यक्तित्व गुणहरू", "मुख्य व्यक्तित्व गुणहरू"),
