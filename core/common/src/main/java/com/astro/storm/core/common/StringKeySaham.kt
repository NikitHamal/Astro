...
enum class StringKeySaham(override val en: String, override val ne: String, override val hi: String) : StringKeyInterface {
    ...
    SUBTITLE("Sensitive points calculated from planetary positions", "ग्रह स्थितिबाट गणना गरिएको संवेदनशील बिन्दुहरू", "ग्रह स्थितिबाट गणना गरिएको संवेदनशील बिन्दुहरू"),
    ...
    FORMULA_ADJUSTED("Formula Adjusted", "सूत्र समायोजित", "सूत्र समायोजित"),

    // ============================================
    // OVERVIEW TAB
    // ============================================
    TAB_OVERVIEW("Overview", "अवलोकन", "अवलोकन"),
    TAB_ALL_SAHAMS("All Sahams", "सबै सहमहरू", "सबै सहमहरू"),
    ...
    ACTIVE_SAHAMS_TODAY("Active Sahams today", "आज सक्रिय सहमहरू", "आज सक्रिय सहमहरू"),
    TOTAL_SAHAMS("Total Sahams", "कुल सहमहरू", "कुल सहमहरू"),
    AVERAGE_STRENGTH("Average Strength", "औसत बल", "औसत बल"),

    // ============================================
    // SEARCH & FILTER
    // ============================================
    SEARCH_SAHAMS("Search Sahams...", "सहमहरू खोज्नुहोस्...", "सहमहरू खोजें..."),
    FILTER_ALL("All", "सबै", "सबै"),
    ...
    SAHAM_SPIRIT("Part of Spirit", "आत्मा सहम", "आत्मा सहम"),
    ...
    CATEGORY_OTHER("Other Areas", "अन्य क्षेत्रहरू", "अन्य क्षेत्रहरू"),

    // ============================================
    // INFO DIALOG
    // ============================================
    INFO_TITLE("About Sahams", "सहमहरूको बारेमा", "सहमहरूको बारेमा"),
    INFO_DESCRIPTION("Sahams (Arabic Parts) are sensitive points calculated from the positions of planets, Ascendant, and house cusps. They reveal specific life themes and their activation periods.", "सहमहरू (अरबी भाग) ग्रहको स्थिति, लग्न र भाव सन्धिबाट गणना गरिएको संवेदनशील बिन्दुहरू हुन्। तिनीहरूले विशिष्ट जीवन विषयहरू र तिनीहरूको सक्रियता अवधिहरू प्रकट गर्छन्।", "सहमहरू (अरबी भाग) ग्रहको स्थिति, लग्न और भाव सन्धिबाट गणना गरिएको संवेदनशील बिन्दुहरू हुन्। तिनीहरूले विशिष्ट जीवन विषयहरू और तिनीहरूको सक्रियता अवधिहरू प्रकट गर्छन्।"),
    INFO_DAY_NIGHT("Day/Night Charts: The formula for many Sahams reverses between day and night births. Day births have the Sun above the horizon, night births have it below.", "दिवा/रात्रि कुण्डली: धेरै सहमहरूको सूत्र दिवा र रात्रि जन्ममा उल्टो हुन्छ। दिवा जन्ममा सूर्य क्षितिज माथि हुन्छ, रात्रि जन्ममा तल हुन्छ।", "दिवा/रात्रि कुंडली: धेरै सहमहरूको सूत्र दिवा और रात्रि जन्ममा उल्टो हुन्छ। दिवा जन्ममा सूर्य क्षितिज माथि हुन्छ, रात्रि जन्ममा तल हुन्छ।"),
    INFO_ACTIVATION("Activation: A Saham is considered active when transiting planets conjunct or aspect it, or during relevant Dasha periods.", "सक्रियता: गोचर ग्रहले युति वा दृष्टि गर्दा, वा सान्दर्भिक दशा अवधिमा सहम सक्रिय मानिन्छ।", "सक्रियता: गोचर ग्रहले युति या दृष्टि गर्दा, या सान्दर्भिक दशा अवधिमा सहम सक्रिय मानिन्छ।"),
    INFO_FORMULA("Formula: Most Sahams follow the pattern: Asc + Planet A - Planet B. For night charts, planets A and B may swap positions.", "सूत्र: धेरैजसो सहमहरू यो ढाँचा पछ्याउँछन्: लग्न + ग्रह A - ग्रह B। रात्रि कुण्डलीमा, ग्रह A र B को स्थान बदलिन सक्छ।", "सूत्र: धेरैजसो सहमहरू यो ढाँचा पछ्याउँछन्: लग्न + ग्रह A - ग्रह B। रात्रि कुंडलीमा, ग्रह A और B को स्थान बदलिन सक्छ।"),

    // ============================================
    // STATES
    // ============================================
    NO_CHART_SELECTED("No Chart Selected", "कुनै कुण्डली छानिएको छैन", "कुनै कुंडली छानिएको छैन"),
    SELECT_CHART_MESSAGE("Please select a birth chart to view Sahams", "सहमहरू हेर्न कृपया जन्म कुण्डली छान्नुहोस्", "सहमहरू हेर्न कृपया जन्म कुंडली चुनें"),
    CALCULATING("Calculating Sahams...", "सहमहरू गणना गर्दै...", "सहमहरू गणना गर्दै..."),
    ...
    FORMULA_ADJUSTED_DESC("Formulas adjusted per Tajika tradition", "ताजिक परम्परा अनुसार सूत्रहरू समायोजित", "ताजिक परम्परा अनुसार सूत्रहरू समायोजित"),
    STRONGEST("Strongest", "सबैभन्दा बलियो", "सबैभन्दा बलियो"),
