...
SHOOLA_DIRECTION("Dasha Direction", "दशा दिशा"),
    SHOOLA_DIRECT("Direct (Zodiacal)", "Direct (Zodiacal)"),
    SHOOLA_REVERSE("Reverse (Anti-zodiacal)", "Reverse (Anti-zodiacal)"),
...
SHOOLA_CHALLENGING_FACTORS("Challenging Factors", "चुनौतीपूर्ण कारकहरू"),
    SHOOLA_BALARISHTA("Balarishta (0-8 years)", "Balarishta (0-8 years)"),
    SHOOLA_ALPAYU("Alpayu - Short (8-32 years)", "Alpayu - Short (8-32 years)"),
    SHOOLA_MADHYAYU("Madhyayu - Medium (32-70 years)", "Madhyayu - Medium (32-70 years)"),
    SHOOLA_POORNAYU("Poornayu - Full (70-100 years)", "Poornayu - Full (70-100 years)"),
    SHOOLA_AMITAYU("Amitayu - Extended (100+ years)", "Amitayu - Extended (100+ years)"),
...
KAKSHYA_QUALITY_POOR("Poor", "कमजोर"),
    KAKSHYA_DESC("Precise micro-transit timing using 8 divisions per sign (3°45' each)", "Precise micro-transit timing using 8 divisions per sign (3°45' each)"),
...
ASHTAVARGA_BAV_SCORE("BAV Score", "भिन्नाष्टकवर्ग स्कोर"),
    ASHTAVARGA_HIGH_BINDU("High Bindu (30+)", "High Bindu (30+)"),
    ASHTAVARGA_MEDIUM_BINDU("Medium Bindu (25-30)", "Medium Bindu (25-30)"),
    ASHTAVARGA_LOW_BINDU("Low Bindu (<25)", "Low Bindu (<25)"),
...
ASHTAVARGA_TRANSIT_STRENGTH("Transit Strength", "गोचर बल"),
    ASHTAVARGA_VERY_STRONG("Very Strong (30+ SAV)", "Very Strong (30+ SAV)"),
    ASHTAVARGA_STRONG("Strong (26-30 SAV)", "Strong (26-30 SAV)"),
    ASHTAVARGA_AVERAGE("Average (22-25 SAV)", "Average (22-25 SAV)"),
    ASHTAVARGA_WEAK("Weak (<22 SAV)", "Weak (<22 SAV)"),
...
ASHTAVARGA_EKADHIPATYA_REDUCTION("Ekadhipatya Reduction", "एकाधिपत्य घटाउ"),
    ASHTAVARGA_REDUCED_SAV("Reduced SAV (Shodya Pinda)", "Reduced SAV (Shodya Pinda)"),
ASHTAVARGA_TRANSIT_INFO_TITLE("About Ashtavarga Transit", "अष्टकवर्ग गोचरको बारेमा"),
    ASHTAVARGA_TRANSIT_INFO_DESC("Ashtavarga Transit Predictions use the bindu contribution from each planet to predict transit intensity. High SAV scores (30+)", "Ashtavarga Transit Predictions use the bindu contribution from each planet to predict transit intensity. High SAV scores (30+)"),
...
ASHTAVARGA_TRANSIT_UNABLE("Unable to calculate Ashtavarga transits", "अष्टकवर्ग गोचर गणना गर्न सकिएन"),
    NADI_TITLE("Nadi Amsha (D-150)", "Nadi Amsha (D-150)"),
...
NADI_DEGREE("Nadi Degree", "नाडी डिग्री"),
    NADI_NUMBER("Nadi Number (1-150)", "Nadi Number (1-150)"),
...
NADI_INFO_TITLE("About Nadi Amsha", "नाडी अंशको बारेमा"),
    NADI_INFO_DESC("Nadi Amsha (D-150)", "Nadi Amsha (D-150)"),
...
PRASHNA_ARUDHA_CALCULATION("Arudha Calculation", "आरूढ गणना"),
    PRASHNA_ITTHASALA("Itthasala (Application)", "Itthasala (Application)"),
...
PRASHNA_INFO_TITLE("About Enhanced Prashna", "उन्नत प्रश्नको बारेमा"),
    PRASHNA_INFO_DESC("Enhanced Prashna (Horary)", "Enhanced Prashna (Horary)"),
