...
enum class StringKeyAshtavarga(override val en: String, override val ne: String, override val hi: String) : StringKeyInterface {
    ...
    ,
    TOTAL_BINDUS("%d Total Bindus", "%d कुल बिन्दुहरू", "%d कुल बिन्दु"),
    ,
    TRANSIT_IN_SIGN("in %s", "%s मा", "%s में"),
    ,
    ...
    ,
    AFFECTED_AREAS_TITLE("Affected Life Areas", "प्रभावित जीवन क्षेत्रहरू", "प्रभावित जीवन क्षेत्र"),
    ,
    NEXT_SIGNIFICANT_TITLE("Next Significant Transit", "अर्को महत्त्वपूर्ण गोचर", "अर् के महत्त्वपूर्ण गोचर"),
,
}
