...
enum class StringKeyDeepPrediction(override val en: String, override val ne: String, override val hi: String) : StringKeyInterface {
    // Section Headers
    SECTION_PREDICTIONS("Deep Predictions", "गहन भविष्यवाणीहरू", "गहन भविष्यवाणीहरू"),
    ...
    SECTION_MONTHLY("Monthly Predictions", "मासिक भविष्यवाणीहरू", "मासिक भविष्यवाणीहरू"),
    SECTION_LIFE_AREAS("Life Area Predictions", "जीवन क्षेत्र भविष्यवाणीहरू", "जीवन क्षेत्र भविष्यवाणीहरू"),
    SECTION_YOGA_ACTIVATION("Yoga Activation Timeline", "योग सक्रियता समयरेखा", "योग सक्रियता समयरेखा"),
    SECTION_CRITICAL("Critical Periods", "महत्वपूर्ण अवधिहरू", "महत्वपूर्ण अवधिहरू"),
    SECTION_OPPORTUNITIES("Opportunity Windows", "अवसर सञ्झ्यालहरू", "अवसर सञ्झ्यालहरू"),
    ...
    MAHADASHA_STRENGTHS("Period Strengths", "अवधि शक्तिहरू", "अवधि शक्तिहरू"),
    MAHADASHA_CHALLENGES("Period Challenges", "अवधि चुनौतीहरू", "अवधि चुनौतियां"),
    ...
    ANTARDASHA_EFFECTS("Short-Term Effects", "छोटो-अवधि प्रभावहरू", "छोटो-अवधि प्रभाव"),
    ACTIVATED_YOGAS("Activated Yogas", "सक्रिय योगहरू", "सक्रिय योग"),
    
    // Upcoming Dashas
    UPCOMING_DASHAS("Upcoming Dasha Periods", "आगामी दशा अवधिहरू", "आगामी दशा अवधिहरू"),
    ...
    DASHA_MOON("Moon Dasha Theme", "चन्द्रमा दशा विषय", "चन्द्रमा दशा विषय"),
    ...
    // Transits
    MAJOR_TRANSITS("Major Transits", "प्रमुख गोचरहरू", "प्रमुख गोचरहरू"),
    ...
    SADE_SATI_REMEDIES("Sade Sati Remedies", "साढे साती उपचारहरू", "साढे साती उपचारहरू"),
    
    // Jupiter Transit
    JUPITER_TRANSIT_HOUSE("Jupiter Transit House", "बृहस्पति गोचर भाव", "बृहस्पति गोचर भाव"),
    JUPITER_FAVORABLE_AREAS("Jupiter Favorable Areas", "बृहस्पति अनुकूल क्षेत्रहरू", "बृहस्पति अनुकूल क्षेत्रहरू"),
    ...
    KEY_MONTHS("Key Months", "मुख्य महिनाहरू", "मुख्य महिनाहरू"),
    ...
    FOCUS_AREAS("Focus Areas", "फोकस क्षेत्रहरू", "फोकस क्षेत्रहरू"),
    FAVORABLE_DATES("Favorable Dates", "अनुकूल मितिहरू", "अनुकूल मितिहरू"),
    CHALLENGING_DATES("Challenging Dates", "चुनौतीपूर्ण मितिहरू", "चुनौतीपूर्ण मितिहरू"),
    
    // Life Area Predictions
    LIFE_AREA_TITLE("Life Area Predictions", "जीवन क्षेत्र भविष्यवाणीहरू", "जीवन क्षेत्र भविष्यवाणीहरू"),
    AREA_GENERAL("General Life", "सामान्य जीवन", "सामान्य जीवन"),
    AREA_CAREER("Career", "क्यारियर", "करियर"),
    AREA_RELATIONSHIP("Relationships", "सम्बन्धहरू", "संबंधहरू"),
    ...
    SHORT_TERM("Short Term Outlook", "छोटो अवधि दृष्टिकोण", "छोटो अवधि दृष्टिकोण"),
    ...
    // Yoga Activation
    YOGA_ACTIVATION_TITLE("Yoga Activation Events", "योग सक्रियता घटनाहरू", "योग सक्रियता घटनाहरू"),
    ACTIVATION_PERIOD("Activation Period", "सक्रियता अवधि", "सक्रियता अवधि"),
    EXPECTED_RESULTS("Expected Results", "अपेक्षित परिणामहरू", "अपेक्षित परिणामहरू"),
    ACTIVATION_STRENGTH("Activation Strength", "सक्रियता शक्ति", "सक्रियता शक्ति"),
    
    // Critical Periods
    CRITICAL_TITLE("Critical Periods", "महत्वपूर्ण अवधिहरू", "महत्वपूर्ण अवधिहरू"),
    ...
    // Opportunity Windows
    OPPORTUNITY_TITLE("Opportunity Windows", "अवसर सञ्झ्यालहरू", "अवसर सञ्झ्यालहरू"),
    OPPORTUNITY_NAME("Window Name", "सञ्झ्याल नाम", "सञ्झ्याल नाम"),
    OPPORTUNITY_DURATION("Duration", "अवधि", "अवधि"),
    AFFECTED_AREAS("Affected Areas", "प्रभावित क्षेत्रहरू", "प्रभावित क्षेत्रहरू"),
    OPPORTUNITY_TYPE("Opportunity Type", "अवसर प्रकार", "अवसर प्रकार"),
    OPPORTUNITY_ADVICE("How to Maximize", "अधिकतम कसरी गर्ने", "अधिकतम कसरी गर्ने"),
    
    // Remedial Measures
    REMEDIES_TITLE("Remedial Measures", "उपचारात्मक उपायहरू", "उपचारात्मक उपाय"),
    GEMSTONE_REMEDIES("Gemstone Remedies", "रत्न उपचारहरू", "रत्न उपचारहरू"),
    ...
    WEARING_GUIDELINES("Wearing Guidelines", "लगाउने दिशानिर्देशहरू", "लगाउने दिशानिर्देशहरू"),
    GEMSTONE_CAUTIONS("Cautions", "सावधानीहरू", "सावधानीहरू"),
    
    // Mantra Remedies
    MANTRA_REMEDIES("Mantra Remedies", "मन्त्र उपचारहरू", "मन्त्र उपचारहरू"),
    ...
    // Charitable Remedies
    CHARITABLE_REMEDIES("Charitable Remedies", "दान उपचारहरू", "दान उपचारहरू"),
    DONATION_ITEMS("Donation Items", "दान वस्तुहरू", "दान वस्तुहरू"),
    BEST_DAY("Best Day", "सर्वोत्तम दिन", "सर्वोत्तम दिन"),
    DONATION_GUIDELINES("Guidelines", "दिशानिर्देशहरू", "दिशानिर्देशहरू"),
    
    // Fasting Remedies
    FASTING_REMEDIES("Fasting Remedies", "उपवास उपचारहरू", "उपवास उपचारहरू"),
    FASTING_DAY("Fasting Day", "उपवास दिन", "उपवास दिन"),
    FASTING_TYPE("Fasting Type", "उपवास प्रकार", "उपवास प्रकार"),
    FASTING_GUIDELINES("Fasting Guidelines", "उपवास दिशानिर्देशहरू", "उपवास दिशानिर्देशहरू"),
    
    // Yogic Remedies
    YOGIC_REMEDIES("Yogic Remedies", "योगिक उपचारहरू", "योगिक उपचारहरू"),
    PRACTICE_NAME("Practice Name", "अभ्यास नाम", "अभ्यास नाम"),
    TARGET_PLANET("For Planet", "ग्रहको लागि", "ग्रहको लिए"),
    PRACTICE_GUIDELINES("Guidelines", "दिशानिर्देशहरू", "दिशानिर्देशहरू"),
    PRACTICE_BENEFITS("Benefits", "फाइदाहरू", "फाइदाहरू"),
