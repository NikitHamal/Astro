...
enum class StringKeyShadbala(override val en: String, override val ne: String, override val hi: String) : StringKeyInterface {
    ...
    SARVATOBHADRA_DESC("Traditional Vedha chakra for transit analysis, muhurta selection, and name compatibility", "गोचर विश्लेषण, मुहूर्त चयन, र नाम अनुकूलताको लागि परम्परागत वेध चक्र", "गोचर विश्लेषण, मुहूर्त चयन, और नाम अनुकूलताको लिए परम्परागत वेध चक्र"),
    ...
    SARVATOBHADRA_TAB_VEDHA("Vedhas", "वेधहरू", "वेधहरू"),
    ...
    SARVATOBHADRA_NO_VEDHA("No Vedha", "वेध छैन", "वेध छैन"),
    ...
    SARVATOBHADRA_CURRENT_TRANSITS("Current Transit Vedhas", "वर्तमान गोचर वेधहरू", "वर्तमान गोचर वेधहरू"),
    SARVATOBHADRA_TRANSIT_SCORE("Transit Score", "गोचर स्कोर", "गोचर स्कोर"),
    SARVATOBHADRA_FAVORABLE_DAYS("Favorable Days", "अनुकूल दिनहरू", "अनुकूल दिनहरू"),
    SARVATOBHADRA_UNFAVORABLE_DAYS("Unfavorable Days", "प्रतिकूल दिनहरू", "प्रतिकूल दिनहरू"),
    SARVATOBHADRA_OVERALL_SCORE("Overall Score", "समग्र स्कोर", "समग्र स्कोर"),

    // Daily Analysis
    SARVATOBHADRA_TODAY("Today's Analysis", "आजको विश्लेषण", "आजको विश्लेषण"),
    ...
    SARVATOBHADRA_DAY_QUALITY("Day Quality", "दिनको गुणस्तर", "दिनको गुणस्तर"),
    SARVATOBHADRA_FAVORABLE_ACTIVITIES("Favorable Activities", "अनुकूल कार्यहरू", "अनुकूल कार्यहरू"),
    ...
    // Info
    SARVATOBHADRA_INFO_TITLE("About Sarvatobhadra Chakra", "सर्वतोभद्र चक्रको बारेमा", "सर्वतोभद्र चक्रको बारेमा"),
    SARVATOBHADRA_INFO_DESC("Sarvatobhadra Chakra is a 9×9 grid showing relationships between nakshatras, vowels, weekdays, and tithis. It's used for transit analysis, muhurta selection, and name compatibility through vedha (obstruction) calculations.", "सर्वतोभद्र चक्र नक्षत्र, स्वर, वार, र तिथिहरू बीचको सम्बन्ध देखाउने ९×९ ग्रिड हो। यो वेध (अवरोध) गणनाहरू मार्फत गोचर विश्लेषण, मुहूर्त चयन, र नाम अनुकूलताको लागि प्रयोग गरिन्छ।", "सर्वतोभद्र चक्र नक्षत्र, स्वर, वार, और तिथिहरू बीचको संबंध देखाउने ९×९ ग्रिड हो। यो वेध (अवरोध) गणनाहरू मार्फत गोचर विश्लेषण, मुहूर्त चयन, और नाम अनुकूलताको लिए प्रयोग गरिन्छ।"),
    ...
    SARVATOBHADRA_UNABLE("Unable to calculate Sarvatobhadra", "सर्वतोभद्र गणना गर्न सकिएन", "सर्वतोभद्र गणना गर्न सकिएन"),
    ...
    DRIG_DESC("Shadbala component measuring strength from planetary aspects", "ग्रह दृष्टिबाट बल मापन गर्ने षड्बल घटक", "ग्रह दृष्टिबाट बल मापन गर्ने षड्बल घटक"),
    ...
    DRIG_ASPECT_TO("Aspect To", "मा दृष्टि", "मा दृष्टि"),
    ...
    DRIG_PLANET_CASTING("Aspects Cast", "दिइएको दृष्टि", "दिइएको दृष्टि"),
    DRIG_VIRUPAS("Virupas", "विरूपा", "विरूपा"),
    DRIG_POSITIVE("Positive", "सकारात्मक", "सकारात्मक"),
    DRIG_NEGATIVE("Negative", "नकारात्मक", "नकारात्मक"),

    // Info
    DRIG_INFO_TITLE("About Drig Bala", "दृग्बलको बारेमा", "दृग्बलको बारेमा"),
    DRIG_INFO_DESC("Drig Bala measures aspectual strength - the positive or negative influence from planetary aspects. Benefic aspects add strength while malefic aspects reduce it. Net Drig Bala determines overall aspectual support.", "दृग्बलले दृष्टि बल मापन गर्छ - ग्रह दृष्टिबाट सकारात्मक वा नकारात्मक प्रभाव। शुभ दृष्टिले बल थप्छ जबकि अशुभ दृष्टिले घटाउँछ। शुद्ध दृग्बलले समग्र दृष्टि समर्थन निर्धारण गर्छ।", "दृग्बलले दृष्टि बल मापन गर्छ - ग्रह दृष्टिबाट सकारात्मक या नकारात्मक प्रभाव। शुभ दृष्टिले बल थप्छ जबकि अशुभ दृष्टिले घटाउँछ। शुद्ध दृग्बलले समग्र दृष्टि समर्थन निर्धारण गर्छ।"),
    DRIG_VEDIC_REF("Vedic Reference: BPHS Shadbala chapter, Graha Sutras", "वैदिक सन्दर्भ: बृहत् पाराशर होरा शास्त्र षड्बल अध्याय, ग्रह सूत्र", "वैदिक सन्दर्भ: बृहत् पाराशर होरा शास्त्र षड्बल अध्याय, ग्रह सूत्र"),
    DRIG_ANALYZING("Analyzing Drig Bala...", "दृग्बल विश्लेषण गर्दै...", "दृग्बल विश्लेषण गर्दै..."),
    DRIG_UNABLE("Unable to calculate Drig Bala", "दृग्बल गणना गर्न सकिएन", "दृग्बल गणना गर्न सकिएन"),
    ...
    STHANA_DESC("Shadbala component measuring strength from sign, house, and dignity placement", "राशि, भाव, र गरिमा स्थानबाट बल मापन गर्ने षड्बल घटक", "राशि, भाव, और गरिमा स्थानबाट बल मापन गर्ने षड्बल घटक"),

    // Tabs
    STHANA_TAB_OVERVIEW("Overview", "सिंहावलोकन", "अवलोकन"),
    STHANA_TAB_COMPONENTS("Components", "घटकहरू", "घटकहरू"),
    ...
    STHANA_STRONG("Strong", "बलियो", "बलियो"),
    STHANA_WEAK("Weak", "कमजोर", "कमजोर"),
    STHANA_AVERAGE("Average", "औसत", "औसत"),

    // Info
    STHANA_INFO_TITLE("About Sthana Bala", "स्थानबलको बारेमा", "स्थानबलको बारेमा"),
    STHANA_INFO_DESC("Sthana Bala measures positional strength through 5 components: Uccha (exaltation), Saptavargaja (7 vargas), Ojhayugma (odd/even), Kendradi (angular), and Drekkana (decanate). It forms a major portion of Shadbala.", "स्थानबलले ५ घटकहरू मार्फत स्थानगत बल मापन गर्छ: उच्च, सप्तवर्गज, ओज्हयुग्म, केन्द्रादि, र द्रेक्काण। यसले षड्बलको प्रमुख भाग बनाउँछ।", "स्थानबलले ५ घटकहरू मार्फत स्थानगत बल मापन गर्छ: उच्च, सप्तवर्गज, ओज्हयुग्म, केन्द्रादि, और द्रेक्काण। यह षड्बलको प्रमुख भाग बनाउँछ।"),
    STHANA_VEDIC_REF("Vedic Reference: BPHS Chapter 27, Graha Sutras", "वैदिक सन्दर्भ: बृहत् पाराशर होरा शास्त्र अध्याय २७, ग्रह सूत्र", "वैदिक सन्दर्भ: बृहत् पाराशर होरा शास्त्र अध्याय २७, ग्रह सूत्र"),
    STHANA_ANALYZING("Analyzing Sthana Bala...", "स्थानबल विश्लेषण गर्दै...", "स्थानबल विश्लेषण गर्दै..."),
    STHANA_UNABLE("Unable to calculate Sthana Bala", "स्थानबल गणना गर्न सकिएन", "स्थानबल गणना गर्न सकिएन"),
    ...
    KALA_DESC("Shadbala component measuring strength from time factors", "समय कारकहरूबाट बल मापन गर्ने षड्बल घटक", "समय कारकहरूबाट बल मापन गर्ने षड्बल घटक"),

    // Tabs
    KALA_TAB_OVERVIEW("Overview", "सिंहावलोकन", "अवलोकन"),
    KALA_TAB_COMPONENTS("Components", "घटकहरू", "घटकहरू"),
    ...
    // Info
    KALA_INFO_TITLE("About Kala Bala", "कालबलको बारेमा", "कालबलको बारेमा"),
    KALA_INFO_DESC("Kala Bala measures temporal strength through 9 components related to time of birth, lunar phase, day/night, seasons, and planetary wars. It reflects how time supports each planet's strength.", "कालबलले जन्म समय, चन्द्र चरण, दिन/रात, ऋतु, र ग्रह युद्धसँग सम्बन्धित ९ घटकहरू मार्फत समयगत बल मापन गर्छ। यसले प्रत्येक ग्रहको बललाई समयले कसरी समर्थन गर्छ भनी प्रतिबिम्बित गर्छ।", "कालबलले जन्म समय, चन्द्र चरण, दिन/रात, ऋतु, और ग्रह युद्धसँग संबंधित ९ घटकहरू मार्फत समयगत बल मापन गर्छ। यह प्रत्येक ग्रहको बल को समयले कसरी समर्थन गर्छ भनी प्रतिबिम्बित गर्छ।"),
    KALA_VEDIC_REF("Vedic Reference: BPHS Chapter 28, Surya Siddhanta", "वैदिक सन्दर्भ: बृहत् पाराशर होरा शास्त्र अध्याय २८, सूर्य सिद्धान्त", "वैदिक सन्दर्भ: बृहत् पाराशर होरा शास्त्र अध्याय २८, सूर्य सिद्धान्त"),
    KALA_ANALYZING("Analyzing Kala Bala...", "कालबल विश्लेषण गर्दै...", "कालबल विश्लेषण गर्दै..."),
    KALA_UNABLE("Unable to calculate Kala Bala", "कालबल गणना गर्न सकिएन", "कालबल गणना गर्न सकिएन"),

    // ============================================
    // SAHAM (ARABIC PARTS) STRINGS
    // ============================================
    SAHAM_TITLE("Saham", "सहम", "सहम"),
    SAHAM_SUBTITLE("Arabic Parts / Lots", "अरबी बिन्दुहरू", "अरबी बिन्दुहरू"),
    SAHAM_DESC("Sensitive points calculated from three chart factors", "तीन चार्ट कारकहरूबाट गणना गरिएका संवेदनशील बिन्दुहरू", "तीन चार्ट कारकहरूबाट गणना गरिएका संवेदनशील बिन्दुहरू"),
    ...
    SAHAM_ASHA_DESC("Hopes/Wishes", "आशा/इच्छा", "आशा/इच्छा"),
    ...
    SAHAM_MATRI_DESC("Mother", "आमा", "आमा"),
    ...
    SAHAM_SARPA_DESC("Serpent/Hidden enemies", "सर्प/लुकेका शत्रु", "सर्प/लुकेका शत्रु"),
    ...
    SAHAM_UNABLE("Unable to calculate Sahams", "सहम गणना गर्न सकिएन", "सहम गणना गर्न सकिएन"),
