...
enum class StringKeyAshtamangala(override val en: String, override val ne: String, override val hi: String) : StringKeyInterface {
    ...
    TAB_POSITIONS("Positions", "स्थितिहरू", "स्थितिहरू"),
    ...
    POS_4_DESC("Southwest - Obstacles, hidden enemies, dissolution", "नैऋत्य - बाधाहरू, लुकेका शत्रु, विघटन", "नैऋत्य - बाधाहरू, लुकेका शत्रु, विघटन"),
    ...
    CAT_HEALTH_DESC("Recovery, illness, vitality queries", "निको हुने, रोग, जीवनी शक्ति प्रश्नहरू", "निको हुने, रोग, जीवनी शक्ति प्रश्नहरू"),
    ...
    CAT_RELATIONSHIP("Relationships", "सम्बन्धहरू", "संबंधहरू"),
    ...
    CAT_CAREER_DESC("Job, business, profession queries", "नोकरी, व्यापार, पेशा प्रश्नहरू", "नोकरी, व्यापार, पेशा प्रश्नहरू"),
    CAT_TRAVEL("Travel & Movement", "यात्रा र गति", "यात्रा और गति"),
    CAT_TRAVEL_DESC("Journeys, relocation, migrations", "यात्राहरू, स्थानान्तरण, बसाइँसराइ", "यात्राहरू, स्थानान्तरण, बसाइँसराइ"),
    CAT_LOST("Lost Objects", "हराएका वस्तुहरू", "हराएका वस्तुहरू"),
    CAT_LOST_DESC("Finding missing items or valuables", "हराएका सामान वा बहुमूल्य वस्तुहरू खोज्ने", "हराएका सामान या बहुमूल्य वस्तुहरू खोज्ने"),
    ...
    COWRIE_INSTRUCTION("Focus on your question and cast the shells", "आफ्नो प्रश्नमा ध्यान केन्द्रित गर्नुहोस् र कौडी फाल्नुहोस्", "अपना प्रश्नमा ध्यान केन्द्रित करें और कौडी फाल्नुहोस्"),
    ...
    COWRIE_TOTAL("Total Shells: 8", "जम्मा कौडी: ८", "जम्मा कौडी: ८"),
    ...
    // POSITION ANALYSIS
    // ============================================
    POS_ACTIVE("Active Positions", "सक्रिय स्थितिहरू", "सक्रिय स्थितिहरू"),
    ...
    POS_EFFECT("Effect on Query", "प्रश्नमा प्रभाव", "प्रश्नमा प्रभाव"),
    ...
    NUM_OPEN_SHELLS("Open Shells", "खुला कौडीहरू", "खुला कौडीहरू"),
    NUM_INTERPRETATION("Shell Interpretation", "कौडी व्याख्या", "कौडी व्याख्या"),
    NUM_0("0 Open - Total denial, delay, not now", "० खुला - पूर्ण अस्वीकार, ढिलाइ, अहिले होइन", "० खुला - पूर्ण अस्वीकार, ढिलाइ, अहिले होइन"),
    NUM_1("1 Open - Weak affirmation, much effort needed", "१ खुला - कमजोर पुष्टि, धेरै प्रयास चाहिन्छ", "१ खुला - कमजोर पुष्टि, धेरै प्रयास चाहिन्छ"),
    NUM_2("2 Open - Partial success, obstacles remain", "२ खुला - आंशिक सफलता, बाधाहरू बाँकी", "२ खुला - आंशिक सफलता, बाधाहरू बाँकी"),
    NUM_3("3 Open - Favorable with conditions", "३ खुला - शर्तहरूसँग अनुकूल", "३ खुला - शर्तहरूसँग अनुकूल"),
    ...
    NUM_6("6 Open - Strong positive indication", "६ खुला - बलियो सकारात्मक संकेत", "६ खुला - बलियो सकारात्मक संकेत"),
    ...
    TIME_SHORT("Short term (1-4 weeks)", "छोटो अवधि (१-४ हप्ता)", "छोटो अवधि (१-४ हप्ता)"),
    ...
    TIME_BEST_DAY("Best Day for Action", "कार्यको लागि उत्तम दिन", "कार्यको लिए उत्तम दिन"),
    TIME_AVOID_DAY("Avoid Acting On", "यो दिनमा नगर्नुहोस्", "यो दिनमा नकरें"),
    ...
    CHART_SUPPORTS("Chart Supports Reading", "कुण्डलीले पठनलाई समर्थन गर्छ", "कुंडलीले पठन को समर्थन गर्छ"),
    CHART_CONFLICTS("Chart Shows Conflict", "कुण्डलीले विरोध देखाउँछ", "कुंडलीले विरोध देखाउँछ"),
    ...
    CHART_MOON_EFFECT("Moon's Position Effect", "चन्द्रमाको स्थिति प्रभाव", "चन्द्रमाको स्थिति प्रभाव"),

    // ============================================
    // REMEDIES & RECOMMENDATIONS
    // ============================================
    REMEDY_TITLE("Recommendations", "सिफारिसहरू", "सिफारिसहरू"),
    REMEDY_DEITY_WORSHIP("Deity Worship", "देवता पूजा", "देवता पूजा"),
    REMEDY_MANTRA("Recommended Mantra", "सिफारिस गरिएको मन्त्र", "सिफारिस गरिएको मन्त्र"),
    ...
    REMEDY_DONATION("Recommended Donation", "सिफारिस गरिएको दान", "सिफारिस गरिएको दान"),
    REMEDY_ACTION("Suggested Action", "सुझाव गरिएको कार्य", "सुझाव गरिएको कार्य"),
    ...
    // SPECIAL READINGS
    // ============================================
    SPECIAL_LOST_DIRECTION("Lost Object Direction", "हराएको वस्तुको दिशा", "हराएको वस्तुको दिशा"),
    ...
    SPECIAL_LITIGATION_WIN("Litigation Success", "मुद्दामा जित", "मुद्दामा जित"),
    ...
    ERROR_CALCULATION("Unable to calculate reading", "पठन गणना गर्न असमर्थ", "पठन गणना गर्न असमर्थ"),
    ...
    BTN_NEW_QUERY("New Query", "नयाँ प्रश्न", "नया प्रश्न"),
    BTN_SAVE_READING("Save Reading", "पठन सुरक्षित गर्नुहोस्", "पठन सुरक्षित करें"),
    LOADING("Consulting the shells...", "कौडीहरूसँग परामर्श गर्दै...", "कौडीहरूसँग परामर्श गर्दै..."),
    LOADING_ANALYSIS("Analyzing patterns...", "ढाँचाहरू विश्लेषण गर्दै...", "ढाँचाहरू विश्लेषण गर्दै..."),
    ...
    // New keys
    POSITIVE_FACTORS("Positive Factors", "सकारात्मक कारकहरू", "सकारात्मक कारकहरू"),
    CHALLENGES("Challenges", "चुनौतिहरू", "चुनौतिहरू"),
    CAUTIONS("Cautions", "सावधानीहरू", "सावधानीहरू"),
    ...
    SUCCESS_PROBABILITY("Success probability", "सफलताको सम्भावना", "सफलताको सम्भावना"),
    TIMING_INDICATION("Timing indication", "समय संकेत", "समय संकेत"),
    RECOVERY_OUTLOOK("Recovery outlook", "सुधारको दृष्टिकोण", "सुधारको दृष्टिकोण"),
    TITHI_SUGGESTION("Tithi Suggestion", "तिथि सुझाव", "तिथि सुझाव"),
    THE_EIGHT_POSITIONS("The Eight Positions", "आठ स्थितिहरू", "आठ स्थितिहरू"),
    SHELLS("Shells", "कौडीहरू", "कौडीहरू"),
