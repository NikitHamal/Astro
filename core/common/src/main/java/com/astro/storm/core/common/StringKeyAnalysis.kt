...
enum class StringKeyAnalysis(override val en: String, override val ne: String) : StringKeyInterface {
    ...
    PRASHNA_REPORT_HOUSE_INDICATOR("House %d: %s", "भाव %d: %s"),
    PRASHNA_REPORT_HOUSE_LORD_INDICATOR("Lord in House %d", "भावेश भाव %d मा"),
    ...
    PRASHNA_MOON_HOUSE_IND_TEMPLATE("House %d", "भाव %d"),
