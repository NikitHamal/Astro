...
enum class StringKeyDosha(override val en: String, override val ne: String) : StringKeyInterface {
    ...
    YOGINI_ERROR_GENERIC("Failed to calculate Yogini Dasha. Please try again.", "कृपया फेरि प्रयास गर्नुहोस्।"),
    ...
    ARUDHA_IN_CONNECTOR("in", "मा"),
    ARUDHA_LORD_IN_SIGN("Lord: %1\$s in %2\$s", "स्वामी: %1\$s %2\$s मा"),
    ...
    ARUDHA_KEY_AL_DESC("Arudha Lagna - Your public image and status", "आरुढ लग्न - तपाईंको सार्वजनिक छवि र स्थिति"),
    ARUDHA_KEY_A7_DESC("Darapada - Business and partnerships", "दारापद - व्यवसाय र साझेदारी"),
    ARUDHA_KEY_A10_DESC("Rajya Pada - Career manifestation", "राज्य पद - करियर प्रकटीकरण"),
    ARUDHA_KEY_A11_DESC("Labha Pada - Gains and desires", "लाभ पद - लाभ र इच्छाहरू"),
    ARUDHA_KEY_UL_DESC("Upapada - Spouse characteristics", "उपपद - जीवनसाथीका विशेषताहरू"),
    ...
    KEMA_TAB_OVERVIEW("Overview", "सिंहावलोकन"),
    KEMA_SEVERITY_LABEL("Severity", "गम्भीरता"),
    KEMA_CANCELLATION_LABEL("Cancellation", "भंग"),
    KEMA_PERIODS_LABEL("Periods", "अवधि"),
    KEMA_INTERPRETATION_LABEL("Interpretation", "व्याख्या"),
    KEMA_ACTIVE_CANCELLATIONS("Active Cancellations (Bhanga)", "सक्रिय भंग"),
    KEMA_TOTAL_CANCELLATION("Total Cancellation", "कुल भंग"),
    KEMA_IMPACT_LEVEL_LABEL("Impact Level: %s", "प्रभाव स्तर: %s"),
    KEMA_RECOMMENDATIONS_LABEL("Recommendations:", "सिफारिसहरू:"),
    DOSHA_REMEDIES_SECTION_TITLE("Recommended Remedies", "सिफारिस गरिएका उपायहरू"),
    KEMA_NO_REMEDIES_NEEDED("No Remedies Needed", "कुनै उपाय आवश्यक छैन"),
    KEMA_ANALYZING("Analyzing Kemadruma Yoga...", "केमद्रुम योग विश्लेषण गर्दै..."),
    KEMA_NO_CHART_DATA("No Chart Data", "कुण्डली डाटा छैन"),
    KEMA_SELECT_CHART_DESC("Create or select a birth chart to analyze Kemadruma Yoga.", "केमद्रुम योग विश्लेषण गर्न कुण्डली बनाउनुहोस् वा छान्नुहोस्।"),
    KEMA_ABOUT_TITLE_MODAL("About Kemadruma Yoga", "केमद्रुम योगको बारेमा"),
    KEMA_SEV_VERY_HIGH("Very High", "अत्यन्त उच्च"),
    KEMA_SEV_HIGH("High", "उच्च"),
    KEMA_SEV_MODERATE("Moderate", "मध्यम"),
    KEMA_SEV_LOW("Low", "कम"),
    KEMA_SEV_MILD("Mild", "हल्का"),
    KEMA_PRIORITY_ESSENTIAL("Essential", "अनिवार्य"),
    KEMA_PRIORITY_RECOMMENDED("Recommended", "सिफारिस"),
    KEMA_PRIORITY_OPTIONAL("Optional", "वैकल्पिक"),
    KEMA_TIMING_LABEL("Timing: %s", "समय: %s"),
