...
enum class StringKeyAnalysis(override val en: String, override val ne: String) : StringKeyInterface {
    ...
    // Common UI Labels
    UI_KEY_INSIGHTS("Key Insights", "मुख्य अन्तर्दृष्टि"),
    UI_OVERVIEW("Overview", "सिंहावलोकन"),
    ...
    UI_NO_BIRTH_CHART("No Birth Chart", "कुनै जन्म कुण्डली छैन"),
    ...
    ERROR_CALCULATION("Calculation error: %s", "गणना त्रुटि: %s"),
    ...
    EXPORT_GENERATED_BY("Generated by AstroVajra - Ultra-Precision Vedic Astrology", "AstroVajra द्वारा उत्पन्न - अति-सटीक वैदिक ज्योतिष"),
    EXPORT_LUCKY_ELEMENTS("Lucky Elements", "भाग्यशाली तत्वहरू"),
    EXPORT_ASCENDANT_VAL("Ascendant: %s", "लग्न: %s"),
    EXPORT_MOON_SIGN_VAL("Moon Sign: %s", "चन्द्र राशि: %s"),
    EXPORT_TOTAL_REMEDIES_VAL("Total Remedies: %d", "कुल उपाय: %d"),
    EXPORT_ESSENTIAL_REMEDIES_VAL("Essential: %d", "आवश्यक: %d"),
    ...
    EXPORT_GENERATED_BY_SHORT("Generated by AstroVajra", "AstroVajra द्वारा उत्पन्न"),
    ...
    VARSHA_REPORT_FOOTER("Generated by AstroVajra - Ultra-Precision Vedic Astrology", "AstroVajra द्वारा उत्पन्न - अति-सटीक वैदिक ज्योतिष"),
