...
enum class StringKeyAdvanced(override val en: String, override val ne: String) : StringKeyInterface {
    ...
    // KP SYSTEM STRINGS
    // ============================================
    KP_TITLE("KP System", "केपी प्रणाली"),
    KP_DESC("Krishnamurti Paddhati charting with cuspal sub-lords, significators, ruling planets, and KP number lookup", "कस्पल सब-लर्ड, सिग्निफिकेटर, रुलिङ प्लानेट, र केपी नम्बर लुकअपसहित कृष्णमूर्ति पद्धति विश्लेषण"),
    KP_LOADING("Calculating KP chart and significators...", "केपी कुण्डली र सिग्निफिकेटर गणना हुँदैछ..."),
    KP_ERROR_TITLE("Unable to load KP system", "केपी प्रणाली लोड गर्न सकिएन"),
    KP_TAB_OVERVIEW("Overview", "सारांश"),
    KP_TAB_CUSPS("Cusps", "कस्पहरू"),
    KP_TAB_PLANETS("Planets", "ग्रहहरू"),
    KP_TAB_SIGNIFICATORS("Significators", "सिग्निफिकेटर"),
    KP_TAB_NUMBERS("KP Numbers", "केपी नम्बर"),
    KP_PRESET_TITLE("KP Preset", "केपी प्रिसेट"),
    KP_PRESET_AYANAMSA("Ayanamsa", "अयनांश"),
    KP_PRESET_HOUSES("House System", "भाव प्रणाली"),
    KP_PRESET_NODES("Node Mode", "नोड मोड"),
    KP_ANALYSIS_MOMENT("Analysis Moment", "विश्लेषण समय"),
    KP_CHART_SUMMARY("KP Chart Summary", "केपी कुण्डली सारांश"),
    KP_ASCENDANT("Ascendant", "लग्न"),
    KP_MIDHEAVEN("Midheaven", "मध्य आकाश"),
    KP_AYANAMSA_VALUE("Ayanamsa Value", "अयनांश मान"),
    KP_MOON_STAR_SUB("Moon Star/Sub", "चन्द्र तारा/सब"),
    KP_HORARY_RANGE("KP Number Range", "केपी नम्बर दायरा"),
    KP_BIRTH_RULING_PLANETS("Birth Moment Ruling Planets", "जन्म समयका रुलिङ प्लानेट"),
    KP_CURRENT_RULING_PLANETS("Current Ruling Planets", "वर्तमान रुलिङ प्लानेट"),
    KP_WEEKDAY_LORD("Weekday Lord", "वार स्वामी"),
    KP_MOON_RULERS("Moon Sign / Star / Sub", "चन्द्र राशि / तारा / सब"),
    KP_LAGNA_RULERS("Lagna Sign / Star / Sub", "लग्न राशि / तारा / सब"),
    KP_ORDERED_RULING_PLANETS("Ordered Ruling Planets", "क्रमित रुलिङ प्लानेट"),
    KP_CUSP_TITLE("House %d Cusp", "भाव %d कस्प"),
    KP_HOUSE_LABEL("House %d", "भाव %d"),
    KP_HOUSE_SIGNIFICATORS_TITLE("House %d Significators", "भाव %d सिग्निफिकेटर"),
    KP_SIGN_LORD("Sign Lord", "राशि स्वामी"),
    KP_STAR_LORD("Star Lord", "स्टार लर्ड"),
    KP_SUB_LORD("Sub Lord", "सब लर्ड"),
    KP_SUB_SUB_LORD("Sub-Sub Lord", "सब-सब लर्ड"),
    KP_OCCUPANTS("Occupants", "अवस्थित ग्रह"),
    KP_OWNERS("Owners", "स्वामीहरू"),
    KP_OWNED_HOUSES("Owned Houses", "स्वामित्व भएका भाव"),
    KP_STAR_LINKS("Star Linked Houses", "स्टार-सम्बद्ध भाव"),
    KP_SUB_LINKS("Sub Linked Houses", "सब-सम्बद्ध भाव"),
    KP_CUSP_STAR_LORD("Cusp Star Lord", "कस्प स्टार लर्ड"),
    KP_CUSP_SUB_LORD("Cusp Sub Lord", "कस्प सब लर्ड"),
    KP_CUSP_SUB_LINKS("Cusp Sub-Lord Houses", "कस्प सब-लर्ड भाव"),
    KP_FINAL_SIGNIFICATIONS("Final House Significations", "अन्तिम भाव संकेत"),
    KP_STAR_OF_OCCUPANTS("Planets in Star of Occupants", "अवस्थित ग्रहको तारा भएका ग्रह"),
    KP_STAR_OF_OWNERS("Planets in Star of Owners", "स्वामीको तारा भएका ग्रह"),
    KP_NUMBER_LOOKUP_TITLE("KP Number Lookup", "केपी नम्बर लुकअप"),
    KP_NUMBER_LOOKUP_DESC("The KP 1–249 table is built by splitting the zodiac's sub-lord spans at sign boundaries for practical lookup.", "केपी १–२४९ तालिका राशिचक्रका सब-लर्ड खण्डहरूलाई राशि सीमामा विभाजन गरेर व्यावहारिक लुकअपका लागि तयार गरिन्छ।"),
    KP_NUMBER_INPUT_LABEL("KP Number", "केपी नम्बर"),
    KP_NUMBER_TITLE("KP Number %d", "केपी नम्बर %d"),
    KP_NUMBER_RANGE("Longitude Range", "देशान्तर दायरा"),
    KP_NAKSHATRA("Nakshatra", "नक्षत्र"),
    KP_SOURCE_STAR_OCCUPANT("Star of occupant", "अवस्थित ग्रहको तारा"),
    KP_SOURCE_OCCUPANT("Occupant", "अवस्थित"),
    KP_SOURCE_STAR_OWNER("Star of owner", "स्वामीको तारा"),
    KP_SOURCE_OWNER("Owner", "स्वामी"),
    KP_SOURCE_SUB_LORD("Sub-lord link", "सब-लर्ड सम्बन्ध"),
    KP_SOURCE_NODE_SIGN_LORD("Node sign-lord link", "नोड राशि-स्वामी सम्बन्ध"),
    KP_NONE("None", "कुनै छैन"),
